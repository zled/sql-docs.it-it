---
title: "Configurazione di FILESTREAM in un cluster di failover | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "FILESTREAM [SQL Server], configurazione in un cluster di failover"
...
### Per configurare FILESTREAM in un cluster di failover  
