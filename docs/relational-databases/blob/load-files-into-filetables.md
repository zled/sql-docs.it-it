---
title: "Caricamento di file in FileTable | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "FileTable [SQL Server], migrazione di file"
  - "FileTable [SQL Server], caricamento bulk"
  - "FileTable [SQL Server], caricamento di file"
