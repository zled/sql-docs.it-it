...
ms.topic: "article"
helpviewer_keywords: 
  - "guida, architettura di gestione della memoria"
  - "guida sull'architettura di gestione della memoria"
...
### <a name="providing-the-maximum-amount-of-memory-to-includessnoversiontokenssnoversionmdmd"></a>Assegnazione della quantità massima di memoria a [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
...
## <a name="memory-used-by-includessnoversiontokenssnoversionmdmd-objects-specifications"></a>Memoria usata dalle specifiche degli oggetti di [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]
