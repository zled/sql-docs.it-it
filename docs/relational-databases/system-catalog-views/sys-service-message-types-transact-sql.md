---
title: Sys.service_message_types (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|**convalida**|**Char(2)**|Convalida eseguita da Service Broker prima dell'invio di messaggi del tipo specificato. Non ammette i valori Null. I possibili valori sono i seguenti:<br /><br /> N = Nessuno<br /><br /> X = XML<br /><br /> E = Vuoto|  
