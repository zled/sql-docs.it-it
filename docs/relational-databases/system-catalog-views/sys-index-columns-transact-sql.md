...
|**index_column_id**|**int**|ID della colonna dell'indice. **index_column_id** è univoco solo all'interno di **index_id**.|  
|**column_id**|**int**|ID della colonna in **object_id**.<br /><br /> 0 = Identificatore di riga (RID, Row Identifier) in un indice non cluster.<br /><br /> **column_id** è univoco solo all'interno di **object_id**.|  
