---
title: Sys.function_order_columns (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|**valore di order_column_id**|**int**|ID della colonna di ordinamento. **valore di order_column_id** è univoco solo all'interno di **object_id**.<br /><br /> **valore di order_column_id** rappresenta la posizione della colonna nell'ordinamento.|  
