...
> [!NOTE]  
>  Per informazioni sui database di disponibilità unite in join, vedere il **replica_id** e **group_database_id** colonne [Sys. Databases (Transact-SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).  
