---
title: Sys.xml_schema_model_groups (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 06/10/2016
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Restituisce una riga per ogni componente di XML schema che è un gruppo di modelli, **symbol_space** di **M**...  
...
|**filtro Compositor**|**Char (1)**|Tipo compositor di gruppo:<br /><br /> A = XSD \<tutte > gruppo<br /><br /> C = XSD \<scelta > gruppo<br /><br /> S = XSD \<sequenza > gruppo|  
