---
title: Sys. sql_modules (Transact-SQL) | Documenti Microsoft
ms.custom: ''
ms.date: 01/09/2018
ms.prod: sql
...
|**Definizione**|**nvarchar(max)**|Testo SQL che definisce il modulo. Questo valore può anche essere ottenuto utilizzando il [OBJECT_DEFINITION](../../t-sql/functions/object-definition-transact-sql.md) funzione predefinita.<br /><br /> NULL = Crittografato.|  
