---
title: Esecuzione di query XPath (classi gestite SQLXML) | Documenti Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Questo esempio viene illustrata l'esecuzione delle query XPath su uno schema di mapping.  
