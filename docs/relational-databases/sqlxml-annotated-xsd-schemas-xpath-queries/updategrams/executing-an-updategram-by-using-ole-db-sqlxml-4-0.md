...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]In questo argomento fornisce un esempio reale di usingOLE DB per eseguire un updategram.  
