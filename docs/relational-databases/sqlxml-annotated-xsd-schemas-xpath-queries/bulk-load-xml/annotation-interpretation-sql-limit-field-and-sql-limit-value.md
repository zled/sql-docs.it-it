...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Caricamento Bulk XML elabora il **SQL: limit-campo** e **SQL: limit-valore** annotazioni per la relativa definizione. Per ulteriori informazioni, vedere [filtrare valori tramite SQL: limit-field e SQL: limit-value &#40; SQLXML 4.0 &#41; ](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md).  
