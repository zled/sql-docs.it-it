...
## <a name="unsupported-libraries"></a>Librerie non supportate  
 Le librerie non supportate possono essere comunque chiamate da stored procedure gestite, trigger, funzioni definite dall'utente, tipi definiti dall'utente e funzioni di aggregazione definite dall'utente. La libreria non supportata deve prima essere registrata nel [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] del database, utilizzando il **CREATE ASSEMBLY** istruzione, prima che possa essere usato nel codice. È necessario verificare e testare la sicurezza e l'affidabilità delle librerie non supportate registrate ed eseguite nel server.  
  
 Ad esempio, il **System. DirectoryServices** dello spazio dei nomi non è supportata. È necessario registrare l'assembly DirectoryServices con **UNSAFE** autorizzazioni prima di poter chiamare dal codice. Il **UNSAFE** autorizzazione è necessaria perché le classi nel **System. DirectoryServices** dello spazio dei nomi non soddisfano i requisiti per il **provvisoria** o  **EXTERNAL_ACCESS**. Per altre informazioni, vedere [restrizioni del modello di programmazione integrazione CLR](../../../relational-databases/clr-integration/database-objects/clr-integration-programming-model-restrictions.md) e [CLR Integration Code Access Security](../../../relational-databases/clr-integration/security/clr-integration-code-access-security.md).  
