...
ms.topic: "article"
helpviewer_keywords: 
  - "creazione di indici [SQL Server], indici non cluster"
  - "indici non cluster [SQL Server], creazione"
  - "indici non cluster [SQL Server], vincolo UNIQUE"
  - "indici [SQL Server], non cluster"
  - "indici non cluster [SQL Server], vincolo PRIMARY KEY"
