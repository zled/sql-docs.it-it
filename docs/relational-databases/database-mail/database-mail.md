...
ms.topic: "article"
helpviewer_keywords: 
  - "architettura [SQL Server], Posta elettronica database"
  - "Posta elettronica database [SQL Server], architettura"
  - "Posta elettronica database [SQL Server], componenti"
...
-   [Vantaggi dell'utilizzo della Posta elettronica database](#Benefits)  
  
-   [Architettura di Posta elettronica database](#VisualElement)  
  
-   [Introduzione ai componenti di Posta elettronica database](#ComponentsAndConcepts)  
  
-   [Contenuto correlato](#RelatedContent)  
  
##  <a name="Benefits"></a> Vantaggi dell'utilizzo della Posta elettronica database  
