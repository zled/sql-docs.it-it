 ...
 **Indirizzo posta elettronica**  
 Digitare il nome associato all'indirizzo di posta elettronica relativo all'account. Si tratta dell'indirizzo di posta elettronica da cui vengono inviati i messaggi. È ad esempio possibile che un account per [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent invii messaggi di posta elettronica dall'indirizzo SqlAgent@Adventure-Works.com.  
 ...
 **Indirizzo risposte**  
 Consente di digitare l'indirizzo di posta elettronica che verrà utilizzato per le risposte ai messaggi di posta elettronica inviati da questo account. L'indirizzo risposte è facoltativo. È ad esempio possibile che le risposte a un account per [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent vengano inviate all'indirizzo di posta elettronica danw@Adventure-Works.com dell'amministratore del database.  
...
##  <a name="Template"></a> Utilizzo dei modelli  
