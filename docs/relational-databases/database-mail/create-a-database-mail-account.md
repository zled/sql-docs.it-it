...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Per creare un account di Posta elettronica database, usare la **Configurazione guidata Posta elettronica** database o [!INCLUDE[tsql](../../includes/tsql-md.md)].  
