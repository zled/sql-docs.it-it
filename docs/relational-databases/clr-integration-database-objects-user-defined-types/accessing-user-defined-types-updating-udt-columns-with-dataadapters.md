...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Tipi definiti dall'utente (UDT) sono supportati con un **DataSet** e **SqlClient. SqlDataAdapter** per recuperare e modificare i dati.  
...
-   **UserProvidedCommands**, che illustra come fornire **InsertCommand**, **UpdateCommand**, e **DeleteCommand** oggetti per l'aggiornamento di **Punto** UDT nel **punti** tabella (che non contiene un **timestamp** colonna).  
