...
ms.topic: "article"
helpviewer_keywords: 
  - "OLE DB, server collegati"
  - "provider OLE DB, server collegati"
  - "gestione server [SQL Server], server collegati"
  - "server collegati [SQL Server]"
  - "query distribuite [SQL Server], server collegati"
  - "server [SQL Server], collegati"
  - "server remoti [SQL Server], server collegati"
  - "server collegati [SQL Server], informazioni sui server collegati"
