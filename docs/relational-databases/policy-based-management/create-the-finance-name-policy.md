---
title: "Creazione di criteri Nome Finance | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "jhubbard"
---
# Creazione di criteri Nome Finance
...
### Per creare il database Finance  
...
### Per creare la condizione Tabelle Finance  
...
4.  Nell'area **Espressione**, nella casella **Campo** selezionare **@Name**. Nella casella **Operatore** selezionare **Like**. Nella casella **Valore** digitare **'fintbl%'** per fare in modo che tutti i nomi di tabella inizino con le lettere **fintbl**.  
...
### Per creare i criteri Nome Finance  
...
7.  Nella casella **Espressione** completare l'espressione in modo da includere **@Name= 'Finance'**, quindi scegliere **OK** per chiudere la pagina della condizione.  
...
### Per creare la categoria di criteri Finance  
...
[Sottoscrizione e verifica di criteri Nome Finance](../../relational-databases/policy-based-management/subscribe-to-and-check-the-finance-name-policy.md)  
