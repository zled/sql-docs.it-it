...
|Viene descritto come modificare la definizione di una vista.|[Modifica di viste](../../relational-databases/views/modify-views.md)|  
...
## Vedere anche  
 [Creazione di viste](../../relational-databases/xml/create-views-over-xml-columns.md)   
