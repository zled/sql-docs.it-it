...
## Esecuzione di query per le colonne con maschera  
...
### Aggiunta o modifica di una maschera su una colonna esistente  
...
### Concessione di autorizzazioni per visualizzare i dati senza maschera  
