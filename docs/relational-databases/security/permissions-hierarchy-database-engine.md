...
helpviewer_keywords: 
  - "sicurezza [SQL Server], negazione dell'accesso"
  - "gerarchie [SQL Server], autorizzazioni"
  - "entità a protezione diretta [SQL Server]"
  - "sicurezza [SQL Server], autorizzazioni"
  - "autorizzazioni [SQL Server], gerarchia"
  - "sicurezza [SQL Server], concessione dell'accesso"
