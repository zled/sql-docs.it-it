...
ms.topic: "article"
helpviewer_keywords: 
  - "sicurezza [SQL Server], certificati e chiavi simmetriche"
...
|[Identificazione dell'origine dei pacchetti con firme digitali](../../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md)|Vengono fornite informazioni sull'utilizzo di certificati per la firma di pacchetti software.|  
