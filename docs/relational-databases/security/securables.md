...
helpviewer_keywords: 
  ...
  - "schemi [SQL Server], entità a protezione diretta"
  - "entità a sicurezza diretta del database [SQL Server]"
  - "gerarchie [SQL Server], entità a protezione diretta"
  - "entità a sicurezza diretta [SQL Server]"
