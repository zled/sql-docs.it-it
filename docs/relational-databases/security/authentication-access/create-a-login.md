...
helpviewer_keywords: 
  - "autenticazione [SQL Server], account di accesso"
  - "account di accesso [SQL Server], creazione"
  - "creazione di account di accesso con Management Studio"
  - "Creare un account di accesso [SQL Server]"
...
## Creare un account di accesso usando l'autenticazione di SQL Server con SSMS  
