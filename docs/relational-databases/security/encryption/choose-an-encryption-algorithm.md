---
title: "Scelta di un algoritmo di crittografia | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "01/08/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "crittografia [SQL Server], algoritmi"
  - "codifica [SQL Server], algoritmi"
  - "sicurezza [SQL Server], crittografia"
  - "algoritmi [crittografia SQL Server]"
