---
title: "Sviluppare applicazioni usando Always Encrypted con il provider di dati .NET Framework per SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
manager: "jhubbard"
---
# Sviluppare applicazioni usando Always Encrypted con il provider di dati .NET Framework per SQL Server
...
## Recupero e modifica di dati nelle colonne crittografate
...
### Uso del provider dell'insieme di credenziali delle chiavi di Azure
...
## Abilitazione della protezione aggiuntiva per un'istanza di SQL Server compromessa
...
## Copia dei dati crittografati mediante SqlBulkCopy
