...
ms.topic: "article"
helpviewer_keywords: 
  - "database indipendenti, raccolte"
...
|Metadati|DATABASE_DEFAULT/CATALOG_DEFAULT|CATALOG_DEFAULT|  
|Metadati temporanei|Regole di confronto tempdb|CATALOG_DEFAULT|  
|Variabili|Regole di confronto di istanza|CATALOG_DEFAULT|  
|Etichette Goto|Regole di confronto di istanza|CATALOG_DEFAULT|  
...
## Passaggio tra contesti indipendenti e non indipendenti  
