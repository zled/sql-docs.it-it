...
ms.topic: "article"
helpviewer_keywords: 
  - "inizializzazione dei file [SQL Server]"
  - "inizializzazioni dei file immediate [SQL Server]"
  - "inizializzazione di file immediata (SQL Server)"
  - "inizializzazione di file [SQL Server]"
