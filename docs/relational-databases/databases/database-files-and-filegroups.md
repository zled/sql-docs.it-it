...
ms.topic: "article"
helpviewer_keywords: 
  - "database [SQL Server], file"
  - "filegroup [SQL Server]"
  - "log delle transazioni [SQL Server], informazioni"
  - "log delle transazioni [SQL Server], file"
  - "file con estensione mdf"
  - "file di dati [SQL Server]"
  - "filegroup predefiniti"
  - "file [SQL Server], informazioni su file e filegroup"
  - "file secondari [SQL Server]"
  - "file di log [SQL Server]"
  - "file con estensione ndf"
  - "file [SQL Server]"
  - "file con estensione ldf"
  - "file di database [SQL Server]"
  - "database [SQL Server], filegroup"
  - "filegroup [SQL Server], tipi"
  - "filegroup primari [SQL Server]"
  - "filegroup definiti dall’utente [SQL Server]"
  - "filegroup [SQL Server], informazioni sui filegroup"
  - "file primari [SQL Server]"
  - "tipi di file [SQL Server]"
