---
title: Convenzioni della sintassi SMO | Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-xxx-md](../../includes/appliesto-ss-asdb-asdw-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Convenzioni tipografiche di Management Objects (SMO) si basano sulle convenzioni utilizzate nei [!INCLUDE[msCoName](../../includes/msconame-md.md)] materiale di riferimento di Visual Studio .NET.  
