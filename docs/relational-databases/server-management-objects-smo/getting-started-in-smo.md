...
[Installazione di SMO](installing-smo.md) fornisce le istruzioni per l'installazione e che fanno riferimento agli assembly SMO.
...
[Attività di programmazione specifiche](../../relational-databases/server-management-objects-smo/tasks/programming-specific-tasks.md) include i concetti e procedure su come programmare attività specifiche mediante SMO. Vengono inoltre descritti completa a livello di codice di gestione di SQL Server.  
