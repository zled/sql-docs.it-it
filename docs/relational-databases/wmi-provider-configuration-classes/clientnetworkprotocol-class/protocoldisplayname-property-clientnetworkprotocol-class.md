---
title: Proprietà ProtocolDisplayName (classe ClientNetworkProtocol) | Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  Ottiene il nome visualizzato del protocollo di rete client specificato per il [configurazione di protocolli Client](http://technet.microsoft.com/library/ms181035.aspx).  
