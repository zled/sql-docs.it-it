...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Ottiene il valore della proprietà booleana che specifica se il servizio fa parte di un'istanza del cluster.  
