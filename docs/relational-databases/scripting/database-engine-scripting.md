...
ms.topic: "article"
helpviewer_keywords: 
  - "script [SQL Server], PowerShell"
  - "script [SQL Server]"
  - "scripting [Motore di database di SQL Server]"
...
|Descrive come usare l'utilità **sqlcmd** per eseguire script [!INCLUDE[tsql](../../includes/tsql-md.md)] dal prompt dei comandi, inclusa la possibilità di sviluppare script in modo interattivo.|[Procedure correlate a sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md)|  
