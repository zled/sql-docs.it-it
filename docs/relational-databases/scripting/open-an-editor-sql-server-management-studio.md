---
title: "Apertura di un editor (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   **Nuova query**: consente di aprire una nuova finestra dell'editor del tipo associato alla connessione corrente in [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]. La finestra dell'editor utilizza le stesse informazioni di autenticazione della connessione corrente. Se ad esempio si seleziona un'istanza del [!INCLUDE[ssDE](../../includes/ssde-md.md)] in Esplora oggetti e quindi si fa clic sul pulsante **Nuova query**, [!INCLUDE[ssDE](../../includes/ssde-md.md)] apre un editor di query del [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] connesso alla stessa istanza usando le stesse informazioni di autenticazione.  
...
### Utilizzo del Visualizzatore modelli per aprire l'editor di query del Motore di database  
