 ...
 **[stringa con caratteri jolly]**  
 Se si vuole usare caratteri jolly, ad esempio asterischi (`*`) e punti interrogativi (`?`) nella stringa di ricerca, selezionare la casella di controllo **Utilizza** in **Opzioni di ricerca** e quindi fare clic su **Caratteri jolly**.  
  
 **[espressione regolare]**  
 Affinché il motore di ricerca interpreti la stringa come espressione regolare, selezionare la casella di controllo **Utilizza** in **Opzioni di ricerca** e quindi fare clic su **Espressioni regolari**.  
 ...
 **Includi sottocartelle**  
 Indica che la ricerca verrà eseguita nelle sottocartelle della cartella specificata in **Cerca in**. È necessario indicare un set di directory personalizzato.  
