...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Per impostazione predefinita, la maggior parte delle opzioni di [!INCLUDE[msCoName](../../includes/msconame-md.md)] IntelliSense è attivata. È possibile disattivarle e richiamarle tramite un comando di menu o una combinazione di tasti.  
