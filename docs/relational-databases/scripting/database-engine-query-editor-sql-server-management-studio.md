...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "editor di query [Motore di database]"
  - "Editor Transact-SQL Vedere editor di query [Motore di database]"
  - "editor di query del Motore di database [Motore di database]"
  - "editor di query [Motore di database], barra degli strumenti"
  - "editor [SQL Server Management Studio], editor di query del Motore di database"
  - "editor di query [Motore di database], funzionalità"
  - "SQL Server Management Studio [SQL Server], editor di query del Motore di database"
