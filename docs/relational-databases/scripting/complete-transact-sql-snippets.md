...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], completamento di frammenti"
  - "frammenti [Transact-SQL], completamento"
  - "frammenti Transact-SQL, completamento"
...
---
# Completare frammenti di Transact-SQL
...
#### Completamento dell'istruzione del frammento  
