...
ms.topic: "article"
helpviewer_keywords: 
  - "opzioni non disponibili [IntelliSense]"
  - "IntelliSense [SQL Server], risoluzione dei problemi"
  - "IntelliSense [SQL Server], opzioni non disponibili"
  - "risoluzione dei problemi [IntelliSense]"
