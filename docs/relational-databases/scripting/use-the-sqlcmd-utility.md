---
title: "Utilizzo dell&#39;utilit&#224; sqlcmd | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "istruzioni Transact-SQL, esecuzione"
  - "utilità del prompt dei comandi [SQL Server], sqlcmd"
  - "istruzioni [SQL Server], esecuzione"
...
### G. Utilizzo di sqlcmd per impostare la crittografia in un database SQL di Windows Azure  
