---
title: "Connessione al Motore di database tramite sqlcmd | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "utilità sqlcmd, connessioni al motore di database"
  - "named pipe [SQL Server], utilità sqlcmd"
  - "TCP/IP [SQL Server], protocolli client"
  - "protocolli di rete [SQL Server], utilità sqlcmd"
  - "protocolli [SQL Server], utilità sqlcmd"
  - "VIA"
