...
helpviewer_keywords: 
  - "database [SQL Server], pubblicazione"
  - "pubblicazione di database"
  - "script [SQL Server], generazione"
  - "script [SQL Server], pubblicazione"
  - "database [SQL Server], generazione di script"
  - "Pubblicazione guidata database"
...
## Generazione di script in Azure SQL Data Warehouse  
