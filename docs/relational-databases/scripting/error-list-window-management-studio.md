...
helpviewer_keywords: 
  ...
  - "SQL Server Management Studio [SQL Server], finestra Elenco errori"
...
## Caratteristiche della finestra Elenco errori  
...
## Utilizzo dell'elenco degli errori  
...
## Errori Transact-SQL in Management Studio  
