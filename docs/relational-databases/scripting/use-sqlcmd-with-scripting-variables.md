---
title: "Utilizzo di sqlcmd con variabili di scripting | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "script [SQL Server], utilità sqlcmd"
  - "variabili [SQL Server], script"
  - "variabili di scripting [SQL Server]"
  - "utilità sqlcmd, script"
  - "setvar - comando"
