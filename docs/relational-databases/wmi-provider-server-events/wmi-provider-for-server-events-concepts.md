---
title: Provider WMI per concetti degli eventi Server | Documenti Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Il Provider WMI per eventi del Server consente di utilizzare Strumentazione gestione Windows (WMI) per monitorare gli eventi in un'istanza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
## <a name="in-this-section"></a>Argomenti della sezione  
 ...
 [Esempio: Creazione di un avviso SQL Server Agent utilizzando il Provider WMI per eventi del Server](../../relational-databases/wmi-provider-server-events/sample-creating-a-sql-server-agent-alert-with-the-wmi-provider.md)  
 ...
 [Esempio: Utilizzo del Provider eventi WMI con .NET Framework](../../relational-databases/wmi-provider-server-events/sample-using-the-wmi-event-provider-with-the-net-framework.md)  
