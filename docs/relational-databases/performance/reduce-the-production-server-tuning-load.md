---
title: "Riduzione del carico di ottimizzazione del server di produzione | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "overhead [Ottimizzazione guidata motore di database]"
  - "overhead di ottimizzazione [SQL Server]"
  - "riduzione del carico di ottimizzazione del server di produzione"
  - "Ottimizzazione guidata motore di database [SQL Server], server di prova"
  - "server di prova [Ottimizzazione guidata motore di database]"
  - "server di produzione [SQL Server]"
  - "ripartizione dell‘overhead di ottimizzazione [SQL Server]"
