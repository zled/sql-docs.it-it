...
ms.topic: "article"
helpviewer_keywords: 
  - "strumenti [SQL Server], monitoraggio delle prestazioni"
  - "monitoraggio delle prestazioni del server [SQL Server], strumenti"
  - "monitoraggio delle prestazioni [SQL Server], strumenti"
  - "prestazioni database [SQL Server], strumenti"
  - "ottimizzazione di database [SQL Server], strumenti"
  - "monitoraggio di database [SQL Server], strumenti"
  - "prestazioni [SQL Server], strumenti di monitoraggio"
  - "prestazioni server [SQL Server], strumenti"
