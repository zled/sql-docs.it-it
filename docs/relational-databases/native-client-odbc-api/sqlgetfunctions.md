...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
  ...
  Il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] interfaccia del driver ODBC di Native Client è conforme ai tre livelli di conformità definiti per ODBC (ISO, Open Group e ODBC livello 2). **SQLGetFunctions** tutte le funzioni ODBC sono supportate per i report di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] driver ODBC Native Client.  
