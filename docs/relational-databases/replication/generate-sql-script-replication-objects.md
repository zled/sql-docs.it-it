...
helpviewer_keywords: 
  - "Genera script SQL - finestra di dialogo"
...
---
# Genera script SQL (oggetti di replica)
...
-   **Genera Script SQL \< ObjectName>**, disponibile dal menu di scelta rapida per le pubblicazioni e sottoscrizioni. Questa finestra di dialogo consente di creare lo script di singoli oggetti.  
...
## Genera Script SQL \< ObjectName> Opzioni  
 **Per creare o attivare i componenti** e **per rimuovere o disabilitare i componenti**  
 ...
 **Processi di replica**  
 Questa opzione è disponibile solo il **Genera Script SQL** la finestra di dialogo.  
