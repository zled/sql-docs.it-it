...
11. Fare clic su **Impostazioni di sicurezza** accanto ad Agente snapshot, immettere \<*Machine_Name>***\repl_snapshot** nella casella **Account processo**, specificare la password per l'account e quindi fare clic su **OK**.  
