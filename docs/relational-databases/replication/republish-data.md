---
title: "Ripubblicazione dei dati | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "ripubblicazione di dati"
  - "pubblicazione [replica di SQL Server], Sottoscrittori"
  - "Sottoscrittori [replica di SQL Server], ripubblicazione dei dati"
...
> [!NOTE]  
>  Se si utilizza la replica di tipo merge in una topologia di ripubblicazione, tutti i Sottoscrittori di ripubblicazione devono utilizzare sottoscrizioni server. Per ulteriori informazioni sui tipi di sottoscrizione, vedere [sottoscrivere pubblicazioni](../../relational-databases/replication/subscribe-to-publications.md).  
