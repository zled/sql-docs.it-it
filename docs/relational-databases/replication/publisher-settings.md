...
helpviewer_keywords: 
  - "Impostazioni server di pubblicazione - finestra di dialogo"
...
---
# Impostazioni server di pubblicazione
 ...
 **Connessione server di pubblicazione**  
 Fare clic per avviare il **Connetti al Server** utilizza la finestra di dialogo, che consente di visualizzare e modificare le proprietà di connessione e le credenziali di monitoraggio replica per connettersi a un server di pubblicazione.  
