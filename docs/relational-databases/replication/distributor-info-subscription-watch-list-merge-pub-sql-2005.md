---
title: Informazioni sul database di distribuzione, Elenco verifica sottoscrizioni (pubblicazione di tipo merge, SQL 2005+) | Microsoft Docs
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
...
ms.locfileid: "37358253"
---
# <a name="distributor-info-subscription-watch-list-merge-pub-sql-2005"></a>Informazioni sul database di distribuzione, Elenco verifica sottoscrizioni (pubblicazione di tipo merge, SQL 2005+)
