...
6.  Nella pagina Sottoscrittori selezionare il nome dell'istanza del server del sottoscrittore e selezionare **<New Database>** dall'elenco in **Database di sottoscrizione**.  
...
8.  Nella pagina Sicurezza agente di merge fare clic sul pulsante con i puntini di sospensione (**…**), immettere \<*Machine_Name>***\repl_merge** nella casella **Account processo**, specificare la password per l'account, fare clic su **OK**, su **Avanti** e di nuovo su **Avanti**.  
...
2.  Nella pagina **Generale** immettere \<*Machine_Name>***\repl_merge** nella casella **Nome utente**, fare clic sul pulsante con i puntini di sospensione (**…**), fare clic su **Sfoglia**, selezionare \<*Machine_Name>***\repl_merge**, fare clic su **OK**, su **Controlla nomi** e su **OK**.  
