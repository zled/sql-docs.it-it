...
ms.topic: "article"
helpviewer_keywords: 
  - "replica [SQL Server], informazioni"
  - "replica [SQL Server]"
 ...
 **Ricerca di contenuto per area**  
 ![Icona della cartella file piccola](../../analysis-services/media/filefolder-small.png "Icona della cartella file piccola") [Novità](../../relational-databases/replication/what-s-new-replication.md)  
  
 ![Icona della cartella file piccola](../../analysis-services/media/filefolder-small.png "Icona della cartella file piccola") [Compatibilità con le versioni precedenti](../../relational-databases/replication/replication-backward-compatibility.md)  
  
 ![Icona della cartella file piccola](../../analysis-services/media/filefolder-small.png "Icona della cartella file piccola") [Caratteristiche e attività di replica](../../relational-databases/replication/replication-features-and-tasks.md)  
  
 ![Icona della cartella file piccola](../../analysis-services/media/filefolder-small.png "Icona della cartella file piccola") [Riferimenti tecnici](../../relational-databases/replication/technical-reference-replication.md)  
