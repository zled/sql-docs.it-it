---
title: "Script di informazioni sui server di distribuzione e di pubblicazione | Microsoft Docs"
ms.custom: ""
ms.date: "03/09/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "server di pubblicazione [replica di SQL Server], script di informazioni"
  - "server di distribuzione [replica di SQL Server], script di informazioni"
...
-   Rimuovere i commenti (`--`) dalla riga di `exec sp_helparticle @publication='<PublicationName>'` e sostituire \< PublicationName> con il nome di una pubblicazione.  
...
## Vedere anche  
 ...
 [Procedures & #40; Transact-SQL & #41;](../../../relational-databases/system-catalog-views/sys-procedures-transact-sql.md)   
