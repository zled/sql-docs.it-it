...
helpviewer_keywords: 
  - "sp_recompile"
  - "WITH RECOMPILE - clausola"
  - "ricompilazione di stored procedure"
  - "stored procedure [SQL Server], ricompilazione"
