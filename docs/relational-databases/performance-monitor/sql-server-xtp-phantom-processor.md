...
---
# XTP Phantom Processor di SQL Server
...
## Vedere anche  
 [Contatori delle prestazioni SQL Server XTP &#40;OLTP in memoria&#41;](../../relational-databases/performance-monitor/sql-server-xtp-in-memory-oltp-performance-counters.md)  
