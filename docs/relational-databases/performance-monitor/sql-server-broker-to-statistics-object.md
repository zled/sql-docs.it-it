---
title: "Oggetto Statistiche Broker TO di SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Oggetto dell'oggetto di trasmissione Service Broker"
  - "SQL Server: oggetto di trasmissione Service Broker"
...
---
# Oggetto Statistiche Broker TO di SQL Server
...
|----------------------------------------------|-----------------|  
|**Microsec. media scritture in batch**|La quantità media di oggetti di trasmissione salvati in un batch.|  
|**Microsec. medio scrittura batch (ms)**|Il tempo medio espresso in millisecondi richiesto per salvare un batch di oggetti di trasmissione.|  
|**Microsec. Base tempo medio scrittura batch**|Solo per uso interno.|
|**Microsec. medio tra batch (ms)**|Il tempo medio espresso in millisecondi tra le scritture di batch di oggetti di trasmissione.|  
|**Microsec. Base tempo medio tra batch**|Solo per uso interno.| 
