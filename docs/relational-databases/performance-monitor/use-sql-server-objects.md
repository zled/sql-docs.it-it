---
title: "Utilizzare oggetti di SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "prestazioni server [SQL Server], oggetti per il monitoraggio"
  - "monitoraggio di database [SQL Server], oggetti per il monitoraggio"
  - "grafici [SQL Server]"
  - "Monitor di sistema [SQL Server], contatori"
  - "contatori [SQL Server], elenco"
  - "oggetti [SQL Server], monitoraggio delle prestazioni"
  - "oggetti [SQL Server], Monitoraggio di sistema di Windows"
  - "contatori delle prestazioni [SQL Server], informazioni sui contatori delle prestazioni"
  - "Monitor di sistema [SQL Server], oggetti"
  - "contatori delle prestazioni [SQL Server]"
  - "contatori [SQL Server], informazioni sui contatori delle prestazioni"
  - "ottimizzazione di database [SQL Server], oggetti per il monitoraggio"
  - "prestazioni di database [SQL Server], oggetti per il monitoraggio"
  - "SQL Server, oggetti"
  - "monitoraggio delle prestazioni [SQL Server], oggetti per il monitoraggio"
  - "Monitor di sistema di Windows [SQL Server], oggetti"
  - "Monitor di sistema di Windows [SQL Server], contatori"
  - "contatori [SQL Server]"
  - "contatori delle prestazioni [SQL Server], elenco"
