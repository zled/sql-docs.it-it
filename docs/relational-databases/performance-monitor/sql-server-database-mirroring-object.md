...
helpviewer_keywords: 
  ...
  - "mirroring del database [SQL Server], contatori delle prestazioni"
  - "contatori delle prestazioni [SQL Server], mirroring del database"
  - "Database Mirroring - oggetto"
...
---
# Oggetto Database Mirroring di SQL Server
