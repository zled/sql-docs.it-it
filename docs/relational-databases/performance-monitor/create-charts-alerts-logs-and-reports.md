...
ms.topic: "article"
helpviewer_keywords: 
  - "Monitor di sistema [SQL Server], grafici e report"
  - "grafici [SQL Server]"
  - "report [SQL Server]"
  - "report [SQL Server], creazione"
  - "Monitor di sistema di Windows [SQL Server], grafici e report"
  - "log [SQL Server], Monitor di sistema"
  - "Monitor di sistema [SQL Server], log"
  - "Monitor di sistema di Windows [SQL Server]"
...
---
# Creare grafici, avvisi, log e report
