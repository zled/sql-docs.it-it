...
-   Aumentare il valore di MAX_MEMORY_PERCENT.   
    ...
    > Per altre informazioni, vedere l'argomento [Procedure consigliate: Uso di OLTP in memoria in un ambiente di VM](../Topic/Using%20In-Memory%20OLTP%20in%20a%20VM%20Environment.md).  
...
## Vedere anche  
 ...
 [Procedure consigliate: Uso di OLTP in memoria in un ambiente di VM](../Topic/Using%20In-Memory%20OLTP%20in%20a%20VM%20Environment.md)  
