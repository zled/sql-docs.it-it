...
### <a name="to-create-a-database-with-a-memory-optimized-data-filegroup"></a>Per creare un database con un filegroup di dati con ottimizzazione per la memoria  
...
### <a name="to-create-a-memory-optimized-table"></a>Per creare una tabella con ottimizzazione per la memoria  
...
### <a name="to-create-a-user-defined-memory-optimized-table-type"></a>Per creare una tipo di tabella con ottimizzazione per la memoria definito dall'utente  
