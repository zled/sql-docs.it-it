...
5.  Verificare la corretta esecuzione del programma eseguendo una query sul contenuto delle tabelle:  
 ...
 Di seguito è riportato il listato di codice [!INCLUDE[tsql](../../includes/tsql-md.md)] per la creazione degli oggetti di database con ottimizzazione per la memoria.  
