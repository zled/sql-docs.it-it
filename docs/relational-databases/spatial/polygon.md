...
helpviewer_keywords: 
  ...
  - "sottotipo di geometria Polygon [SQL Server]"
...
## Istanze Polygon  
 ...
 ![Esempi di istanze di geometria Polygon](../../relational-databases/spatial/media/polygon.png "Esempi di istanze di geometria Polygon")  
