...
# <a name="spatial-data-types-overview"></a>Panoramica dei tipi di dati spaziali
 ...
 -  
 --   [OGC Specifications, Simple Feature Access Part 1 - Common Architecture](http://go.microsoft.com/fwlink/?LinkId=93627) (Specifiche OGC, accesso semplificato alle caratteristiche Parte 1- Architettura comune)  
 -  
 --   [OGC Specifications, Simple Feature Access Part 2 – SQL Options](http://go.microsoft.com/fwlink/?LinkId=93628) (Specifiche OGC, accesso semplificato alle caratteristiche Parte 2 - Opzioni SQL)  
 -  
 -  
