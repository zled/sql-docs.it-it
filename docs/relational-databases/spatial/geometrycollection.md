...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **GeometryCollection** è una raccolta di zero o più istanze di tipo **geometry** o **geography**. **GeometryCollection** può essere vuoto.  
