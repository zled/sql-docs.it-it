...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Un'istanza **MultiLineString** è una raccolta di zero o più istanze di tipo **geometry** o **geographyLineString**.  
