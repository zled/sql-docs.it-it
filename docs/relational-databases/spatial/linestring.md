...
ms.topic: "article"
helpviewer_keywords: 
  - "sottotipo di geometria LineString [SQL Server]"
...
## Istanze LineString  
 ...
 ![Esempi di istanze di geometria LineString](../../relational-databases/spatial/media/linestring.png "Esempi di istanze di geometria LineString")  
