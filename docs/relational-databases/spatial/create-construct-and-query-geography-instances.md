---
title: "Creare, Costruire e Istanze geografiche di Query | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "tipo di dati geografy [SQL Server]"
  - "tipo di dati geodetico [SQL Server]"
  - "tipo di dati geography [SQL Server], informazioni sul tipo di dati geography"
