...
helpviewer_keywords: 
  ...
  - "livelli di gravità [SQL Server]"
  - "recupero di gravità errore"
  - "errori [SQL Server], gravità"
...
## Gravità dell'errore e costrutto TRY…CATCH  
...
## Recupero della gravità dell'errore  
...
## Vedere anche  
 ...
 [Funzioni di sistema &#40;Transact-SQL&#41;](../../t-sql/functions/system-functions-transact-sql.md)   
