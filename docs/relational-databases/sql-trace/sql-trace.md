...
|**IndexID**|24|ID dell'indice dell'oggetto interessato dall'evento. Per determinare l'ID di indice di un oggetto, usare la colonna **indid** della tabella di sistema **sysindexes**.|  
