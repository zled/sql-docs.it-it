 ...
 *iValue*  
 Il valore per l'oggetto specificato è *eOption*. *iValue* è un valore integer (LONGLONG) eseguire il cast a un puntatore void per consentire l'espansione futura a valori a 64 bit.  
