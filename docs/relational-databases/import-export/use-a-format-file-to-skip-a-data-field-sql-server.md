---
title: "Utilizzo di un file di formato per escludere un campo di dati (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "09/19/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "file di formato [SQL Server], esclusione di campi di dati"
  - "esclusione di campi di dati durante l'importazione"
