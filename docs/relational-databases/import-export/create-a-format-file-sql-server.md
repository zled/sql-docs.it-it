---
title: "Creazione di un file di formato (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "02/23/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "file di formato [SQL Server], creazione"
...
>  Per distinguere un file di formato non XML, è consigliabile utilizzare l'estensione fmt, ad esempio MyTable.fmt.  
 ...
 Per informazioni sulla struttura e sui campi dei file di formato non XML, vedere [File di formato non XML &#40;SQL Server&#41;](../../relational-databases/import-export/non-xml-format-files-sql-server.md).  
