...
ms.topic: "article"
helpviewer_keywords: 
  - "tabella di esempio myTeam [SQL Server]"
  - "importazione in blocco [SQL Server], esempi"
  - "esportazione in blocco [SQL Server], esempi"
...
---
# Tabella di esempio HumanResources.myTeam (SQL Server)
