---
title: "Importazione di dati per operazioni bulk con BULK INSERT o OPENROWSET(BULK...) (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "BULK INSERT - istruzione, importazione di dati da un file di dati remoto"
  - "importazione bulk [SQL Server], metodi"
  - "esportazione bulk [SQL Server], metodi"
  - "OPENROWSET - funzione, BULK INSERT"
  - "importazione bulk [SQL Server], sicurezza"
  - "provider di set di righe con lettura bulk [SQL Server]"
  - "esportazione bulk [SQL Server], BULK INSERT - istruzione"
  - "accesso a dati remoti [SQL Server], importazione bulk"
  - "importazione bulk [SQL Server], BULK INSERT - istruzione"
  - "Transact-SQL - operazioni di esportazione/importazione bulk"
...
> **NOTA:** quando si usa BULK INSERT o OPENROWSET(BULK…), è importante comprendere in che modo la versione di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] gestisce la rappresentazione. Per ulteriori informazioni, vedere la sezione "Considerazioni sulla sicurezza" di seguito in questo argomento.  
...
> **NOTA:** questa restrizione non si applica all'utilità **bcp** perché il client legge il file in modo indipendente da [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
