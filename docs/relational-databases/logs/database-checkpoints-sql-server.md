...
helpviewer_keywords: 
  ...
  - "log delle transazioni [SQL Server], checkpoint"
  - "log [SQL Server], attivo"
  - "pagine [SQL Server], dirty"
  - "MinLSN"
  - "checkpoint [SQL Server]"
  - "pagine [SQL Server], scaricamento"
  - "pagine dirty"
  - "log delle transazioni [SQL Server], log attivi"
  - "recovery interval - opzione [SQL Server]"
  - "cache buffer [SQL Server]"
  - "log [SQL Server], checkpoint"
  - "LSN (numero di sequenza del file di log, Log Sequence Number) minimo del recupero"
  - "scaricamento di pagine"
  - "log attivi"
...
>**IMPORTANTE** Le transazioni di cui non è stato eseguito il commit con esecuzione prolungata aumentano il tempo di recupero per tutti i tipi di checkpoint.  
