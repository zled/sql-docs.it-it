...
1.  Dal **Pannello di controllo**, l'accesso **strumenti di amministrazione** e quindi su **origini dati ODBC (64 bit)** o **origini dati ODBC (32 bit)**. In alternativa, è possibile richiamare odbcad32.exe.  
