...
2.  Per ogni marcatore di parametro:  
     ...
     Chiamare [SQLBindParameter](../../../relational-databases/native-client-odbc-api/sqlbindparameter.md) per l'associazione di matrici di parametri dei dati e dei valori lunghezza per il parametro dell'istruzione.  
