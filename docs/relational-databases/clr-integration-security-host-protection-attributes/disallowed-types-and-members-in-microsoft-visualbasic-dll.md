---
title: Non consentito di tipi e i membri di Microsoft.VisualBasic.dll | Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|**Tipo o membro**|**Valori di Attributo**|  
|------------------------|------------------------|  
