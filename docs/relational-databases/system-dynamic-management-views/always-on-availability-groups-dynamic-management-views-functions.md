---
title: Sempre in viste a gestione dinamica disponibilità gruppi - funzioni | Documenti Microsoft
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
---
# <a name="always-on-availability-groups-dynamic-management-views---functions"></a>Sempre in viste a gestione dinamica disponibilità gruppi - funzioni
...
|[sys.dm_hadr_cluster](../../relational-databases/system-dynamic-management-views/sys-dm-hadr-cluster-transact-sql.md)|[tcp_listener_states](../../relational-databases/system-dynamic-management-views/sys-dm-tcp-listener-states-transact-sql.md)|  
