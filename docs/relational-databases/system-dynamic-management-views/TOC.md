# [Panoramica](system-dynamic-management-views.md)  
...
## [sys.dm_db_objects_impacted_on_version_change (database di SQL Azure)](sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)  
...
## [sys.dm_db_wait_stats (database di SQL Azure)](sys-dm-db-wait-stats-azure-sql-database.md)  
## [sys.dm_operation_status (database di SQL Azure)](sys-dm-operation-status-azure-sql-database.md)  
## [sys.dm_database_copies (database di SQL Azure)](sys-dm-database-copies-azure-sql-database.md)  
## [sys.dm_db_resource_stats (database SQL di Azure)](sys-dm-db-resource-stats-azure-sql-database.md)  
...
## [sys.dm_xe_database_sessions (database SQL di Azure)](sys-dm-xe-database-sessions-azure-sql-database.md)  
...
# [Ricerca full-text e ricerca semantica](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
## [sys.dm_continuous_copy_status (database SQL di Azure)](sys-dm-continuous-copy-status-azure-sql-database.md)  
...
# [Tabella ottimizzata per la memoria](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [Sicurezza](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Server](server-related-dynamic-management-views-and-functions-transact-sql.md)  
