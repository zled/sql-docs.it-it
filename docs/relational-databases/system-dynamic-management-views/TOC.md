...
## [Sys.dm operation_status (Database SQL di Azure)](sys-dm-operation-status-azure-sql-database.md)  
...
## [Sys.dm xe_sessions_events](sys-dm-xe-session-events-transact-sql.md)  
