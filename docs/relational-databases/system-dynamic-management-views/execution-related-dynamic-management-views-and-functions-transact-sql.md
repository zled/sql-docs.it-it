---
title: Funzioni (Transact-SQL) e viste a gestione dinamica relative all'esecuzione | Documenti Microsoft
ms.custom: ''
ms.date: 04/24/2017
ms.prod: sql
ms.reviewer: ''
...
> [!NOTE]  
>  Il **exec_query_transformation_stats** vista a gestione dinamica viene identificata esclusivamente per scopi informativi. Non supportato. Non è garantita la compatibilità con le versioni future.  
