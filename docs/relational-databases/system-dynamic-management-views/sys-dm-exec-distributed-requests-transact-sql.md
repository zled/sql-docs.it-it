...
|status|**nvarchar (32**|Stato corrente della richiesta.|'Sospeso', 'Autorizzazione', 'AcquireSystemResources', 'Initializing', 'Piano', 'Analisi', 'AquireResources', 'In esecuzione', 'Annullamento', 'Completato', 'non riuscito","Annullata".|  
