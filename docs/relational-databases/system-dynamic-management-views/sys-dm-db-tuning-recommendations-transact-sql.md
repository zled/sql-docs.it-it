...
| **tipo** | **nvarchar(4000)** | Il nome dell'opzione di ottimizzazione automatica che ha generato la raccomandazione, ad esempio,`FORCE_LAST_GOOD_PLAN` |
| **motivo** | **nvarchar(4000)** | Motivo fornita perché questa raccomandazione. |
...
| **stato** | **nvarchar(4000)** | Documento JSON che descrive lo stato dell'indicazione. Sono disponibili i seguenti campi:<br />-   `currentValue`-stato corrente dell'indicazione.<br />-   `reason`-Costante che descrive perché la raccomandazione è nello stato corrente.|
...
| **è\_revertable\_azione** | **bit** | 1 = le indicazioni possono essere monitorate e ripristinate dal motore di Database automaticamente.<br />0 = la raccomandazione non può essere monitorata e ripristinata automaticamente. La maggior parte delle &quot;eseguibile&quot; azioni saranno &quot;revertable&quot;. |
...
| **ripristinare\_azione\_avviare\_ora** | **datetime2** | Data che l'indicazione è stata annullata. |
| **ripristinare\_azione\_durata** | **time** | Durata dell'azione di annullamento. |
