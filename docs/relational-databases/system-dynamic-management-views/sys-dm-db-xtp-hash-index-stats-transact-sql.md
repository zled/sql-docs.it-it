---
title: Sys.dm db_xtp_hash_index_stats (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 08/29/2016
 ...
 **Sys.dm db_xtp_hash_index_stats** analizza l'intera tabella. Pertanto, se sono presenti tabelle di grandi dimensioni nel database, **Sys.dm db_xtp_hash_index_stats** potrebbe richiedere molto tempo esecuzione.  
 ...
 Per ulteriori informazioni, vedere [gli indici Hash per le tabelle con ottimizzazione](../../relational-databases/in-memory-oltp/hash-indexes-for-memory-optimized-tables.md).  
...
Per informazioni dettagliate su come interpretare i risultati della query, vedere [gli indici Hash per le tabelle con ottimizzazione](../../relational-databases/in-memory-oltp/hash-indexes-for-memory-optimized-tables.md).  
