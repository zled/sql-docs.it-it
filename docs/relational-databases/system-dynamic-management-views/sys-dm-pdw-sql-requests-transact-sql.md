---
title: Sys.dm_pdw_sql_requests (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 06/10/2016
ms.prod: 
...
|error_id|**nvarchar(36)**|Identificatore univoco dell'errore associata a questa distribuzione delle query, se presente.|Vedere error_id in [sys.dm_pdw_errors &#40; Transact-SQL &#41; ](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-errors-transact-sql.md). Se si è verificato alcun errore, impostato su NULL.|  
