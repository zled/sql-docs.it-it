...
|**secondary_lag_seconds**|**bigint**|Il numero di secondi durante i quali la replica secondaria alla replica primaria durante la sincronizzazione.<br /><br />**Si applica a:**  da [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] fino a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].|  
