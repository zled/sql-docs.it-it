---
title: "Creazione di funzioni definite dall&#39;utente (Motore di database) | Microsoft Docs"
ms.custom: ""
ms.date: "10/24/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SCHEMABINDING - clausola"
  - "funzioni associate a schema [SQL Server]"
  - "funzioni definite dall'utente [SQL Server], creazione"
  - "CREATE FUNCTION - istruzione"
  - "istruzioni valide [SQL Server]"
