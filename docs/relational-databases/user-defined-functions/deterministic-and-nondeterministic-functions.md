...
ms.topic: "article"
helpviewer_keywords: 
  - "funzioni predefinite [SQL Server]"
  - "funzioni non deterministiche"
  - "stored procedure estese [SQL Server], funzioni di chiamata"
  - "funzioni deterministiche"
  - "funzioni definite dall'utente [replica di SQL Server], deterministiche"
