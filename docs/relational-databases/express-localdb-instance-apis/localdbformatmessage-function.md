...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Restituisce la descrizione testuale localizzata per il codice di errore SQL Server Express LocalDB.  
