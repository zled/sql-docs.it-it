...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Arresta l'istanza di SQL Server Express LocalDB specificata dall'esecuzione.  
