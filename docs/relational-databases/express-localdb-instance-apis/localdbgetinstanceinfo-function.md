...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Restituisce informazioni per l'istanza specificata di SQL Server Express LocalDB, ad esempio se esiste, la versione del database locale utilizzata, se è in esecuzione e così via.  
