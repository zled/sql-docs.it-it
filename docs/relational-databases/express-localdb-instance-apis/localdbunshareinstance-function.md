...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Arresta la condivisione dell'istanza di SQL Server Express LocalDB specificata.  
