...
ms.locfileid: "34707869"
---
# <a name="data-types-ole-db"></a>Tipi di dati (OLE DB)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]

  Per eseguire [!INCLUDE[tsql](../../includes/tsql-md.md)] istruzioni ed elaborare i risultati utilizzando il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provider OLE DB Native Client, è necessario conoscere il modo in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] mappe di provider OLE DB Native Client [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] tipi di dati per i tipi di dati OLE DB durante l'associazione di parametri o colonne in un set di righe e quando viene utilizzato il **ITableDefinition** interfaccia per creare una tabella in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
