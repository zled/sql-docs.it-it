...
ms.topic: "article"
helpviewer_keywords: 
  - "Change Data Capture [SQL Server], confronto con il rilevamento delle modifiche"
  - "Change Data Capture e rilevamento delle modifiche"
  - "Change Data Capture [SQL Server], comportamenti dei tipi di dati"
  - "Sync Services for ADO.NET"
  - "rilevamento delle modifiche [SQL Server], Sync Services for ADO.NET"
  - "rilevamento delle modifiche [SQL Server]"
  - "Change Data Capture [SQL Server], sicurezza"
...
## Vedere anche  
 ...
 [Viste a gestione dinamica correlate a Change Data Capture &#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
