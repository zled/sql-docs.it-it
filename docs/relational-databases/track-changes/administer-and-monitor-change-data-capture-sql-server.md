...
ms.topic: "article"
helpviewer_keywords: 
  - "Change Data Capture [SQL Server], monitoraggio"
  - "Change Data Capture [SQL Server], amministrazione"
  - "Change Data Capture [SQL Server], processi"
