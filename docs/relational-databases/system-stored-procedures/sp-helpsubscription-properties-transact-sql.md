...
## <a name="arguments"></a>Argomenti  
 [  **@publisher=**] **'***publisher***'**  
 Nome del server di pubblicazione. *server di pubblicazione* è **sysname**, il valore predefinito è  **%** , che restituisce informazioni su tutti i server di pubblicazione.  
 ...
 Nome della pubblicazione. *pubblicazione* è **sysname**, il valore predefinito è  **%** , che restituisce informazioni su tutte le pubblicazioni.  
...
|**parametro**|**sysname**|Account di accesso per il server di distribuzione.|  
