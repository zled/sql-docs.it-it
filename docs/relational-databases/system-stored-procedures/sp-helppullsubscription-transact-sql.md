...
## <a name="arguments"></a>Argomenti  
 [  **@publisher=**] **'***publisher***'**  
 Nome del server remoto. *server di pubblicazione* è **sysname**, il valore predefinito è  **%** , che restituisce informazioni per tutti i server di pubblicazione.  
  
 [  **@publisher_db=**] **'***publisher_db***'**  
 Nome del database del server di pubblicazione. *publisher_db* è **sysname**, il valore predefinito è  **%** , che restituisce tutti i database di pubblicazione.  
  
 [  **@publication=**] **'***pubblicazione***'**  
 Nome della pubblicazione. *pubblicazione* è **sysname**, il valore predefinito è  **%** , che restituisce tutte le pubblicazioni. Se questo parametro è uguale a tutti, solo le sottoscrizioni pull con independent_agent = **0** vengono restituiti.  
  
 [  **@show_push=**] **'***show_push***'**  
 Indica se devono essere restituite tutte le sottoscrizioni push. *show_push*è **nvarchar (5)**, il valore predefinito è FALSE, che non restituisce le sottoscrizioni push.  
...
|**parametro**|**sysname**|ID dell'account di accesso utilizzato nel server di distribuzione per l'autenticazione di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
