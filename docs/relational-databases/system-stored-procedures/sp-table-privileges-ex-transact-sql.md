...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@table_name =** ] **'***table_name***'**]  
 Nome della tabella per cui si desidera ottenere informazioni sui privilegi assegnati. *TABLE_NAME* è **sysname**, con un valore predefinito è NULL.  
  
 [  **@table_schema =** ] **'***table_schema***'**  
 Schema della tabella. In alcuni ambienti DBMS corrisponde al proprietario della tabella. *TABLE_SCHEMA* è **sysname**, con un valore predefinito è NULL.  
