...
## <a name="arguments"></a>Argomenti  
 ...
 Nome del profilo per l'associazione da includere nell'elenco. *profile_name* è **sysname**, con un valore predefinito è NULL. Entrambi *profile_id* o *profile_name* può essere specificato.  
