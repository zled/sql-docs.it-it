...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@request_id=** ] *request_id*  
 Specifica una determinata richiesta dello stato in modo che tutte le risposte a tale richiesta vengano eliminate. *request_id* viene **int**, con valore predefinito è NULL.  
  
 [  **@cutoff_date=** ] *cutoff_date*  
 Specifica una data limite prima della quale tutti i record relativi alle risposte verranno rimossi. *cutoff_date* viene **datetime**, con valore predefinito è NULL.  
