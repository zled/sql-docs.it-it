---
title: Stored procedure (Transact-SQL) per XML | Documenti Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33252277"
---
# <a name="xml-stored-procedures-transact-sql"></a>Stored procedure XML (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] supporta le seguente stored procedure di sistema utilizzate per gestire il testo XML.  
