...
## <a name="arguments"></a>Argomenti  
 ...
 Il valore **Q** (SQL_QUICK) chiede al driver di recuperare la cardinalità e le pagine solo se sono disponibili dal server. In tal caso, il driver non garantisce che i valori siano aggiornati. Per le applicazioni scritte in base allo standard Open Group viene restituito sempre il comportamento di SQL_QUICK da driver conformi a ODBC 3.x.  
...
|**INDEX_QUALIFIER**|**sysname**|Nome del proprietario dell'indice. In alcuni prodotti DBMS gli indici possono essere creati da utenti diversi dal proprietario della tabella. In [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], questa colonna è sempre identico **TABLE_NAME**.|  
...
## <a name="remarks"></a>Osservazioni  
 ...
 Gli indici di tipo cluster sono quelli in cui i dati della tabella sono archiviati nell'ordine dell'indice, Questo corrisponde ai [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] indici cluster.  
