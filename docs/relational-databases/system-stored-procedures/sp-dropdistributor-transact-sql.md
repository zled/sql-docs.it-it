...
## <a name="arguments"></a>Argomenti  
 [  **@no_checks=**] *no_checks*  
 Indica se è necessario verificare la presenza di oggetti dipendenti prima di rimuovere il server di distribuzione. *no_checks* è **bit**, con un valore predefinito è 0.  
