---
title: sp_syscollector_delete_collection_item (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 03/06/2017
...
## <a name="arguments"></a>Argomenti  
 ...
 Identificatore univoco per l'elemento della raccolta. *collection_item_id* è **int** con un valore predefinito è NULL. *collection_item_id* deve avere un valore se *nome* è NULL.  
