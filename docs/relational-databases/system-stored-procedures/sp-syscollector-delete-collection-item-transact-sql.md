...
## <a name="arguments"></a>Argomenti  
 ...
 Identificatore univoco per l'elemento della raccolta. *collection_item_id* viene **int** con un valore predefinito è NULL. *collection_item_id* deve avere un valore se *nome* è NULL.  
