...
## <a name="arguments"></a>Argomenti  
 ...
 ID del profilo per cui si desidera eliminare un parametro. *profile_id* è **int**, non prevede alcun valore predefinito.  
  
 [  **@parameter_name=**] **'***parameter_name***'**  
 Nome del parametro che si desidera eliminare. *parameter_name* è **sysname**, il valore predefinito è  **%** . Se  **%** , vengono eliminati tutti i parametri per il profilo specificato.  
