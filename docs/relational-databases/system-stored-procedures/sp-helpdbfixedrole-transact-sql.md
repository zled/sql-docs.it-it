...
## <a name="arguments"></a>Argomenti  
 [  **@rolename =** ] **'***ruolo***'**  
 Nome di un ruolo predefinito del database. *ruolo* è **sysname**, con un valore predefinito è NULL. Se *ruolo* è specificato, vengono restituite solo informazioni relative a tale ruolo; in caso contrario, viene restituito un elenco e una descrizione di tutti i ruoli predefiniti del database.  
...
|**Description**|**nvarchar (70)**|Descrizione di **DbFixedRole.**|  
