...
## <a name="arguments"></a>Argomenti  
 ...
 Nome della tabella o della vista indicizzata in cui visualizzare l'opzione AUTO_UPDATE_STATISTICS. *table_or_indexed_view_name* è **nvarchar(776)**, non prevede alcun valore predefinito.  
 ...
 **OFF** = OFF  
 ...
 Quando *stats_flag* non è specificato, viene visualizzata l'impostazione AUTO_UPDATE_STATISTICS corrente. *stats_value* è **varchar (10)**, con un valore predefinito è NULL.  
 ...
 *nome_statistiche* è **sysname**, con un valore predefinito è NULL.  
