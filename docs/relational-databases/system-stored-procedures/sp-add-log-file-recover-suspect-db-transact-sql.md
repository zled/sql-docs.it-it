---
title: sp_add_log_file_recover_suspect_db (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 03/16/2017
...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@filename =** ] **'***os_file_name***'**  
 Percorso e nome di file utilizzato dal sistema operativo per il file. Il file deve essere disponibile nel server in cui è installato [!INCLUDE[ssDE](../../includes/ssde-md.md)]. *os_file_name* è **nvarchar (260)**, non prevede alcun valore predefinito.  
