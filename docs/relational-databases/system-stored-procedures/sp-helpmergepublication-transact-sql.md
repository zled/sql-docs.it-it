...
## <a name="arguments"></a>Argomenti  
 ...
 Nome della pubblicazione. *pubblicazione*è **sysname**, il valore predefinito è  **%** , che restituisce informazioni su tutte le pubblicazioni di tipo merge nel database corrente.  
  
 [ @found  **=**  ] **'***trovato***'** OUTPUT  
 Flag che indica le righe che restituiscono valori. *trovato*è **int** e un parametro di OUTPUT, con un valore predefinito è NULL. **1** indica la pubblicazione è stata trovata. **0** indica la pubblicazione è stata trovata.  
  
 [ @publication_id  **=** ] **'***publication_id***'** OUTPUT  
 Numero di identificazione della pubblicazione. *publication_id* è **uniqueidentifier** e un parametro di OUTPUT, con un valore predefinito è NULL.  
  
 [ @reserved  **=** ] **'***riservato***'**  
 [!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]*riservato* è **nvarchar (20)**, con un valore predefinito è NULL.  
  
 [ @publisher  **=**  ] **'***publisher***'**  
 Nome del server di pubblicazione. *server di pubblicazione* è **sysname**, con un valore predefinito è NULL.  
  
 [@publisher_db  **=**  ] **'***publisher_db***'**  
 Nome del database di pubblicazione. *publisher_db* è **sysname**, con un valore predefinito è NULL.  
...
|centralized_conflicts|**int**|Viene determinato se i record dei conflitti vengono archiviati nel server di pubblicazione specificato:<br /><br /> **0** = i record dei conflitti vengono archiviati nel server di pubblicazione e nel Sottoscrittore che ha causato il conflitto.<br /><br /> **1** = tutti i record dei conflitti vengono archiviati nel server di pubblicazione.|  
