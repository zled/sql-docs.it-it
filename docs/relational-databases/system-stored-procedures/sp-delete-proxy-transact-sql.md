...
## <a name="arguments"></a>Argomenti  
 [ **@proxy_id**=] *id*  
 Numero di identificazione del proxy da rimuovere. Il *proxy_id* viene **int**, con un valore predefinito è NULL.  
  
 [ **@proxy_name**=] **'***proxy_name***'**  
 Nome del proxy da rimuovere. Il *nome_proxy* viene **sysname**, con un valore predefinito è NULL.  
