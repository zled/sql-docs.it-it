 ...
 **@succeeded**  
 Parametro passato dall'utente per indicare se l'evento ha avuto esito positivo o meno. Viene visualizzato nella colonna del log di controllo indicante l'esito positivo. *@succeeded*è **bit**.  
  
 **@user_defined_information**  
 Testo definito dall'utente e registrato nella nuova colonna user_defined_event_id del log di controllo. *@user_defined_information*è **nvarchar (4000)**.  
