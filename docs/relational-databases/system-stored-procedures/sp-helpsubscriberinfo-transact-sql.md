...
## <a name="arguments"></a>Argomenti  
 ...
 Nome del Sottoscrittore. *Sottoscrittore* è **sysname**, il valore predefinito è  **%** , che restituisce tutte le informazioni.  
...
|**tipo**|**tinyint**|Tipo di Sottoscrittore:<br /><br /> **0**  =  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] database **1** = origine dati ODBC|  
|**account di accesso**|**sysname**|ID dell'account di accesso per l'autenticazione di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
