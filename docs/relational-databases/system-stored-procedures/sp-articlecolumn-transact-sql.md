...
## <a name="arguments"></a>Argomenti  
 ...
 Specifica se aggiungere o eliminare colonne in un articolo. *operazione* viene **nvarchar(5**, con un valore predefinito è add. **aggiungere** contrassegna la colonna per la replica. **DROP** deseleziona colonna.  
 ...
 Consente di modificare le colonne delle pubblicazioni a cui sono associate sottoscrizioni. *change_active* è un **int** con valore predefinito è **0**. Se **0**, le colonne non vengono modificate. Se **1**, è possibile aggiungere colonne o eliminate dagli articoli attivi a cui sono associate sottoscrizioni.  
