...
## <a name="arguments"></a>Argomenti  
 ...
 [ **@fhasnullcols**=] *field_has_null_columns* OUTPUT  
 Flag che indica se l'indice della vista include colonne che ammettono valori Null. *view_name* viene **sysname**, non prevede alcun valore predefinito. Restituisce un valore di **1** se l'indice della vista include colonne che ammettono valori NULL. Restituisce un valore di **0** se la vista contiene le colonne che ammettono valori null.  
