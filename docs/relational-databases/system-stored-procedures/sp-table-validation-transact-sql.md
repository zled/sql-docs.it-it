...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@full_or_fast=**] *full_or_fast*  
 Metodo utilizzato per il conteggio delle righe. *full_or_fast* viene **tinyint**, il valore predefinito è **2**, e può essere uno dei valori seguenti.  
