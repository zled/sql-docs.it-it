...
|**run_value**|**int**|Valore dell'opzione di configurazione in corso (valore **value_in_use**).<br /><br /> Per ulteriori informazioni, vedere [Configurations &#40; Transact-SQL &#41; ](../../relational-databases/system-catalog-views/sys-configurations-transact-sql.md).|  
