...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@publisher=**] **'***publisher***'**  
 Nome del server di pubblicazione. *Server di pubblicazione* viene **sysname**, predefinito è il nome del server locale. Il server di pubblicazione deve essere un server valido.  
...
>  Non è consigliabile specificare un valore di **Nessuno**.  
 ...
 Breve descrizione della sottoscrizione pull. *Descrizione*viene **nvarchar(255**, con un valore predefinito è NULL. Questo valore viene visualizzato da Monitoraggio replica nel **nome descrittivo** colonna, che può essere utilizzato per ordinare le sottoscrizioni per una pubblicazione monitorata.  
