...
# PolyBase
## [Stored procedure PolyBase - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Stored procedure PolyBase - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
...
# [Piano di manutenzione del database](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
## [sp_set_firewall_rule (database di SQL Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (database di SQL Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (database di SQL Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (database di SQL Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [Ricerca full-text e ricerca semantica](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
## [Sintassi della gerarchica di oggetti](object-hierarchy-syntax-transact-sql.md)  
...
# [Estese di Stretch Database](stretch-database-extended-stored-procedures-transact-sql.md)  
