# [Panoramica](system-stored-procedures-transact-sql.md)  
# [Indici spaziali](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# Tabelle temporali
## [Tabella temporale - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Tabella temporale - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Backup di snapshot
## [Backup di snapshot - sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Backup di snapshot - sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [Stored procedure di PolyBase - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Stored procedure di PolyBase - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# FileStream e tabelle Filetable
...
# [Catalogo](catalog-stored-procedures-transact-sql.md)  
...
# [Cursore](cursor-stored-procedures-transact-sql.md)  
...
## [stored procedure sp_describe_cursor](sp-describe-cursor-transact-sql.md)  
## [sp_describe_cursor_columns](sp-describe-cursor-columns-transact-sql.md)  
## [stored procedure sp_describe_cursor_tables](sp-describe-cursor-tables-transact-sql.md)  
...
# [Agente di raccolta dati](data-collector-stored-procedures-transact-sql.md)  
...
# [Motore di database](database-engine-stored-procedures-transact-sql.md)  
## [sp_add_data_file_recover_suspect_db](sp-add-data-file-recover-suspect-db-transact-sql.md)  
## [procedura sp_addextendedproc](sp-addextendedproc-transact-sql.md)  
...
## [sp_execute_remote (Database SQL di Azure)](sp-execute-remote-azure-sql-database.md)  
...
## [procedura sp_monitor](sp-monitor-transact-sql.md)  
...
## [sp_xtp_control_query_exec_stats](sys-sp-xtp-control-query-exec-stats-transact-sql.md)  
...
# [Posta elettronica database](database-mail-stored-procedures-transact-sql.md)  
...
## [sysmail_delete_profileaccount_sp](sysmail-delete-profile-sp-transact-sql.md)  
...
# [Piano di manutenzione database](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [Query distribuite](distributed-queries-stored-procedures-transact-sql.md)  
## [sp_addlinkedserver](sp-addlinkedserver-transact-sql.md)  
## [procedura sp_addlinkedsrvlogin](sp-addlinkedsrvlogin-transact-sql.md)  
...
## [procedura sp_droplinkedsrvlogin](sp-droplinkedsrvlogin-transact-sql.md)  
...
# [Regole del firewall (Database SQL di Azure)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (Database SQL di Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (Database SQL di Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (Database SQL di Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (Database SQL di Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [Ricerca full-Text e semantica](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [Estese generali](general-extended-stored-procedures-transact-sql.md)  
...
# [Backup gestito](managed-backup-stored-procedures-transact-sql.md)  
...
# [Data warehouse di gestione](management-data-warehouse-stored-procedures-transact-sql.md)  
...
# [Automazione OLE](ole-automation-stored-procedures-transact-sql.md)  
## [Sintassi della gerarchia degli oggetti](object-hierarchy-syntax-transact-sql.md)  
...
# [Gestione basata su criteri](policy-based-management-stored-procedures-transact-sql.md)  
...
# [Archivio query](query-store-stored-procedures-transact-sql.md)  
...
# [Sicurezza](security-stored-procedures-transact-sql.md)  
...
## [sp_cycle_errorlog](sp-cycle-agent-errorlog-transact-sql.md)  
...
# [Estensione Database esteso](stretch-database-extended-stored-procedures-transact-sql.md)  
...
# [Replica](replication-stored-procedures-transact-sql.md)  
## [procedura sp_add_agent_parameter](sp-add-agent-parameter-transact-sql.md)  
...
## [stored procedure sp_addsubscription](sp-addsubscription-transact-sql.md)  
