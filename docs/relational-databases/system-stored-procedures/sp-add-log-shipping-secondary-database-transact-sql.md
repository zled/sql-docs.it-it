 ...
 *ripristinare* è **bit** e non può essere NULL.  
 ...
 [  **@threshold_alert_enabled**  =] '*threshold_alert_enabled*'  
 Specifica se viene generato un avviso quando *backup_threshold* viene superato. Il valore 1 (valore predefinito) indica che l'avviso viene generato. *threshold_alert_enabled* è **bit**.  
