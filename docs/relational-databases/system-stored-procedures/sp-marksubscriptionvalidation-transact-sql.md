...
## <a name="arguments"></a>Argomenti  
 ...
 [  **@destination_db=**] **'***destination_db***'**  
 Nome del database di destinazione. *destination_db* è **sysname**, non prevede alcun valore predefinito.  
