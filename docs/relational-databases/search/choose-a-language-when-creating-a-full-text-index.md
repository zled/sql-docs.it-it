---
title: "Scelta di una lingua durante la creazione di un indice full-text | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "indici full-text [SQL Server], linguaggi"
  - "considerazioni sulle funzionalità internazionali [ricerca full-text]"
  - "stemmer [ricerca full-text]"
  - "considerazioni globali [ricerca full-text]"
  - "ricerca full-text [SQL Server], considerazioni sulle funzionalità internazionali"
  - "linguaggi [SQL Server], indici full-text"
