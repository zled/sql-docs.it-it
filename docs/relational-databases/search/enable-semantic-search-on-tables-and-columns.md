...
ms.topic: "article"
helpviewer_keywords: 
  - "ricerca semantica [SQL Server], abilitazione"
...
###  <a name="HowToEnableAlter"></a> Procedura: creare un indice semantico quando esiste un indice full-text  
 ...
 **Aggiungere un indice semantico tramite SQL Server Management Studio**  
 È possibile modificare le colonne abilitate per l'indicizzazione semantica e full-text nella pagina **Colonne indice full-text** della finestra di dialogo **Proprietà indice full-text**. Per altre informazioni, vedere [Gestire indici full-text](../Topic/Manage%20Full-Text%20Indexes.md).  
...
###  <a name="HowToCheckEnabled"></a> Procedura: verificare se la ricerca semantica su oggetti di database è abilitata  
