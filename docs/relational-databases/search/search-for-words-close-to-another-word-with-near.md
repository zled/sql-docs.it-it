---
title: "Ricerca di parole vicine a un&#39;altra parola con NEAR | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "ricerche di parole [ricerca full-text]"
  - "NEAR - opzione [ricerca full-text]"
  - "ricerche di frasi [ricerca full-text]"
  - "ricerche di prossimità [ricerca full-text]"
  - "ricerca full-text [SQL Server], ricerche per prossimità"
  - "query full-text [SQL Server], prossimità"
  - "query [ricerca full-text], prossimità"
...
# Ricerca di parole vicine a un&#39;altra parola con NEAR
  Per cercare parole o frasi vicine, è possibile usare un termine di prossimità (NEAR) in un predicato [CONTAINS](../../t-sql/queries/contains-transact-sql.md) o in una funzione [CONTAINSTABLE](../../relational-databases/system-functions/containstable-transact-sql.md). È inoltre possibile specificare il numero massimo di termini non di ricerca che separano il primo e l'ultimo termine di ricerca. È inoltre possibile cercare parole o frasi in qualsiasi ordine o parole e frasi nell'ordine in cui sono state specificate. [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] supporta sia il termine di [prossimità generico precedente](#Generic_NEAR), ora deprecato, che il [termine di prossimità personalizzato](#Custom_NEAR), nuovo in [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)].  
...
> [!NOTE]  
>  Per altre informazioni sulla sintassi di <custom_proximity_term>, vedere [CONTAINS &#40;Transact-SQL&#41;](../../t-sql/queries/contains-transact-sql.md).  
...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] È consigliabile usare il [termine di prossimità personalizzato](#Custom_NEAR).  
...
> [!NOTE]  
>  Per informazioni sulla sintassi di <generic_proximity_term>, vedere [CONTAINS &#40;Transact-SQL&#41;](../../t-sql/queries/contains-transact-sql.md).  
