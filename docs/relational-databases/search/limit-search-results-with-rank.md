---
title: "Limitazione dei risultati della ricerca mediante RANK | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "classificazione per pertinenza delle righe [ricerca full-text]"
  - "valori di classificazione per pertinenza [ricerca full-text]"
  - "ricerca full-text [SQL Server], classificazione"
  - "calcoli di pertinenza di indici [ricerca full-text]"
  - "risultati di calcolo di pertinenza [ricerca full-text]"
  - "calcoli di pertinenza [ricerca full-text]"
  - "valori di pertinenza per riga [ricerca full-text]"
