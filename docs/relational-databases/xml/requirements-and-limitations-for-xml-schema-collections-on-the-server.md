---
title: "Requisiti e limitazioni per l&#39;utilizzo di raccolte di XML Schema nel server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "identificatori [raccolte di XML Schema]"
  - "raccolte XML Schema [SQL Server], limitazioni"
  - "gruppi di sostituzione [XML in SQL Server]"
  - "raccolte XML Schema [SQL Server], linee guida"
  - "convalida di tipo lax"
  - "facet di enumerazione [XML in SQL Server]"
  - "precisione decimale [XML in SQL Server]"
  - "valori ripetuti di raccolte di XML Schema"
  - "raccolte di schemi [SQL Server], limitazioni"
  - "fusi orari [XML in SQL Server]"
  - "decimali di precisione [XML in SQL Server]"
  - "raccolte di schemi [SQL Server], linee guida"
