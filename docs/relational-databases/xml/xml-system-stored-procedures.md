...
ms.topic: "article"
helpviewer_keywords: 
  - "stored procedure di sistema [SQL Server], XML"
  - "sp_xml_removedocument"
  - "OPENXML - istruzione, stored procedure di sistema"
  - "sp_xml_preparedocument"
  - "XML [SQL Server], stored procedure di sistema"
...
---
# Stored procedure XML di sistema
