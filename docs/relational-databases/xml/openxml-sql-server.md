...
helpviewer_keywords: 
  ...
  - "Istruzione OPENXML, informazioni sull'istruzione OPENXML"
  - "scrittura di XML, istruzione OPENXML"
  - "istruzione OPENXML, esecuzione di query su XML"
  - "mapping incentrato sugli attributi"
  - "istruzione SELECT [SQL Server], parola chiave OPENXML"
  - "modelli di colonna [XML in SQL Server]"
  - "modelli di riga [XML in SQL Server]"
  - "rowpattern [XML in SQL Server]"
  - "query [XML in SQL Server], istruzione OPENXML"
  - "XML [SQL Server], istruzione OPENXML"
