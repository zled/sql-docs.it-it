...
ms.topic: "article"
helpviewer_keywords: 
  - "funzioni definite dall'utente [SQL Server], XML"
  - "tipo di dati XML [SQL Server], clausola FOR XML"
...
---
# Supporto del tipo di dati xml in FOR XML
...
## Restituzione di codice XML da una funzione definita dall'utente  
