...
helpviewer_keywords: 
  ...
  - "xml_schema_namespace - funzione"
  - "raccolte XML Schema [SQL Server], informazioni sulle raccolte XML Schema"
  - "metadati [SQL Server], raccolte XML Schema"
  - "query [XML in SQL Server], raccolte XML Schema"
  - "raccolte di schemi [SQL Server]"
  - "schemi [SQL Server], XML"
  - "XML [SQL Server], raccolte di schemi"
  - "raccolte di XML Schema [SQL Server]"
  - "raccolte di schemi [SQL Server], informazioni sulle raccolte XML Schema"
...
### Esempio: enumerazione degli spazi dei nomi XML in una raccolta di XML Schema  
...
### Esempio: enumerazione del contenuto di una raccolta di XML Schema  
...
### Esempio: restituzione di uno schema specifico da una raccolta di XML Schema  
...
### Esecuzione di query su elementi XML Schema  
...
## Vedere anche  
 [Visualizzazione di una raccolta di XML Schema archiviata](../../relational-databases/xml/view-a-stored-xml-schema-collection.md)   
