---
title: "Visualizzazione di una raccolta di XML Schema archiviata | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "raccolte di schemi [SQL Server], visualizzazione"
  - "XML Schema [SQL Server], visualizzazione"
  - "CREATE XML SCHEMA COLLECTION - istruzione"
  - "xml_schema_namespace - funzione"
  - "raccolte di XML Schema [SQL Server], visualizzazione"
  - "visualizzazione di raccolte di XML Schema"
  - "visualizzazione delle raccolte di XML Schema"
