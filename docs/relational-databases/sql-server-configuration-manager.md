...
ms.topic: "article"
helpviewer_keywords: 
  - "protocolli [SQL Server], gestione"
  - "protocolli di rete [SQL Server], gestione"
  - "Configurazione di rete client"
  - "account [SQL Server]"
  - "Gestione configurazione SQL Server"
  - "Configurazione di rete server"
  - "account [SQL Server], servizi"
  - "servizi [SQL Server], gestione"
  - "strumenti [SQL Server], Gestione configurazione SQL Server"
  - "Gestione configurazione [SQL Server]"
...
> -   **Windows 8**:  
>          Per aprire Gestione configurazione [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], nell'icona promemoria **Cerca** in **App** digitare **SQLServerManager<versione>\>.msc**, ad esempio **SQLServerManager13.msc**, quindi premere **INVIO**.  
...
## Modifica degli account utilizzati dai servizi  
...
## Gestione dei protocolli di rete server e client  
