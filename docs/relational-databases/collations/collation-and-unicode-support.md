...
ms.topic: "article"
helpviewer_keywords: 
  - "regole di confronto binarie [SQL Server]"
  - "regole di confronto a livello di espressione [SQL Server]"
  - "regole di confronto di Windows [SQL Server]"
  - "globalizzazione [SQL Server], informazioni sulla globalizzazione"
  - "supporto per caratteri supplementari"
  - "tabelle codici [SQL Server], informazioni sulle tabelle codici"
  - "regole di confronto [SQL Server], informazioni sulle regole di confronto"
  - "Unicode [SQL Server], regole di confronto"
  - "regole di confronto a livello di database [SQL Server]"
  - "ordine di lettura"
  - "regole di confronto a livello di colonna"
  - "impostazioni locali [SQL Server], informazioni sulle impostazioni locali"
  - "impostazioni locali [SQL Server]"
  - "tabelle codici [SQL Server]"
  - "regole di confronto di SQL Server"
  - "regole di confronto a livello di server [SQL Server]"
...
##  <a name="a-nametermsa-collation-terms"></a><a name="Terms"></a> Termini delle regole di confronto    
...
###  <a name="a-namecollationdefna-collation"></a><a name="Collation_Defn"></a> Confronto    
...
###  <a name="a-namelocaledefna-locale"></a><a name="Locale_Defn"></a> Impostazioni locali    
...
###  <a name="a-namecodepagedefna-code-page"></a><a name="Code_Page_Defn"></a> Tabella codici    
...
###  <a name="a-namesortorderdefna-sort-order"></a><a name="Sort_Order_Defn"></a> Ordinamento    
...
##  <a name="a-nameunicodedefna-unicode-support"></a><a name="Unicode_Defn"></a> Supporto Unicode    
...
##  <a name="a-namesupplementarycharactersa-supplementary-characters"></a><a name="Supplementary_Characters"></a> Caratteri supplementari    
...
##  <a name="a-namegb18030a-gb18030-support"></a><a name="GB18030"></a> Supporto GB18030    
...
##  <a name="a-namecomplexscripta-complex-script-support"></a><a name="Complex_script"></a> Supporto di lingue con alfabeti non latini    
...
##  <a name="a-namejapanesecollationsa-japanese-collations-added-in--includesssqlv14mdtokensqlv14sssqlv14mdmd"></a>Regole di confronto per il giapponese <a name="Japanese_Collations"></a> aggiunte in [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)]
...
##  <a name="a-namerelatedtasksa-related-tasks"></a><a name="Related_Tasks"></a> Attività correlate    
...
##  <a name="a-namerelatedcontenta-related-content"></a><a name="Related_Content"></a> Contenuto correlato    
 [SQL Server Best Practices Collation Change](http://go.microsoft.com/fwlink/?LinkId=113891) (Modifica delle regole di confronto di procedure consigliate di SQL Server)    
    
 [SQL Server Best Practices Migration to Unicode](http://go.microsoft.com/fwlink/?LinkId=113890) (Migrazione di procedure consigliate di SQL Server su Unicode)    
