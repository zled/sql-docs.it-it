---
title: Sys.syspermissions (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 03/15/2017
...
|**GRANTOR**|**smallint**|ID dell'utente, del gruppo o del ruolo che ha concesso o negato l'autorizzazione.|  
...
|**Sel**|**varbinary (4000)**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
