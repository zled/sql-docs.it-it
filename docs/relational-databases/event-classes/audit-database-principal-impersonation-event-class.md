...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Database Principal Impersonation - classe di evento"
...
---
# Classe di evento Audit Database Principal Impersonation
...
## Colonne di dati della classe di evento Audit Database Principal Impersonation  
...
|**ObjectType**|**int**|Valore che rappresenta il tipo di oggetto coinvolto nell'evento. Questo valore corrisponde alla colonna type nella vista del catalogo **sys.objects** . Per valori, vedere [Colonna ObjectType per gli eventi di traccia](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Sì|  
