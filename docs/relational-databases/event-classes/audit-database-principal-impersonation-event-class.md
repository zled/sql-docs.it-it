...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Audit Database Principal Impersonation** viene generata in presenza di una rappresentazione nell'ambito del database, ad esempio EXECUTE AS \<*utente*> o SETUSER.  
