...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento Missing Join Predicate indica che è in esecuzione una query priva di predicato join. Ciò può comportare tempi di esecuzione della query prolungati. Per altre informazioni sui predicati di join, vedere [Predicati &#40;Transact-SQL&#41;](~/t-sql/queries/predicates.md).  
