...
ms.topic: "article"
helpviewer_keywords: 
  - "funzionalità deprecate [SQL Server], fase annunciata di eventi"
  - "Deprecation Announcement - classe di evento"
...
## Colonne di dati della classe di evento Deprecation Announcement  
