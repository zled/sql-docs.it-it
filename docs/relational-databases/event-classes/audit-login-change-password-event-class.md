...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Login Change Password _- classe di evento"
...
---
# Classe di evento Audit Login Change Password
...
## Colonne di dati della classe di evento Audit Login Change Password  
