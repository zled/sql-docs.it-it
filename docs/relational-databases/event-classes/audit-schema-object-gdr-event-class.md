...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Audit Schema Object GDR** si verifica ogni volta che viene generata un'istruzione GRANT, REVOKE o DENY relativa all'autorizzazione per un oggetto dello schema da uno degli utenti di [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
