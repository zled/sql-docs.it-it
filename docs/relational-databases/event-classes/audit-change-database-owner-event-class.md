...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Change Database Owner - classe di evento"
...
---
# Classe di evento Audit Change Database Owner
...
## Colonne di dati della classe di evento Audit Change Database Owner  
