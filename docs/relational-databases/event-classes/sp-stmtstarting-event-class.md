...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento SP:StmtStarting indica che è stata avviata un'istruzione [!INCLUDE[tsql](../../includes/tsql-md.md)] in una stored procedure.  
