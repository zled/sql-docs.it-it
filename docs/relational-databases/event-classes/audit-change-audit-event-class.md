...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Audit Change Audit** si verifica ogni volta che si apporta una modifica alla traccia di controllo.  
