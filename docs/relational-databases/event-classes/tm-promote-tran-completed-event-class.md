...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento TM: Promote Tran Completed indica il completamento di una richiesta PROMOTE TRANSACTION. inviata dal client tramite l'interfaccia di gestione delle transazioni.  
