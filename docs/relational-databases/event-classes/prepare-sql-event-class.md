...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento Prepare SQL indica che una o più istruzioni [!INCLUDE[tsql](../../includes/tsql-md.md)] sono state preparate da SqlClient, ODBC, OLE DB o DB-Library.  
