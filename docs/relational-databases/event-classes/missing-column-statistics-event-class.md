...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento Missing Column Statistics indica che le statistiche di colonna, utilizzabili da Query Optimizer, non sono disponibili.  
