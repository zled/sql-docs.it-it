...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Bitmap Warning** può essere usata per monitorare l'uso del filtro bitmap nelle query. La sottoclasse dell'evento può essere utilizzata per segnalare quando i filtri bitmap sono stati disabilitati in una query.  
