...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento SQL:StmtCompleted indica il completamento di un'istruzione [!INCLUDE[tsql](../../includes/tsql-md.md)].  
