...
ms.topic: "article"
helpviewer_keywords: 
  - "Showplan XML Statistics Profile - classe di evento"
...
---
# Classe di evento Showplan XML Statistics Profile
...
## Colonne di dati della classe di evento Showplan XML Statistics Profile  
