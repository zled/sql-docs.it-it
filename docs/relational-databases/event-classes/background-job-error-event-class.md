...
ms.topic: "article"
helpviewer_keywords: 
  - "Background Job Error - classe di evento"
...
---
# Classe di evento Background Job Error
...
## Colonne di dati della classe di evento Background Job Error  
...
|**IndexID**|**int**|ID dell'indice dell'oggetto interessato dall'evento. Per determinare l'ID di indice di un oggetto, usare la colonna **indid** della tabella di sistema **sysindexes**.|24|Sì|  
