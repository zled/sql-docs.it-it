...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Add Login to Server Role - classe di evento"
...
---
# Classe di evento Audit Add Login to Server Role
...
## Colonne di dati della classe di evento Audit Add Login to Server Role  
