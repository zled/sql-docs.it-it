...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Audit Add Login to Server Role** viene generata quando viene aggiunto o rimosso un account di accesso da un ruolo predefinito del server. Questa classe di evento viene usata per le stored procedure **sp_addsrvrolemember** e **sp_dropsrvrolemember** .  
