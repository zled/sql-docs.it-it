...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento Scan:Started si verifica all'avvio dell'analisi di una tabella o di un indice.  
