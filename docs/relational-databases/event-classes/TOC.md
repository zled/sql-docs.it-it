...
# [Classe di evento Broker:Message Drop](broker-message-drop-event-class.md)
...
# [Categoria di eventi Security Audit (SQL Server Profiler)](security-audit-event-category-sql-server-profiler.md)
...
# [Categoria di eventi Transactions](transactions-event-category.md)
...
# [Categoria di eventi Objects](objects-event-category.md)
...
# [Guida di riferimento alla classe di evento SQL Server](sql-server-event-class-reference.md)
