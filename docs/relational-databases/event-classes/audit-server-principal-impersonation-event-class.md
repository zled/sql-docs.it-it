...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento **Audit Server Principal Impersonation** viene generata in presenza di una rappresentazione nell'ambito del server, come EXECUTE AS \<*Accesso*>.  
