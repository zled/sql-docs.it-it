...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Principal Impersonation - classe di evento"
...
---
# Classe di evento Audit Server Principal Impersonation
  La classe di evento **Audit Server Principal Impersonation** viene generata in presenza di una rappresentazione nell'ambito del server, come EXECUTE AS \<*login*>.  
  
## Colonne di dati della classe di evento Audit Server Principal Impersonation  
