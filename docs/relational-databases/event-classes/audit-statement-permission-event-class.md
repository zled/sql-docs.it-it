...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Statement Permission - classe di evento"
...
---
# Classe di evento Audit Statement Permission
...
## Colonne di dati della classe di evento Audit Statement Permission  
