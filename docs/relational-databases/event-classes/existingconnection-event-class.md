...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento ExistingConnection indica le proprietà delle connessioni utente esistenti al momento dell'avvio della traccia. Il server genera un evento ExistingConnection per ogni connessione utente esistente.  
