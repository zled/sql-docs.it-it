...
ms.topic: "article"
helpviewer_keywords: 
  - "Classi di eventi SQL Server, valori della colonna ObjectType"
  - "eventi [SQL Server], valori della colonna ObjectType"
  - "classi di eventi [SQL Server], valori della colonna ObjectType"
  - "valori della colonna ObjectType [SQL Server]"
...
---
# Colonna ObjectType per gli eventi di traccia
...
## Valori della colonna ObjectType  
