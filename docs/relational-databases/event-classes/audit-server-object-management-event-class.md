...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Server Object Management - classe di evento"
...
---
# Classe di evento Audit Server Object Management
  La classe di evento **Audit Server Object Management** viene generata in caso di CREATE, ALTER o DROP per oggetti server.  
  
## Colonne di dati della classe di evento Audit Server Object Management  
