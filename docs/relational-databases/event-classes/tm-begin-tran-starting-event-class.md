...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La classe di evento TM: Begin Tran Starting indica l'avvio di una richiesta BEGIN TRANSACTION. inviata dal client tramite l'interfaccia di gestione delle transazioni.  
