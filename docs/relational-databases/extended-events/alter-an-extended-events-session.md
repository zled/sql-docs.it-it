...
## Modifica di una sessione Eventi estesi utilizzando la Creazione guidata Eventi estesi SQL Server  
...
## Vedere anche  
 ...
 [Creare una sessione Eventi estesi tramite l'editor di query](../Topic/Create%20an%20Extended%20Events%20Session%20Using%20Query%20Editor.md)  
