...
manager: "jhubbard"
---
# Guida sensibile al contesto di Gestione Utilit&#224;
  ...
  ## Dashboard Utilità (Utilità SQL Server)
...
-   Dati non disponibili - I dati per le istanze gestite di SQL Server non sono disponibili perché l'istanza di SQL Server è appena stata inclusa e la prima operazione di raccolta dati non è stata completata o perché si è verificato un problema con l'istanza gestita di SQL Server durante la raccolta e il caricamento dei dati nel punto di controllo dell'utilità.  
 ...
 Per altre informazioni sulla visualizzazione dello stato di integrità per singole istanze di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] o per visualizzare o modificare impostazioni di configurazione dei criteri, vedere [Dettagli di istanze gestite &#40;Utilità SQL Server&#41;](../Topic/Managed%20Instance%20Details%20\(SQL%20Server%20Utility\).md).  
...
-   1 anno, visualizzato in intervalli di 1 mese.  
 ...
 ## Dettagli delle applicazioni livello dati distribuite (Utilità SQL Server)
...
## Dettagli di istanze gestite (Utilità SQL Server)
...
-   Frequenza di caricamento del set di raccolta: ogni 15 minuti.  
 ...
 La directory del data warehouse di gestione dell'utilità è configurabile: \<Unità sistema>:\Programmi\Microsoft SQL Server\MSSQL10_50.\<nome punto di controllo dell'utilità>\MSSQL\Data\\, dove \<Unità sistema> è solitamente l'unità C:\. Il file di log UMDW_\<GUID>_LOG si trova nella stessa directory.  
