...
ms.topic: "article"
helpviewer_keywords: 
  - "procedura guidata [applicazione livello dati], decompressione"
  - "applicazione livello dati [SQL Server], decompressione"
  - "procedura [applicazione livello dati], decompressione"
  - "decompressione di un'applicazione livello dati"
...
##  <a name="UnpackDACDial"></a> Finestra di dialogo per la decompressione dell'applicazione livello dati  
...
##  <a name="ExamDACPack"></a> Verifica del contenuto di un pacchetto di applicazione livello dati  
