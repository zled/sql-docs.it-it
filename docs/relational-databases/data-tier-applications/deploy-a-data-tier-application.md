...
helpviewer_keywords: 
  ...
  - "distribuire applicazione livello dati"
  - "applicazione livello dati [SQL Server], distribuzione"
  - "procedura [applicazione livello dati], distribuzione"
  - "procedura guidata [applicazione livello dati], distribuzione"
...
-   **Per distribuire un'applicazione livello dati, usando:** la [procedura guidata Distribuisci applicazione livello dati](#UsingDeployDACWizard), [PowerShell](#DeployDACPowerShell)  
 ...
 **Annulla** consente di terminare la procedura guidata senza distribuire un'applicazione livello dati.  
 ...
 [&#91;Distribuzione guidata&#93;](#UsingDeployDACWizard)  
  
##  <a name="Select_dac_package"></a> Pagina Selezione pacchetto di applicazione livello dati  
 ...
 **\< Indietro**: consente di tornare alla pagina**Aggiorna configurazione** per modificare le selezioni.  
