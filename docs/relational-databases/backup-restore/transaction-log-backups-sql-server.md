...
ms.topic: "article"
helpviewer_keywords: 
  - "esecuzione del backup [SQL Server], log delle transazioni"
  - "backup dei log delle transazioni [SQL Server], creazione"
  - "backup di log [SQL Server]"
  - "backup dei log delle transazioni [SQL Server], sequenza"
