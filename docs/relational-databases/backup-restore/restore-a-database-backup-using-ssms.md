...
helpviewer_keywords: 
  ...
  - "ripristini di database [SQL Server], backup completi"
  - "esecuzione del backup dei database [SQL Server], backup completi"
  - "backup dei database [SQL Server], backup completi"
  - "ripristino di database [SQL Server], backup completi"
...
---
# Ripristinare un backup del database tramite SSMS
...
### **A. Ripristinare un backup del database completo**    
...
6.  Nella griglia **Selezionare i set di backup da ripristinare** selezionare i set di backup che si desidera ripristinare. In questa griglia vengono visualizzati i backup disponibili per il percorso specificato. Per impostazione predefinita, viene suggerito un piano di recupero. Per ignorare il piano di recupero suggerito, è possibile modificare le impostazioni selezionate nella griglia. I backup che dipendono dal ripristino di un backup precedente vengono automaticamente deselezionati quando il backup precedente è deselezionato. Per informazioni sulle colonne nella griglia **Set di backup da ripristinare**, vedere [Ripristina database&#40;(pagina Generale)&#41;](../../relational-databases/backup-restore/restore-database-general-page.md).    
...
### **B. Ripristinare un backup del disco precedente su un database esistente**    
...
### **C.  Ripristinare un backup del disco precedente con un nome di database nuovo in cui è già esistente il database originale**
...
### **D.  Ripristinare i backup del disco precedenti in un momento specifico**
...
#### **F.   Ripristinare un backup locale nell'archiviazione di Microsoft Azure**
