...
ms.topic: "article"
helpviewer_keywords: 
  - "database di sistema [SQL Server], backup e ripristino"
  - "ripristino di database di sistema [SQL Server]"
  - "backup [SQL Server], database di sistema"
  - "backup di database [SQL Server], database di sistema"
