...
ms.topic: "article"
helpviewer_keywords: 
  - "sequenze di ripristino [SQL Server], pianificazione"
  - "modello di recupero con registrazione completa [SQL Server], pianificazione di sequenze di ripristino"
