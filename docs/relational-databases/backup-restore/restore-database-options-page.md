 ...
 **Mantieni le impostazioni di replica (WITH KEEP_REPLICATION)**  
 ...
 La selezione di questa opzione equivale all'uso dell'opzione KEEP_REPLICATION in un'istruzione [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md).  
