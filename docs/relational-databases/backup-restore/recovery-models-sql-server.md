...
helpviewer_keywords: 
  ...
  - "modello di recupero con registrazione minima delle operazioni bulk [SQL Server]"
  - "recupero [SQL Server], modello di recupero"
  - "ripristino di log delle transazioni [SQL Server], modelli di recupero"
  - "backup di database [SQL Server], modelli di recupero"
  - "modelli di recupero [SQL Server], informazioni"
  - "backup di log delle transazioni [SQL Server]"
  - "modello di recupero con registrazione minima [SQL Server]"
  - "backup [SQL Server], modelli di recupero"
  - "modelli di recupero [SQL Server]"
  - "modelli di recupero [SQL Server], gestione del log delle transazioni"
  - "ripristini di database [SQL Server], modelli di recupero"
  - "ripristini di log delle transazioni [SQL Server]"
  - "log [SQL Server], modelli di recupero"
  - "ripristino di database [SQL Server], modelli di recupero"
  - "modello di recupero con registrazione completa [SQL Server]"
  - "backup di log delle transazioni [SQL Server], modelli di recupero"
