---
title: "Utilizzare Transazioni contrassegnate per recuperare coerentemente i database correlati (Modello di recupero con registrazione completa) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "contrassegni di transazione [SQL Server]"
  - "transazioni contrassegnate [SQL Server]"
  - "ripristini di database [SQL Server], inserimento di contrassegni transazione"
  - "recupero [SQL Server], database correlati"
  - "ripristino di database [SQL Server], recupero di database correlati"
  - "ripristini di database [SQL Server], database correlati"
  - "transazioni contrassegnate [SQL Server], creazione"
  - "BEGIN TRAN...WITH MARK - istruzione"
  - "commit in due fasi"
...
manager: "jhubbard"
---
# Utilizzare Transazioni contrassegnate per recuperare coerentemente i database correlati (Modello di recupero con registrazione completa)
...
## Distribuzione forzata di un contrassegno in altri server  
