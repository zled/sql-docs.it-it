---
title: "Specifica se un&#39;operazione di backup o ripristino viene arrestata o prosegue in seguito a un errore (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
helpviewer_keywords: 
  ...
  - "esecuzione del backup dei database [SQL Server], errori"
  - "backup [SQL Server], errori"
  - "backup dei database [SQL Server], errori"
...
manager: "jhubbard"
---
# Specifica se un&#39;operazione di backup o ripristino viene arrestata o prosegue in seguito a un errore (SQL Server)
...
#### Per specificare se il backup viene arrestato o prosegue se viene rilevato un errore  
...
#### Per specificare se un'operazione di backup viene arrestata o prosegue in seguito a un errore  
...
#### Per specificare se un'operazione di ripristino viene arrestata o prosegue in seguito a un errore  
  
1.  Connettersi al [!INCLUDE[ssDE](../../includes/ssde-md.md)].  
  
2.  Dalla barra Standard fare clic su **Nuova query**.  
  
3.  Nell'istruzione [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) specificare l'opzione CONTINUE_AFTER ERROR per continuare o l'opzione STOP_ON_ERROR per interrompere. Il comportamento predefinito è l'arresto nel caso venga rilevato un errore. In questo esempio si indica all'operazione di ripristino di continuare nonostante sia stato rilevato un errore.  
