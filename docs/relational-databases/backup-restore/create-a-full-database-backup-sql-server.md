---
title: "Creazione di un backup completo del database (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/25/2016"
...
helpviewer_keywords: 
  ...
  - "esecuzione del backup dei database [SQL Server], SQL Server Management Studio"
  - "backup [SQL Server], creazione"
  - "backup dei database [SQL Server], SQL Server Management Studio"
...
### Esempi  
#### **A.  Eseguire il backup completo su disco nel percorso predefinito**
...
#### **D.  Eseguire il backup nel servizio di archiviazione BLOB di Microsoft Azure**
#### **Passaggi comuni**  
...
#### **B.  Backup completo in Microsoft Azure**  
