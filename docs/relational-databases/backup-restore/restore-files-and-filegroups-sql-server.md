---
title: "Ripristino di file e filegroup (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], ripristino di file e di filegroup"
...
---
# Ripristino di file e filegroup (SQL Server)
...
11. Il pannello **Stato di recupero** determina lo stato del database dopo l'operazione di ripristino.  
     ...
     **Lascia il database non operativo e non eseguire il rollback delle transazioni di cui non è stato eseguito il commit. È possibile ripristinare altri log delle transazioni. (RESTORE WITH NORECOVERY)**  
