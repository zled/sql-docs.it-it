...
helpviewer_keywords: 
  ...
  - "stima delle dimensioni di backup di database"
  - "esecuzione del backup [SQL Server], dimensioni del backup"
  - "backup dei database [SQL Server], backup completi"
  - "dimensioni [SQL Server], backup"
...
### Esempio ([!INCLUDE[tsql](../../includes/tsql-md.md)])  
