...
ms.topic: "article"
helpviewer_keywords: 
  - "agente di raccolta dati [SQL Server], attività del server"
  - "attività del server [SQL Server]"
  - "report [SQL Server], raccolta dati"
  - "report [SQL Server], utilizzo del disco"
  - "set di raccolta [SQL Server], report"
  - "agente di raccolta dati [SQL Server], report"
  - "report [SQL Server], statistiche sulle query"
  - "report delle statistiche sulle query [SQL Server]"
  - "report sull'utilizzo del disco [SQL Server]"
...
---
# Report per i set di raccolta dati di sistema
...
### Report del set di raccolta Utilizzo disco  
...
#### Sottoreport del set di raccolta Utilizzo disco - Database: <database_name>  
...
#### Sottoreport Utilizzo disco per database: <database_name>  
...
### Selezione dei dati da includere nel report  
...
#### Report Cronologia statistiche query  
...
#### Sottoreport Dettagli piano query  
...
## Report Cronologia attività server  
