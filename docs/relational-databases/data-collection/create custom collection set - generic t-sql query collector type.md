---
title: "Creazione di un set di raccolta personalizzato che utilizza il tipo agente di raccolta Query T-SQL generico (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "tipo agente di raccolta Query T-SQL"
  - "set di raccolta [SQL Server], creazione personalizzati"
...
manager: "jhubbard"
---
# Creazione di un set di raccolta personalizzato che utilizza il tipo agente di raccolta Query T-SQL generico (Transact-SQL)
...
### Verifica dell'esistenza del nuovo set di raccolta a dell'elemento della raccolta  
