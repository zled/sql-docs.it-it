...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] È possibile visualizzare o modificare le pianificazioni dei set di raccolta usando [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
