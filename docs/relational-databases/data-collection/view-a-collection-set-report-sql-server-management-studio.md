...
helpviewer_keywords: 
  - "set di raccolta [SQL Server], visualizzazione dei report"
  - "report [SQL Server], visualizzazione del set di raccolta"
...
### Per visualizzare un report di un set di raccolta  
...
#### Calendario report di raccolta dati  
