# [Panoramica](system-tables-transact-sql.md)  
# [Estendere le tabelle degli eventi - contenute](extended-events-tables-trace-xe-action-map.md)  
# [Estendere le tabelle degli eventi - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tabelle di applicazione livello dati - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tabelle di applicazione livello dati - sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Mapping di tabelle di sistema di viste di sistema](mapping-system-tables-to-system-views-transact-sql.md)  
# [Tabelle di Base di sistema](system-base-tables.md)  
# [Tabelle di backup e ripristino](backup-and-restore-tables-transact-sql.md)  
...
# [Tabelle Change Data Capture](change-data-capture-tables-transact-sql.md)  
...
# [Tabelle di piano di manutenzione database](database-maintenance-plan-tables-transact-sql.md)  
...
# [Tabelle Integration Services](integration-services-tables-transact-sql.md)  
...
# [Tabelle di log Shipping](log-shipping-tables-transact-sql.md)  
...
# [Tabelle di SQL Server Agent](sql-server-agent-tables-transact-sql.md)  
...
# [Tabelle di replica](replication-tables-transact-sql.md)  
