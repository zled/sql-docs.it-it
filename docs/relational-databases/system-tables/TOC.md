...
# [Tabelle eventi estesi - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Tabelle eventi estesi - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tabelle applicazioni livello dati - sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tabelle applicazioni livello dati - sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Mapping di tabelle di sistema a viste di sistema](mapping-system-tables-to-system-views-transact-sql.md)  
...
# [Tabelle di Change Data Capture](change-data-capture-tables-transact-sql.md)  
...
# [Tabelle dei piani di manutenzione database](database-maintenance-plan-tables-transact-sql.md)  
...
# [Tabelle di Integration Services](integration-services-tables-transact-sql.md)  
