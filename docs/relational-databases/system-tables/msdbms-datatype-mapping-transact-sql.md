...
|**dest_createparams**|**int**|Mappa di bit che descrive quale combinazione di lunghezza, precisione e scala è applicabile a ogni tipo di dati. Sono disponibili i valori seguenti:<br /><br /> **0x1** = precisione.<br /><br /> **0x2** = scala.<br /><br /> **0x4** = lunghezza.|  
