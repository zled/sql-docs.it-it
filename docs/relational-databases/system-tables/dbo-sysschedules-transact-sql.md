...
|**valore schedule_uid**|**uniqueidentifier**|Identificatore univoco della pianificazione dei processi. Questo valore viene utilizzato per identificare una pianificazione per i processi distribuiti.|  
...
|**abilitato**|**int**|Stato della pianificazione dei processi:<br /><br /> **0** = non abilitata.<br /><br /> **1** = abilitato.<br /><br /> Quando la pianificazione non è abilitata, non verrà eseguito alcun processo su questa pianificazione.|  
...
|**freq_relative_interval**|**int**|Quando **freq_interval** si verifica in ogni mese, se **freq_interval** è **32** (frequenza mensile relativa). I possibili valori sono i seguenti:<br /><br /> **0** = **freq_relative_interval** viene utilizzato<br /><br /> **1** = primo<br /><br /> **2** = secondi<br /><br /> **4** = terzo<br /><br /> **8** = quarto<br /><br /> **16** = ultimo|  
|**freq_recurrence_**<br /><br /> **fattore**|**int**|Numero di settimane o mesi tra le esecuzioni pianificate di un processo. **freq_recurrence_factor** viene utilizzata solo se **freq_type** è **8**, **16**, o **32**. Se questa colonna contiene **0**, **freq_recurrence_factor** è inutilizzato.|  
...
|-------------------------|------------------------------|  
|**1** (una volta)|**freq_interval** è inutilizzato (**0**)|  
|**4** (giornaliera)|Ogni **freq_interval** giorni|  
|**8** (settimanale)|**freq_interval** uno o più dei seguenti:<br /><br /> **1** = domenica<br /><br /> **2** = lunedì<br /><br /> **4** = martedì<br /><br /> **8** = mercoledì<br /><br /> **16** = giovedì<br /><br /> **32** = venerdì<br /><br /> **64** = sabato|  
...
|**64** (inizia all'avvio del servizio Agente SQL Server)|**freq_interval** è inutilizzato (**0**)|  
|**128** (viene eseguito quando il computer è inattivo)|**freq_interval** è inutilizzato (**0**)|  
