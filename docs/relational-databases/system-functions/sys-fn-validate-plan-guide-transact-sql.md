 ...
 *plan_guide_id*  
 È l'ID della Guida di piano come riportato nel [plan_guides](../../relational-databases/system-catalog-views/sys-plan-guides-transact-sql.md) vista del catalogo. *plan_guide_id* è **int** prevede alcun valore predefinito.  
