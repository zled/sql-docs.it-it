...
[!INCLUDE[SNAC_Deprecated](../../../includes/snac-deprecated.md)]
  ...
  Un batch di [!INCLUDE[tsql](../../../includes/tsql-md.md)] istruzioni contiene due o più istruzioni, separate da punto e virgola (;), incorporato in una singola stringa passata a **SQLExecDirect** o [funzione SQLPrepare](http://go.microsoft.com/fwlink/?LinkId=59360). Ad esempio  
