...
helpviewer_keywords: 
  ...
  - "RWS"
  - "LAT"
  - "server proxy [SQL Server]"
  - "connessioni server [SQL Server], server proxy"
  - "Microsoft Proxy Server [SQL Server]"
  - "Local Address Table [SQL Server]"
...
##  <a name="a-namessmsprocedurea-using-sql-server-configuration-manager"></a><a name="SSMSProcedure"></a> Uso di Gestione configurazione SQL Server  
