...
ms.topic: "article"
helpviewer_keywords: 
  - "periodo di memorizzazione del backup [SQL Server]"
  - "set di backup [SQL Server], periodo di memorizzazione"
  - "media retention - opzione"
...
---
# Configurare l&#39;opzione di configurazione del server media retention
...
#### Per configurare l'opzione media retention  
