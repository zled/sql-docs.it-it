...
ms.topic: "article"
helpviewer_keywords: 
  - "gestione server [SQL Server], connessioni"
  - "connessioni amministrative [SQL Server]"
  - "porte [SQL Server], applicazione livello dati"
  - "DAC"
  - "connessioni di rete [SQL Server], connessioni amministrative dedicate"
  - "connessioni di diagnostica [SQL Server]"
