...
ms.topic: "article"
helpviewer_keywords: 
  - "query [SQL Server], tempo di esecuzione"
  - "query governor cost limit - opzione [SQL Server]"
  - "tempo [SQL Server], tempo di esecuzione della query"
...
---
# Configurare l&#39;opzione di configurazione del server query governor cost limit
...
#### Per configurare l'opzione query governor cost limit  
