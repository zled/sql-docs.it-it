...
ms.topic: "article"
helpviewer_keywords: 
  - "transazioni distribuite [SQL Server], transazioni non risolte"
  - "transazioni non risolte"
  - "in-doubt xact resolution - opzione"
...
---
# Opzione di configurazione del server in-doubt xact resolution
