---
title: "Avviare, arrestare, sospendere, riprendere, riavviare il motore di database, SQL Server Agent o SQL Server Browser | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Gestione configurazione SQL Server, avviare e arrestare servizi"
  - "arresto di SQL Server Agent"
  - "parametri [SQL Server], opzioni di avvio"
  - "SQL Server, opzioni di avvio"
  - "Motore di database [SQL Server], avvio e arresto di servizi"
  - "sospensione di SQL Server"
  - "PowerShell [SQL Server], avvio e arresto di servizi"
  - "modalità utente singolo [SQL Server], avvio"
  - "SQL Server Management Studio [SQL Server], avvio e arresto di servizi"
  - "arresto del servizio SQL Server Browser"
  - "avvio di SQL Server Agent"
  - "istanze predefinite [SQL Server], avvio e arresto"
  - "SQL Server Agent, avvio e arresto"
  - "prompt dei comandi [SQL Server], avvio e arresto di servizi SQL Server"
  - "prosecuzione dell'esecuzione di SQL Server"
  - "avvio del motore di database di SQL Server"
  - "net stop - comandi [SQL Server]"
  - "prompt dei comandi [SQL Server], SQL Browser - servizio"
  - "Gestione configurazione, avviare e arrestare servizi"
  - "ripresa dell'esecuzione di SQL Server"
  - "opzioni di avvio [SQL Server]"
  - "istanze denominate [SQL Server], avvio e arresto"
  - "net start - comandi [SQL Server]"
  - "SQL Server, avvio e arresto"
  - "arresto di SQL Server"
  - "avvio del servizio SQL Server Browser"
  - "opzioni di avvio dell'impostazione del motore di database di SQL Server"
  - "amministrazione di SQL Server, avvio e arresto di servizi"
  - "Management Studio [SQL Server], avvio e arresto di servizi"
...
#### Avvio di Gestione configurazione [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Per avviare, arrestare, sospendere, riprendere o riavviare un'istanza del [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  Per avviare un'istanza di [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] con le opzioni di avvio, vedere [Configurare le opzioni di avvio del server &#40;Gestione configurazione SQL Server&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
#### Per avviare, arrestare, sospendere, riprendere o riavviare [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser o un'istanza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent  
...
#### Per avviare, arrestare o riavviare un'istanza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent  
...
#### Per arrestare il [!INCLUDE[ssDE](../../includes/ssde-md.md)] tramite [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### Per avviare e arrestare i servizi del [!INCLUDE[ssDE](../../includes/ssde-md.md)]  
...
## Vedere anche  
 [Panoramica sulla documentazione del programma di installazione di SQL Server](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
