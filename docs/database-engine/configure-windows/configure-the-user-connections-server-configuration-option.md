...
ms.topic: "article"
helpviewer_keywords: 
  - "connessioni simultanee[SQL Server]"
  - "user connections - opzione [SQL Server]"
  - "utenti [SQL Server], connessioni simultanee"
  - "numero massimo di connessioni utente simultanee"
  - "connessioni [SQL Server], simultanee"
