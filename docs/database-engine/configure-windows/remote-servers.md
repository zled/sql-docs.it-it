...
ms.topic: "article"
helpviewer_keywords: 
  - "gestione server [SQL Server], server remoti"
  - "server remoti [SQL Server], configurazione"
  - "server remoti [SQL Server]"
  - "server [SQL Server], remoti"
  - "opzione accesso remoto"
...
## Informazioni sui server remoti  
...
### Esempio di sicurezza del server remoto  
...
## Visualizzazione delle proprietà dei server locali o remoti  
