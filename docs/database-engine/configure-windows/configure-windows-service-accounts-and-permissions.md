...
||\<Account del servizio Web ReportServer>|*\<installazione>*\Reporting Services\ReportServer\global.asax|Completo|  
...
||NETWORK SERVICE|*\<installazione>*\Reporting Services\ReportServer\ReportService.asmx|Completo|  
