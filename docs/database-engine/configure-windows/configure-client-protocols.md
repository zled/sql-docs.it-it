...
helpviewer_keywords: 
  ...
  - "protocolli di rete [SQL Server], configurazione client"
  - "TCP/IP [SQL Server], protocolli client"
  - "disabilitazione di protocolli client"
  - "ordine dei protocolli [SQL Server]"
  - "protocolli [SQL Server], ordine per i computer client"
  - "configurazione di protocolli client"
  - "protocolli client [SQL Server]"
  - "protocolli [SQL Server], configurazione client"
  - "protocolli predefiniti, client"
...
-   Alcune applicazioni client, ad esempio sqlcmd.exe, possono specificare il protocollo nella stringa di connessione. Per altre informazioni, vedere [Connessione al Motore di database tramite sqlcmd](../../relational-databases/scripting/connect-to-the-database-engine-with-sqlcmd.md).  
