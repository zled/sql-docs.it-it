...
helpviewer_keywords: 
  - "criteri comuni [Motore di database]"
  - "conformità ai criteri comuni [Motore di database]"
  - "Protezione delle informazioni residuali [Motore di database]"
  - "RIP (Residual Information Protection, Protezione delle informazioni residuali)"
