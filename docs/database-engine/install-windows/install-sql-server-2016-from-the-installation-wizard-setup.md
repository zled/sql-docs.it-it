...
ms.topic: "article"
helpviewer_keywords: 
  - "installazione di SQL Server, passaggi"
  - "installazione [SQL Server], passaggi"
...
-   [Installazione di SQL Server 2016 con SysPrep](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md)  
...
-   [Installare edizioni gratuite di SQL Server 2016 direttamente da Internet](../../database-engine/install-windows/install-sql-server-2016.md#bkmk_basicInstaller) 
...
Microsoft ha rilevato un problema con una specifica versione dei file binari di Microsoft VC++ 2013 Runtime installata come prerequisito da SQL Server 2016. Se questo aggiornamento dei file binari di VC++ Runtime non viene installato, potrebbero verificarsi problemi di stabilità di SQL Server 2016 in determinati scenari. Prima di installare SQL Server 2016, seguire le istruzioni in [Note sulla versione di SQL Server 2016](../../sql-server/sql-server-2016-release-notes.md#bkmk_ga_instalpatch) per vedere se il computer richiede una patch per i file binari di VC++ Runtime. 
  
## Per installare [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
12. Nella pagina Configurazione dell'istanza specificare se si desidera installare un'istanza predefinita o un'istanza denominata. Per ulteriori informazioni, vedere [Instance Configuration](../Topic/Instance%20Configuration.md).  
...
14. Utilizzare la pagina Configurazione del [!INCLUDE[ssDE](../../includes/ssde-md.md)] - Configurazione server per specificare gli elementi seguenti:  
    ...
    >  Se si specificano directory di installazione non predefinite, verificare che le cartelle di installazione siano univoche per l'istanza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Nessuna delle directory presenti in questa finestra di dialogo deve essere condivisa con le directory di altre istanze di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
     ...
     Per altre informazioni, vedere [Configurazione del motore di database - Directory dati](../Topic/Database%20Engine%20Configuration%20-%20Data%20Directories.md).  
...
16. Utilizzare la pagina Configurazione di [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] per specificare il tipo di installazione di [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] da creare. Per altre informazioni sulle modalità di configurazione di [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] e le opzioni disponibili, vedere [Opzioni di configurazione di Reporting Services &#40;SSRS&#41;](../Topic/Reporting%20Services%20Configuration%20Options%20\(SSRS\).md).  
