...
helpviewer_keywords: 
  ...
  - "database [Analysis Services], aggiornamento"
  - "installazione di Analysis Services, installazioni side-by-side"
  - "aggiornamenti di Analysis Services"
  - "aggiornamenti di Analysis Services, informazioni sull'aggiornamento di Analysis Services"
  - "SSAS, migrazione di database"
  - "aggiornamento di Analysis Services"
  - "installazione di Analysis Services, aggiornamento"
  - "SSAS, aggiornamento"
...
---
# Aggiornare Analysis Services
  Le istanze di Analysis Services possono essere aggiornate a una versione di SQL Server 2016 con la stessa modalità server per sfruttare i vantaggi delle funzionalità introdotte nella versione corrente, come descritto in [What's New in Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md).  
...
-   [SQL Server 2016 Release Notes (Note sulla versione di SQL Server 2016)](http://go.microsoft.com/fwlink/?LinkID=398124) descrive problemi noti e soluzioni alternative.  
...
## Aggiornamento del modello tabulare al livello di compatibilità 1200  
...
## Post-aggiornamento per i modelli tabulari a livello di compatibilità 1200  
...
## Aggiornare i modelli tabulari in modalità DirectQuery  
...
4.  Riattivare **DirectQuery** . Vedere [DirectQuery for Tabular 1200 models](../Topic/DirectQuery%20for%20Tabular%201200%20models.md) per maggiori informazioni.  
...
## Vedere anche  
 ...
 [Installazione di Analysis Services in modalità Multidimensionale e Data Mining](../Topic/Install%20Analysis%20Services%20in%20Multidimensional%20and%20Data%20Mining%20Mode.md)   
