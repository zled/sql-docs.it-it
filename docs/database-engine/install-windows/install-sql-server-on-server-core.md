...
|-------------|---------------|----------------------------|  
|[!INCLUDE[ssDE](../../includes/ssde-md.md)] Servizi|Sì||  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Documentazione online|no||  
