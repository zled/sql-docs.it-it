...
---
# Considerazioni sull&#39;installazione di SQL Server tramite SysPrep
...
-   [Completare l'immagine](#BKMK_CompleteImage)  
 ...
 Per altre informazioni su come eseguire l'installazione di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] tramite SysPrep, vedere [Installazione di SQL Server 2016 con SysPrep](../../database-engine/install-windows/install-sql-server-2016-using-sysprep.md).  
  
## Utilizzi comuni di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] SysPrep  
...
## Considerazioni sul supporto di installazione  
...
## Installazioni di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] supportate  
 ...
 Per informazioni sulle edizioni supportate di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], vedere [Funzionalità supportate dalle edizioni di SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
