---
title: "Specifica dell&#39;URL dell&#39;endpoint quando si aggiunge o si modifica una replica di disponibilit&#224; (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "endpoint [SQL Server], gruppi di disponibilità AlwaysOn"
  - "gruppi di disponibilità [SQL Server], configurazione"
  - "gruppi di disponibilità [SQL Server], endpoint"
  - "URL di endpoint (HADR)"
