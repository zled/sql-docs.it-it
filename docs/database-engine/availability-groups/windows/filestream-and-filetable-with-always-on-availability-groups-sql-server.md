...
ms.topic: "article"
helpviewer_keywords: 
  - "FileTable [SQL Server], gruppi di disponibilità"
  - "FILESTREAM [SQL Server], gruppi di disponibilità"
...
---
# FILESTREAM e FileTable con i gruppi di disponibilit&#224; AlwaysOn (SQL Server)
