...
ms.topic: "article"
helpviewer_keywords: 
  - "rilevamento modifiche [SQL Server], gruppi di disponibilità AlwaysOn"
  - "Change Data Capture [SQL Server], gruppi di disponibilità AlwaysOn"
...
manager: "jhubbard"
---
# Replica, Rilevamento modifiche, Change Data Capture e Gruppi di disponibilit&#224; AlwaysOn (SQL Server)
...
-   [Panoramica della replica nei gruppi di disponibilità AlwaysOn](#Overview)  
  
    -   [Reindirizzamento del server di pubblicazione](#PublisherRedirect)  
  
    -   [Modifiche apportate agli agenti di replica per supportare i gruppi di disponibilità AlwaysOn](#Changes)  
  
    -   [Stored procedure che supportano AlwaysOn](#StoredProcs)  
  
    -   [Change Data Capture](#CDC)  
  
    -   [Rilevamento delle modifiche](#CT)  
  
-   [Prerequisiti, restrizioni e considerazioni per l'utilizzo della replica con gruppi di disponibilità AlwaysOn](#Prereqs)  
...
###  <a name="PublisherRedirect"></a> Reindirizzamento del server di pubblicazione  
 ...
 In un gruppo di disponibilità AlwaysOn un database secondario non può essere un server di pubblicazione. La ripubblicazione è supportata solo quando la replica transazionale è combinata con [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)].  
...
#### Modifiche all'agente di lettura log  
