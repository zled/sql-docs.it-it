...
helpviewer_keywords: 
  ...
  - "Gruppi di disponibilità [SQL Server], commit asincrono"
  - "modalità di disponibilità con commit sincrono"
  - "Gruppi di disponibilità [SQL Server], commit sincrono"
...
-   [Modalità di disponibilità con commit asincrono](#AsyncCommitAvMode)  
  
-   [Modalità di disponibilità commit sincrono](#SyncCommitAvMode)  
...
##  <a name="AsyncCommitAvMode"></a> Modalità di disponibilità con commit asincrono  
...
##  <a name="SyncCommitAvMode"></a> Modalità di disponibilità commit sincrono  
