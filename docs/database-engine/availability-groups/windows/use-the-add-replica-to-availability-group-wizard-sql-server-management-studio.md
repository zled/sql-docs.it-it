---
title: "Utilizzare la procedura guidata Aggiungi replica a gruppo di disponibilit&#224; (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "05/17/2016"
...
---
# Utilizzare la procedura guidata Aggiungi replica a gruppo di disponibilit&#224; (SQL Server Management Studio)
...
-   **Per aggiungere una replica con:** [Procedura guidata Aggiungi replica a gruppo di disponibilità (SQL Server Management Studio)](#SSMSProcedure)  
...
10. La pagina **Stato** visualizza lo stato di avanzamento dei passaggi per la creazione del gruppo di disponibilità, ovvero configurazione di endpoint, creazione del gruppo di disponibilità e creazione di un join della replica secondaria al gruppo.  
