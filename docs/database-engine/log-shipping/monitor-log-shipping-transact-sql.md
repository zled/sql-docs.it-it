...
ms.topic: "article"
helpviewer_keywords: 
  - "log shipping [SQL Server], stato"
  - "tabelle di cronologia [SQL Server]"
  - "informazioni cronologiche [SQL Server], log shipping"
  - "log shipping [SQL Server], monitoraggio"
  - "avvisi [SQL Server], log shipping"
  - "informazioni di stato [SQL Server], log shipping"
  - "monitoraggio di log shipping [SQL Server]"
