...
helpviewer_keywords: 
  ...
  - "cataloghi full-text [SQL Server], mirroring del database"
  - "cataloghi [SQL Server], mirroring del database"
...
---
# Mirroring di database e cataloghi full-text (SQL Server)
