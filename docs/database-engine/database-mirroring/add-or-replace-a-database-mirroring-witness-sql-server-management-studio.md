---
title: "Aggiunta o sostituzione di un server di controllo del mirroring del database (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Aggiunta o sostituzione di un server di controllo del mirroring del database (SQL Server Management Studio)
...
### Per aggiungere o sostituire un server di controllo del mirroring  
