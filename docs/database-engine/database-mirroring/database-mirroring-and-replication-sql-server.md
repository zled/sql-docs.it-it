...
helpviewer_keywords: 
  ...
  - "replica [SQL Server], mirroring del database e"
...
## Configurazione della replica con il mirroring del database  
...
## Gestione di un database di pubblicazione con mirroring  
...
## Funzionamento dell'agente di lettura log  
