...
# [Mirroring di database e cataloghi full-text](database-mirroring-and-full-text-catalogs-sql-server.md)
...
# [Impostazione del mirroring del database](setting-up-database-mirroring-sql-server.md)
...
# [Utilizzare i valori di soglia avvisi e avvisi sulle metriche delle prestazioni di mirroring](use-warning-thresholds-and-alerts-on-mirroring-performance-metrics-sql-server.md)
...
# [Preparazione di un database mirror per il mirroring](prepare-a-mirror-database-for-mirroring-sql-server.md)
...
# [Concessione dell'accesso alla rete a un endpoint per il mirroring del database utilizzando l'autenticazione di Windows](database mirroring - allow network access - windows authentication.md)
...
# [Stabilire una sessione di mirroring del database tramite autenticazione di Windows (Transact-SQL)](establish-database-mirroring-session-windows-authentication.md)
# [Aggiornamento di istanze con mirroring](upgrading-mirrored-instances.md)
# [Connessione di client a una sessione di mirroring del database](connect-clients-to-a-database-mirroring-session-sql-server.md)
