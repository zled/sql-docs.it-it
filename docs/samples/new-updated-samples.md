...
1. [Esempi di SQL](sql-samples-where-are.md)
2. [Catalogo del database WideWorldImportersDW](wide-world-importers-dw-database-catalog.md)
3. [WideWorldImportersDW installazione e configurazione](wide-world-importers-dw-install-configure.md)
4. [WideWorldImportersDW utilizzo delle funzionalità di SQL Server](wide-world-importers-dw-use-of-sql-server-features.md)
5. [Generazione di dati WideWorldImporters](wide-world-importers-generate-data.md)
6. [Catalogo del database WideWorldImporters](wide-world-importers-oltp-database-catalog.md)
7. [Installazione e configurazione](wide-world-importers-oltp-install-configure.md)
8. [Utilizzo delle funzionalità di SQL Server](wide-world-importers-oltp-use-of-sql-server-features.md)
9. [Flusso di lavoro WideWorldImportersDW ETL](wide-world-importers-perform-etl.md)
10. [Database di esempio Wide World Importers per Microsoft SQL](wide-world-importers-what-is.md)
