...
description: "È possibile monitorare active e recente [dwloader](dwloader.md) carica tramite la Console di amministrazione Analitica piattaforma di strumenti analitici o le viste di sistema Parallel Data Warehouse (PDW)."
ms.date: 10/20/2016
ms.topic: article
