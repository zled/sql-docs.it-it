---
title: "Report per il server Integration Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# Report per il server Integration Services
 ...
 Per informazioni su come distribuire i pacchetti al server [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)], vedere [Distribuire progetti nel server Integration Services](../../integration-services/packages/deploy-projects-to-integration-services-server.md).  
...
## Attività correlate  
 [Visualizzare i report per il server Integration Services](../../integration-services/performance/view-reports-for-the-integration-services-server.md)  
  
## Contenuto correlato  
[Esecuzione di pacchetti e altre operazioni di monitoraggio](../../integration-services/performance/monitor-running-packages-and-other-operations.md)
