...
ms.topic: "article"
helpviewer_keywords: 
  - "pacchetti di Integration Services, aggiornamento"
  - "aggiornamento di pacchetti di Integration Services"
...
---
# Aggiornare i pacchetti di Integration Services mediante l&#39;Aggiornamento guidato pacchetti SSIS
...
## Esecuzione dell'Aggiornamento guidato pacchetti SSIS  
...
#### Per eseguire la procedura guidata da SQL Server Data Tools  
...
#### Per eseguire la procedura guidata da SQL Server Management Studio  
...
#### Per eseguire il backup dei pacchetti originali in SQL Server Management Studio o dal prompt dei comandi  
...
2.  Eseguire l'Aggiornamento guidato pacchetti [!INCLUDE[ssIS](../../includes/ssis-md.md)] in [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] o dal prompt dei comandi.  
...
#### Per eseguire il backup dei pacchetti originali in SQL Server Data Tools  
