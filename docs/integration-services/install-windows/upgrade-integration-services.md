...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, aggiornamento"
  - "SSIS, aggiornamento"
  - "SQL Server Integration Services, aggiornamento"
...
>   
>  Per informazioni sulle altre funzionalità sospese, vedere [Funzionalità di Integration Services non più supportate in SQL Server 2016](../Topic/Discontinued%20Integration%20Services%20Functionality%20in%20SQL%20Server%202016.md).  
...
## Aggiornamento di Integration Services e del Motore di database a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
## Aggiornamento solo del Motore di database a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 In questa sezione vengono descritti gli effetti di un aggiornamento che utilizza i criteri seguenti:  
