...
###  <a name="a-namebkmkchangetablescta-change-tables-ct"></a><a name="BKMK_Change_Tables_CT"></a> Tabelle delle modifiche (_CT)  
...
|Nome|Valore predefinito|Min|Max|Statico|Description|  
|----------|-------------|---------|---------|------------|-----------------|  
