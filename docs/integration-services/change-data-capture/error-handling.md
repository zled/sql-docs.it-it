...
-   La tabella \<cdc-database>.cdc.xdbcdc_trace, utilizzata per le operazioni di registrazione generale e di traccia effettuate dalle istanze di Oracle CDC. Ciò significa che gli errori correlati a un'istanza specifica di Oracle CDC vengono registrati nella tabella di traccia dell'istanza.  
...
### Gestione degli errori di connessione al database Oracle di origine  
...
### Gestione degli errori di connessione di SQL Server di destinazione  
...
### Gestione degli errori di spazio di archiviazione esaurito di SQL Server di destinazione  
...
### Gestione degli errori imprevisti dell'istanza di Oracle CDC  
