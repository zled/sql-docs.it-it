---
title: "Guida procedurale del servizio Change Data Capture per Oracle di Attunity | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Guida procedurale del servizio Change Data Capture per Oracle di Attunity
  In questa sezione viene illustrato come eseguire le attività nella console di configurazione del servizio CDC.  
  
## Informazioni sull'utilizzo del servizio CDC per l'interfaccia utente di configurazione del servizio Oracle  
