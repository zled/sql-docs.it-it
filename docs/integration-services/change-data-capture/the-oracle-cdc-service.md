...
### Protezione dei dati delle modifiche Oracle di origine  
...
### Protezione delle credenziali di log mining Oracle di origine  
...
### Account del servizio di Windows del servizio Oracle CDC  
