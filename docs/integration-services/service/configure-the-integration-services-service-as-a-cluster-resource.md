---
title: "Configurazione del servizio Integration Services come risorsa cluster | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   Portare il servizio [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] online come risorsa cluster.  
 ...
 Dopo avere configurato il servizio [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] in un cluster o in un server, potrebbe essere necessario configurare le autorizzazioni DCOM per potersi connettere al servizio da un computer client. Per altre informazioni, vedere [Eseguire una connessione a un server Integration Services remoto &#40;servizio SSIS&#41;](../../integration-services/service/connect-to-a-remote-integration-services-server-ssis-service.md).  
