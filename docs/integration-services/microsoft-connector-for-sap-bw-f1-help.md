---
title: Microsoft Connector for SAP BW F1 Guida | Documenti Microsoft
ms.custom: 
ms.date: 03/14/2017
...
-   [Editor gestione connessione di SAP BW](../integration-services/connection-manager/sap-bw-connection-manager-editor.md)  
