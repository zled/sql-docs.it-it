---
title: Individuare l'origine dei pacchetti con firme digitali | Documenti Microsoft
ms.custom: 
ms.date: 08/24/2016
...
## <a name="signing_dialog"></a>Finestra di dialogo dell'interfaccia utente riferimento al firma digitale
