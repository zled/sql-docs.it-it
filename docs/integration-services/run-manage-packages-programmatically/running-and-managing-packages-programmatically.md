---
title: In esecuzione e la gestione dei pacchetti a livello di codice | Documenti Microsoft
ms.custom: 
ms.date: 03/17/2017
...
-   Creare un nuovo pacchetto, aggiungere e configurare i componenti oggetto per oggetto e proprietà per proprietà, salvarlo ed eseguirlo.  
 ...
 In questa sezione viene descritto e illustrato come eseguire un pacchetto esistente a livello di programmazione e come accedere all'output del flusso di dati da altre applicazioni. L'opzione di programmazione avanzata, è possibile creare a livello di codice un [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] pacchetto riga per riga come descritto nell'argomento [creazione pacchetti a livello di codice](../../integration-services/building-packages-programmatically/building-packages-programmatically.md).  
...
## <a name="running-packages-on-the-integration-services-server"></a>Esecuzione di pacchetti nel server Integration Services  
 ...
 È inoltre possibile utilizzare lo spazio dei nomi per distribuire e gestire progetti [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] nel server [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]. Per una panoramica dei frammenti di codice e lo spazio dei nomi, vedere il post di blog, [uno sguardo rapido del modello oggetto gestito del catalogo SSIS](http://go.microsoft.com/fwlink/?LinkId=253122), su blogs.msdn.com.  
...
## <a name="in-this-section"></a>Argomenti della sezione  
 ...
 [Gestione dei ruoli pacchetto a livello di codice &#40; Servizio SSIS &#41;](../../integration-services/run-manage-packages-programmatically/managing-package-roles-programmatically-ssis-service.md)  
