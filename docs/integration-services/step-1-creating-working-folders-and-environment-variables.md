...
manager: "jhubbard"
---
# Passaggio 1: Creazione di cartelle di lavoro e variabili di ambiente
...
### Per creare la cartella di lavoro locale  
...
### Per creare le variabili di ambiente locali  
...
### Per creare le variabili d'ambiente di destinazione  
