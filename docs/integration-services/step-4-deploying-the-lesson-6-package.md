...
manager: "jhubbard"
---
# Passaggio 4: Distribuzione del pacchetto della lezione 6
...
### Per individuare o aggiungere il catalogo SSISDB  
...
### Per aggiungere il pacchetto al catalogo SSISDB  
...
### Per modificare il parametro del pacchetto in modo da puntare ai nuovi dati di esempio  
...
### Per testare la distribuzione del pacchetto creato nella lezione 6  
