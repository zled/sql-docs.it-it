---
title: 'Lezione 5: Aggiungere le configurazioni dei pacchetti SSIS per il modello di distribuzione del pacchetto | Documenti Microsoft'
ms.custom: 
ms.date: 03/14/2017
...
-   [Passaggio 2: Abilitare e configurare le configurazioni di pacchetto](../integration-services/lesson-5-2-enabling-and-configuring-package-configurations.md)  
  
-   [Passaggio 3: Modifica il valore di configurazione delle proprietà Directory](../integration-services/lesson-5-3-modifying-the-directory-property-configuration-value.md)  
