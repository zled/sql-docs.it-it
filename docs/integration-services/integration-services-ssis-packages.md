...
ms.topic: "article"
helpviewer_keywords: 
  - "pacchetti di SQL Server Integration Services, informazioni sui pacchetti"
  - "pacchetti [Integration Services], informazioni sui pacchetti"
  - "pacchetti SSIS, informazioni sui pacchetti"
  - "pacchetti SSIS"
  - "pacchetti di SQL Server Integration Services"
  - "contenitori [Integration Services], pacchetti"
  - "pacchetti [Integration Services]"
  - "pacchetti di Integration Services, informazioni sui pacchetti"
...
## Voci di log personalizzate disponibili nei pacchetti  
 Nella tabella seguente sono elencate le voci di log personalizzate disponibili per i pacchetti. Per altre informazioni, vedere [Registrazione di Integration Services &#40;SSIS&#41;](../integration-services/performance/integration-services-ssis-logging.md) e [Messaggi personalizzati per la registrazione](../integration-services/performance/custom-messages-for-logging.md).  
...
-   [Importazione/Esportazione guidata SQL Server](SQL%20Server%20Import%20and%20Export%20Wizard.md)  
