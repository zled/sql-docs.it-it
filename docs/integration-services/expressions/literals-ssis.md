...
helpviewer_keywords: 
  - "string literals"
  - "valori letterali [Integration Services]"
  - "valori letterali booleani"
  - "espressioni [Integration Services], valori letterali"
  - "valori letterali [Integration Services]"
  - "mapping tra valori letterali [Integration Services]"
