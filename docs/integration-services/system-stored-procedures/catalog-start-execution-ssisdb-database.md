...
## <a name="arguments"></a>Argomenti  
 ...
 Il numero di tentativi se l'esecuzione ha esito negativo. Ha effetto solo se l'esecuzione è in orizzontale. Questo parametro è facoltativo. Si è impostato su 0, se non diversamente specificato. Il *conteggio_tentativi* è **int**.
