...
# <a name="sql-server-integration-services"></a>SQL Server Integration Services
 ...
 > Per contenuti relativi alle versioni precedenti di SQL Server, vedere [SQL Server Integration Services](https://msdn.microsoft.com/en-US/library/ms141026(SQL.120).aspx).
...
- [Forum MSDN su SSIS - Per porre domande](https://social.msdn.microsoft.com/Forums/en-us/home?forum=sqlintegrationservices)
- [Forum MSDN su SSDT e SSMS - Per porre domande](https://social.msdn.microsoft.com/Forums/en-US/home?forum=sqltool)
