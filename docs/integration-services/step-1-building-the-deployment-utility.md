...
manager: "jhubbard"
---
# Passaggio 1: Compilazione dell&#39;utilit&#224; di distribuzione
...
### Per impostare le proprietà dell'utilità di distribuzione  
...
### Per compilare l'utilità di distribuzione  
...
[Passaggio 2: Verifica del pacchetto di distribuzione](../integration-services/step-2-verifying-the-deployment-bundle.md)  
