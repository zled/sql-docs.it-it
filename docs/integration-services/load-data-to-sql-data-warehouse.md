...
Creare un pacchetto di SQL Server Integration Services (SSIS) per caricare dati da SQL Server in [Azure SQL Data Warehouse](/azure/sql-data-warehouse/index.md). È anche possibile ristrutturare, trasformare e pulire i dati durante il passaggio attraverso il flusso di dati SSIS.
