...
1.  [Passaggio 1: Copia del pacchetto della lezione 5](../integration-services/step-1-copying-the-lesson-5-package.md)  
  
2.  [Passaggio 2: Conversione del progetto nel modello di distribuzione del progetto](../integration-services/step-2-converting-the-project-to-the-project-deployment-model.md)  
  
3.  [Passaggio 3: Test del pacchetto della lezione 6](../integration-services/step-3-testing-the-lesson-6-package.md)  
  
4.  [Passaggio 4: Distribuzione del pacchetto della lezione 6](../integration-services/step-4-deploying-the-lesson-6-package.md)  
  
## Inizio della lezione  
[Passaggio 1: Copia del pacchetto della lezione 5](../integration-services/step-1-copying-the-lesson-5-package.md)  
