...
helpviewer_keywords: 
  ...
  - "pacchetti di Integration Services, prestazioni"
  - "prestazioni [Integration Services]"
  - "flusso di dati [Integration Services], risoluzione dei problemi"
  - "pacchetti di SQL Server Integration Services, prestazioni"
  - "caricamento di dati"
  - "flusso di controllo [Integration Services], risoluzione dei problemi"
  - "pacchetti SSIS, prestazioni"
  - "pacchetti [Integration Services], prestazioni"
  - "query [Integration Services], risoluzione dei problemi"
  - "ordinamento di dati [Integration Services]"
  - "aggregazioni [Integration Services]"
