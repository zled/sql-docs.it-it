---
title: Origine Blob di Azure | Documenti Microsoft
ms.custom:
- SQL2016_New_Updated
ms.date: 07/25/2016
...
# <a name="azure-blob-source"></a>Origine BLOB di Azure
 ...
 Il **origine Blob di Azure** è un componente del [Feature Pack di SQL Server Integration Services (SSIS) per Azure](../../integration-services/azure-feature-pack-for-integration-services-ssis.md).  
