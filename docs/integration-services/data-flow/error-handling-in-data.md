...
## Usare gli output degli errori per acquisire gli errori a livello di riga  
...
## Gli errori sono errori o troncamenti  
...
## Selezionare un'opzione di gestione degli errori  
