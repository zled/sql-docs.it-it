...
---
# Eseguire il mapping delle colonne ai domini compositi
...
### Per eseguire il mapping di più colonne a un dominio composito  
...
### Per eseguire il mapping di una colonna con valori delimitati a un dominio composito  
