---
title: Editor trasformazione Query di Data Mining (scheda Query) | Documenti Microsoft
ms.custom: 
ms.date: 03/01/2017
...
# <a name="data-mining-query-transformation-editor-query-tab"></a>Editor trasformazione Query di data mining (scheda Query)
 ...
 Per ulteriori informazioni sulla trasformazione Query di data mining, vedere [Data Mining Query Transformation](../../../integration-services/data-flow/transformations/data-mining-query-transformation.md).  
