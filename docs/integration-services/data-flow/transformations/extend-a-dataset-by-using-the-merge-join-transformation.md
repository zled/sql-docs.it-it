---
title: "Estensione di un set di dati tramite la trasformazione Merge join | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "set di dati [Integration Services], join"
  - "set di dati [Integration Services], estensione"
  - "unione in join di set di dati [Integration Services]"
...
---
# Estensione di un set di dati tramite la trasformazione Merge join
