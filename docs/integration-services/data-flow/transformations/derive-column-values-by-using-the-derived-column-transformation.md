---
title: "Derivazione di valori di colonna tramite la trasformazione Colonna derivata | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "colonne [Integration Services]"
  - "colonne derivate"
  - "colonne [Integration Services], valori"
...
---
# Derivazione di valori di colonna tramite la trasformazione Colonna derivata
...
10. Per configurare l'output degli errori, fare clic su **Configura output errori**. Per altre informazioni, vedere [Configurazione di un output degli errori in un componente del flusso di dati](../../../integration-services/troubleshooting/configure-an-error-output-in-a-data-flow-component.md).  
