...
helpviewer_keywords: 
  ...
  - "tabelle di riferimento [Integration Services]"
  - "corrispondenza tra dati simili [Integration Services]"
  - "inserimento di valori mancanti"
  - "correzione di dati [Integration Services]"
  - "cache [Integration Services]"
  - "standardizzazione dei dati [Integration Services]"
  - "ricerche [Integration Services]"
  - "punteggi di confidenza [Integration Services]"
  - "corrispondenze fuzzy"
  - "inserimento di valori mancanti [Integration Services]"
