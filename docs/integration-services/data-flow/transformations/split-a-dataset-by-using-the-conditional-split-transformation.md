---
title: "Divisione di un set di dati tramite la trasformazione Suddivisione condizionale | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "suddivisione di set di dati"
  - "set di dati [Integration Services], suddivisione"
...
### Per eseguire la suddivisione condizionale di un set di dati  
...
10. Per configurare un output degli errori, fare clic su **Configura output errori**. Per altre informazioni, vedere [Configurazione di un output degli errori in un componente del flusso di dati](../../../integration-services/troubleshooting/configure-an-error-output-in-a-data-flow-component.md).  
