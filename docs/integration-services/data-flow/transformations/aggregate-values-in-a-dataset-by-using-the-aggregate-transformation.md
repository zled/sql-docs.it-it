...
---
# <a name="aggregate-values-in-a-dataset-by-using-the-aggregate-transformation"></a>Aggregare valori in un set di dati tramite la trasformazione Aggregazione
