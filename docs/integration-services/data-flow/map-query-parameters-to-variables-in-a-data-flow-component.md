...
ms.topic: "article"
helpviewer_keywords: 
  - "query [Integration Services], mapping di parametri"
  - "parametri [Integration Services]"
  - "mapping di parametri di query a variabili [Integration Services]"
  - "variabili [Integration Services], mapping di parametri"
...
---
# Mapping dei parametri di query a variabili in un componente del flusso di dati
