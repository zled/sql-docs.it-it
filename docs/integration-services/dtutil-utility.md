...
ms.topic: "article"
helpviewer_keywords: 
  - "verifica di pacchetti"
  - "controllo di pacchetti"
  - "spostamento di pacchetti"
  - "pacchetti [Integration Services], opzioni della riga di comando"
  - "prompt dei comandi [Integration Services]"
  - "pacchetti di SQL Server Integration Services, opzioni della riga di comando"
  - "copia di pacchetti"
  - "test di esistenza [Integration Services]"
  - "pacchetti di Integration Services, opzioni della riga di comando"
  - "pacchetti SSIS, opzioni della riga di comando"
...
-   Aprire una finestra del prompt dei comandi, accedere alla directory che contiene la versione a 64 bit dell'utilità *\<unità>*:\Programmi\Microsoft SQL Server\130\DTS\Binn, quindi eseguire l'utilità da quel percorso.  
...
|/FDe[lete] {*SQL* &#124; *DTS*}[;*ParentFolderPath;FolderName]*|(Facoltativo) Elimina la cartella specificata dal nome in *FolderName* da [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] o [!INCLUDE[ssIS](../includes/ssis-md.md)]. Il percorso della cartella da eliminare è indicato dall'opzione *ParentFolderPath*.|  
