...
helpviewer_keywords: 
  ...
  - "Riorganizza indice - attività [Integration Services]"
...
## Configurazione dell'attività Riorganizza indice  
...
## Attività correlate  
 Per altre informazioni su come impostare queste proprietà nella finestra di Progettazione [!INCLUDE[ssIS](../../includes/ssis-md.md)], vedere [Impostare le proprietà di un'attività o di un contenitore](../Topic/Set%20the%20Properties%20of%20a%20Task%20or%20Container.md).  
