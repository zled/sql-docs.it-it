...
---
# Eseguire la convalida XML con Attivit&#224; XML
...
## Esempio di output per un file XML valido  
...
## Esempio di output per un file XML non valido  
...
## Analizzare l'output della convalida XML con una query Transact-SQL  
