...
-   Enumeratore BLOB di Azure Foreach per enumerare i BLOB in un contenitore BLOB di Archiviazione di Azure.  
 ...
 ![Contenitore Foreach Loop per l'enumerazione di una cartella](../../integration-services/control-flow/media/ssis-foreachloop.gif "Contenitore Foreach Loop per l'enumerazione di una cartella")  
