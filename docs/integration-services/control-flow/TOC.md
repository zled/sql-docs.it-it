...
# [Esecuzione di un ciclo su file e tabelle di Excel utilizzando un contenitore Ciclo Foreach](loop-through-excel-files-and-tables-by-using-a-foreach-loop-container.md)
...
# [Attività di download di BLOB di Azure](azure-blob-download-task.md)
...
# [Incorporamento di un'attività Profiling dati nel flusso di lavoro del pacchetto](incorporate-a-data-profiling-task-in-package-workflow.md)
...
# [Eseguire la convalida XML con Attività XML](validate-xml-with-the-xml-task.md)
