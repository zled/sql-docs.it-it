---
title: "Esecuzione di un ciclo su file e tabelle di Excel utilizzando un contenitore Ciclo Foreach | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "connessioni [Integration Services], Excel"
  - "Excel [Integration Services]"
  - "gestioni connessioni [Integration Services], Excel"
...
---
# Esecuzione di un ciclo su file e tabelle di Excel utilizzando un contenitore Ciclo Foreach
...
3.  Aggiungere un contenitore Ciclo Foreach alla scheda **Flusso di controllo**. Per informazioni su come configurare il contenitore Ciclo Foreach, vedere [Configurare un contenitore Ciclo Foreach](../Topic/Configure%20a%20Foreach%20Loop%20Container.md).  
...
7.  Aggiungere una gestione connessione Excel in un pacchetto, come descritto in [Aggiungere, eliminare o condividere una gestione connessione in un pacchetto](../Topic/Add,%20Delete,%20or%20Share%20a%20Connection%20Manager%20in%20a%20Package.md). Selezionare un file di una cartella di lavoro di Excel esistente per la connessione, per evitare errori di convalida.  
