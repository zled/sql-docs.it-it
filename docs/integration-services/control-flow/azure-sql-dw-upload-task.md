...
L'**attività di caricamento di Azure SQL DW** è un componente di SQL Server Integration Services (SSIS) Feature Pack per Azure per SQL Server 2016. Scaricare il Feature Pack [qui](http://go.microsoft.com/fwlink/?LinkID=626967).
