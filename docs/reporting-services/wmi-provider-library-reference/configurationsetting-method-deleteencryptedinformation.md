---
title: Metodo DeleteEncryptedInformation (MSReportServer_ConfigurationSetting WMI) | Documenti Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---deleteencryptedinformation"></a>Metodo ConfigurationSetting - DeleteEncryptedInformation
