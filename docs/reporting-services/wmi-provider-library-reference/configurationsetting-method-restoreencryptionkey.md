---
title: Metodo RestoreEncryptionKey (MSReportServer_ConfigurationSetting WMI) | Documenti Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---restoreencryptionkey"></a>Metodo ConfigurationSetting - RestoreEncryptionKey
