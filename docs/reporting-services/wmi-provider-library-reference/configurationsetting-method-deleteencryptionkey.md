---
title: Metodo DeleteEncryptionKey (MSReportServer_ConfigurationSetting WMI) | Documenti Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---deleteencryptionkey"></a>Metodo ConfigurationSetting - DeleteEncryptionKey
