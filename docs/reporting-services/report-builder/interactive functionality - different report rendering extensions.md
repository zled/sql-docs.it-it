---
title: "Funzionalit&#224; interattiva per estensioni per il rendering di report differenti (Generatore report e SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
## Caratteristiche interattive nei diversi formati di output  
...
### Collegamenti drill-through ad altri report  
...
### Attivazione/disattivazione di elementi all'interno di un report  
...
### Collegamenti ipertestuali a immagini o contenuto Web esterni  
...
### Parametri richiesti ottenuti in fase di esecuzione  
...
### Filtri applicati in fase di esecuzione  
...
## Vedere anche  
 ...
 [Matrici &#40;Generatore report e SSRS&#41;](../Topic/Matrices%20\(Report%20Builder%20and%20SSRS\).md)   
