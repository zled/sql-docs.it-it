...
|------------------------|-----------------|  
|Interfaccia <xref:Microsoft.ReportingServices.Interfaces.IExtension>|Rappresenta un'estensione in [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)].|  
|Interfaccia <xref:Microsoft.ReportingServices.Interfaces.IDeliveryExtension>|Rappresenta un'estensione per il recapito in [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)].|  
|Interfaccia <xref:Microsoft.ReportingServices.Interfaces.IDeliveryReportServerInformation>|Contiene informazioni sul server di report richieste dalle estensioni per il recapito (ad esempio, un elenco delle estensioni per il rendering disponibili).|  
...
|Interfaccia <xref:Microsoft.ReportingServices.Interfaces.ISubscriptionBaseUIUserControl>|Controllo utente che rappresenta il mezzo per il recupero delle informazioni sulla sottoscrizione specifiche dell'estensione dall'utente in Gestione report (ad esempio, un indirizzo di posta elettronica o il percorso di una condivisione file).|  
