...
-   List Subscriptions: [Enunmerazione ReportOperation](../Topic/ReportOperation%20Enumeration.md) sul report E (l'utente è proprietario della sottoscrizione) O ReadAnySubscription.  
...
-   List Subscriptions: ManageAlerts O ([CreateAlerts](https://technet.microsoft.com/library/microsoft.sharepoint.spbasepermissions.aspx) sul report E l'utente è proprietario della sottoscrizione e la sottoscrizione è a tempo determinato).  
