...
ms.topic: "article"
helpviewer_keywords: 
  - "pianificazioni specifiche del report [Reporting Services]"
  - "pianificazioni condivise [Reporting Services]"
  - "modifica di pianificazioni"
  - "rimozione di pianificazioni"
  - "pianificazioni condivise [Reporting Services], creazione"
  - "pianificazioni condivise [Reporting Services], modifica"
  - "pianificazioni [Reporting Services], eliminazione"
  - "eliminazione di pianificazioni"
  - "pianificazioni [Reporting Services], creazione"
  - "pianificazioni [Reporting Services], modifica"
  - "pianificazioni condivise [Reporting Services], eliminazione"
...
-   **Portale Web:** in Impostazioni del sito, nella pagina Pianificazioni condivise, verificare i valori presenti nei campi Ultima esecuzione, Prossima esecuzione e Stato. Se una pianificazione non viene più eseguita perché è scaduta, nel campo Stato viene visualizzata la data di scadenza. Per altre informazioni, vedere [Reporting Services Web portal](../../reporting-services/web-portal-ssrs-native-mode.md) (Portale Web Reporting Services).
...
**Nota:** in caso di dubbio sull'effettivo uso di una pianificazione condivisa, eliminarla in [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] anziché nel portale Web. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] sono disponibili le stesse funzionalità di gestione delle pianificazioni condivise di Gestione report, ma è presente inoltre una pagina Report aggiuntiva contenente il nome di ogni report in cui viene utilizzata la pianificazione.  
 ...
 ## Eliminazione di una pianificazione in base al report  
...
### Per eliminare una pianificazione condivisa (portale Web)  
...
### Creare, eliminare o modificare una pianificazione condivisa (Management Studio)  
...
### Per creare o modificare una pianificazione condivisa (Management Studio)  
...
##### Per eliminare una pianificazione condivisa (Management Studio)  
...
### Creare pianificazioni condivise (modalità SharePoint)  
...
### Eliminare pianificazioni condivise (modalità SharePoint)  
