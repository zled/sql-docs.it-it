...
---
# Lezione 4: Aggiunta di una tabella al report (Reporting Services)
...
### Per aggiungere un'area dati tabella e campi a un layout del report  
...
## Visualizzazione in anteprima di un report  
...
![ssrs_ssdt_preview](../reporting-services/media/ssrs-ssdt-preview.png)  
    ...
    ![Anteprima, righe di dettaglio di una tabella con 5 colonne](../reporting-services/media/rs-basictabledetailspreview.gif "Anteprima, righe di dettaglio di una tabella con 5 colonne")  
