...
---
# Aggiungere griglie dati a report per dispositivi mobili | Reporting Services
La visualizzazione migliore, talvolta, è proprio quella dei dati. Per visualizzare i dati in [!INCLUDE[SS_MobileReptPub_Long](../../includes/ss-mobilereptpub-long.md)] sono disponibili tre *griglie dati*, o tabelle:
