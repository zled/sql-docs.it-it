...
helpviewer_keywords: 
  ...
  - "default security"
  - "sicurezza basata su ruoli [Reporting Services], impostazioni predefinite"
...
## Come utilizzare i ruoli predefiniti  
...
3.  Quando si è pronti ad assegnare account utente e di gruppo a specifici ruoli, utilizzare Gestione report. Per altre informazioni, vedere [Concedere l'accesso utente a un server di report &#40;Gestione report&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md).  
...
### Attività del ruolo Gestione contenuto  
...
### Personalizzazione del ruolo Gestione contenuto  
...
### Personalizzazione del ruolo Visualizzazione  
...
### Personalizzazione del ruolo Generatore report  
...
### Attività del ruolo Amministratore sistema  
