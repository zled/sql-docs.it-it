...
ms.topic: "article"
helpviewer_keywords: 
  - "negazione dell'accesso alla cartella Report personali"
  - "cartelle private [Reporting Services]"
  - "area di lavoro dell'utente [Reporting Services]"
  - "sicurezza [Reporting Services], cartella Report personali"
  - "Report personali - cartella [Reporting Services]"
...
## Assegnazione di ruolo per la funzionalità Report personali  
...
## Definizione di ruolo per la funzionalità Report personali  
...
## Negazione delle autorizzazioni di accesso alla funzionalità Report personali  
