---
title: "Proprietà del sistema Server di report | Documenti Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
|--------------|-----------------|  
|SiteName|Nome del sito del server di report visualizzato nell'interfaccia utente. Il valore predefinito è **il Server di Report di Microsoft**. Questa proprietà può essere una stringa vuota. La lunghezza massima è di 8.000 caratteri.|  
