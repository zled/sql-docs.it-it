...
---
# Sintassi di query XML per i dati del report XML (SSRS)
...
|-----------------------|-------------------------------------|  
|\<Query/>|Valore A: http://schemas.microsoft.com/...<br /><br /> Valore B: http://schemas.microsoft.com/...<br /><br /> Valore C: http://schemas.microsoft.com/...|  
