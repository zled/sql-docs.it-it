...
helpviewer_keywords: 
  ...
  - "origini dei dati [Reporting Services], Hyperion Essbase"
  - "dati multidimensionali [Reporting Services]"
  - "strumenti di progettazione query [Reporting Services]"
  - "Hyperion Essbase [Reporting Services], progettazione query"
...
|![Aggiungi membro calcolato](../../reporting-services/report-data/media/rsqdicon-addcalculatedmember.png "Aggiungi membro calcolato")|Consente di visualizzare la finestra di dialogo **Generatore membri calcolati** , utilizzabile per creare o modificare espressioni per un membro calcolato, tra cui l'impostazione della proprietà **Solve Order** .|  
...
|![Elimina](../../reporting-services/report-data/media/rsqdicon-delete.png "Elimina")|Consente di eliminare l'elemento selezionato dalla query. Utilizzare questo pulsante per eliminare righe selezionate nel riquadro Filtro.|  
