...
helpviewer_keywords: 
  ...
  - "report pubblicati [Reporting Services], connessioni a origini dati"
  - "origini dati condivise [Reporting Services]"
  - "origini dati [Reporting Services], gestione"
...
## Creazione e utilizzo di origini dati condivise  
...
## Controllo dell'accesso alle proprietà di un'origine dati condivisa  
...
## Gestione delle proprietà dell'origine dati in un server di report  
...
|Aggiungere proprietà di connessione alle origini dati in un file di definizione del report (con estensione rdl).|Progettazione report|[Creare un'origine dati incorporata o condivisa &#40;SSRS&#41;](../Topic/Create%20an%20Embedded%20or%20Shared%20Data%20Source%20\(SSRS\).md)|  
...
|Creare un'origine dei dati condivisa in un server di report.|Gestione report|[Creare, eliminare o modificare un'origine dei dati condivisa &#40;Gestione report&#41;](../Topic/Create,%20Delete,%20or%20Modify%20a%20Shared%20Data%20Source%20\(Report%20Manager\).md)|  
...
|Creare un'origine dei dati condivisa in un server di report.|Sito di SharePoint|[Creare e gestire origini dati condivise &#40;Reporting Services in modalità integrata SharePoint&#41;](../Topic/Create%20and%20Manage%20Shared%20Data%20Sources%20\(Reporting%20Services%20in%20SharePoint%20Integrated%20Mode\).md)|  
