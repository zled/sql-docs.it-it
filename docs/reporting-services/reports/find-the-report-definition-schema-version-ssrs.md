...
ms.topic: "article"
helpviewer_keywords: 
  - "XML Schema [Reporting Services]"
  - "Report Definition Language, XML Schema"
  - "schemi [Reporting Services]"
