...
ms.topic: "article"
helpviewer_keywords: 
  - "origini dati [Reporting Services], pubblicazione in una raccolta di SharePoint"
...
---
# Pubblicare un&#39;origine dati condivisa in una raccolta di SharePoint
...
### Per pubblicare un'origine dati condivisa in un sito di SharePoint  
...
2.  Scegliere **Proprietà** dal menu **Progetto**. Verrà visualizzata la finestra di dialogo **Pagina delle proprietà** *\<progetto>*.  
