...
### URL per un server di SharePoint  
...
### URL per un sito o un sito secondario di SharePoint Server  
...
### URL di una raccolta di SharePoint  
...
### URL completi per gli elementi di un sito di SharePoint  
...
### Specifica di sottoreport e report drill-through  
...
### Nomi riservati in siti di SharePoint  
...
#### Origini dei dati condivise da Progettazione report  
...
## Differenze tra caricamento e pubblicazione  
...
## Aggiornamento di un elemento pubblicato  
