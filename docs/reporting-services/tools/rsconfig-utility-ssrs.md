...
helpviewer_keywords: 
  ...
  - "utilità del prompt dei comandi [SQL Server], rsconfig"
...
#### Impostazione di un account utente di dominio  
...
#### Impostazione di un account predefinito  
...
#### Impostazione di un account per l'esecuzione automatica su un server locale  
...
#### Impostazione di un account per l'esecuzione automatica su un server remoto  
