...
ms.topic: "article"
helpviewer_keywords: 
  - "Progettazione report [Reporting Services], creazione report"
...
##  <a name="a-namebkmkshareddatasourcesa-shared-data-sources"></a><a name="bkmk_SharedDataSources"></a> Origini dati condivise  
...
##  <a name="a-namebkmkshareddatasetsa-shared-datasets"></a><a name="bkmk_SharedDatasets"></a> Set di dati condivisi  
...
##  <a name="a-namebkmkreportsa-paginated-reports"></a><a name="bkmk_Reports"></a> Report impaginati  
...
##  <a name="a-namebkmkreportpartsa-report-parts"></a><a name="bkmk_ReportParts"></a> Parti del report  
...
##  <a name="a-namebkmkresourcesa-resources"></a><a name="bkmk_Resources"></a> Risorse  
...
##  <a name="a-namebkmkreportlayouta-paginated-report-layout"></a><a name="bkmk_ReportLayout"></a> Layout del report impaginato  
...
##  <a name="a-namebkmkpreviewa-preview-a-paginated-report"></a><a name="bkmk_Preview"></a> Visualizzare in anteprima un report impaginato  
...
##  <a name="a-namebkmksaveanddeploya-save-and-deploy-paginated-reports"></a><a name="bkmk_SaveandDeploy"></a> Salvare e distribuire report impaginati  
...
##  <a name="a-namebkmkreportvalidationanderrorlevelsa-report-validation-and-error-levels"></a><a name="bkmk_ReportValidationandErrorLevels"></a> Convalida del report e livelli di errore  
...
*  [Scaricare SQL Server Data Tools](http://go.microsoft.com/fwlink/?LinkID=616714) [Reporting Services in SQL Server Data Tools &#40;SSDT&#41;](../../reporting-services/tools/reporting-services-in-sql-server-data-tools-ssdt.md)   
