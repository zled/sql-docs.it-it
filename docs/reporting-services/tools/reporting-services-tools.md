...
helpviewer_keywords: 
  - "SSRS, strumenti"
  - "Reporting Services, strumenti"
  - "componenti [Reporting Services]"
  - "componenti [Reporting Services], informazioni sui componenti"
  - "Reporting Services, componenti"
  - "SSRS, componenti"
  - "report [Reporting Services], strumenti"
  - "SQL Server Reporting Services, componenti"
  - "SQL Server Reporting Services, strumenti"
  - "architettura [Reporting Services]"
...
## Strumenti per l'amministrazione del server di report  
...
## Strumenti per la gestione del contenuto dei report  
...
## Vedere anche  
 [Reporting Services Report Server](../../reporting-services/report-server-sharepoint/server-di-report-di-reporting-services.md)   
