...
2.  Utilizzare il <xref:ReportService2010.ReportingService2010.GetItemDefinition%2A> e <xref:ReportService2010.ReportingService2010.GetProperties%2A> metodi per recuperare la definizione del report e le proprietà del report.  
  
3.  Impostare l'URL in modo che punti al server di destinazione.  
  
4.  Utilizzare <xref:ReportService2010.ReportingService2010.CreateCatalogItem%2A> , passando le proprietà restituite da <xref:ReportService2010.ReportingService2010.GetProperties%2A> e la definizione del report restituiti da <xref:ReportService2010.ReportingService2010.GetItemDefinition%2A>.  
...
[Metodo GenerateDatabaseRightsScript &#40; WMI MSReportServer_ConfigurationSetting &#41;](../../reporting-services/wmi-provider-library-reference/configurationsetting-method-generatedatabaserightsscript.md)   
[Metodo GenerateDatabaseUpgradeScript &#40; WMI MSReportServer_ConfigurationSetting &#41;](../../reporting-services/wmi-provider-library-reference/configurationsetting-method-generatedatabaseupgradescript.md)   
