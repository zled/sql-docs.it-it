---
title: "Utilità RS.exe (SSRS) | Documenti Microsoft"
ms.custom: 
ms.date: 03/16/2017
...
- [Eseguire un File di Script di Reporting Services](../../reporting-services/tools/run-a-reporting-services-script-file.md)   
