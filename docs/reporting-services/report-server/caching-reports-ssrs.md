...
helpviewer_keywords: 
  ...
  - "elaborazione di report [Reporting Services], memorizzazione nella cache"
  - "istanze memorizzate nella cache [Reporting Services]"
  - "aggiornamento della cache"
  - "report memorizzati nella cache [Reporting Services]"
  - "precaricamento della cache"
  - "report memorizzati nella cache non validi [Reporting Services]"
  - "prestazioni [Reporting Services]"
  - "scadenza [Reporting Services]"
  - "snapshot [Reporting Services], memorizzazione nella cache"
...
## Vedere anche  
 ...
 [Opzioni di aggiornamento cache &#40;Gestione report&#41;](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
