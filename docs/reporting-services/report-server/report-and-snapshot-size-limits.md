...
helpviewer_keywords: 
  ...
  - "dimensione massima dei report"
  - "dimensioni [SQL Server], report"
  - "dimensioni di report [Reporting Services]"
  - "report [Reporting Services], dimensioni"
  - "attacchi Denial of Service [Reporting Services]"
...
---
# Limiti delle dimensioni di report e snapshot
...
## Calcolo dello spazio di archiviazione degli snapshot  
...
## Dimensioni degli snapshot e prestazioni del server di report  
