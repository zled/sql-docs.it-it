...
ms.topic: "article"
helpviewer_keywords: 
  - "Reporting Services, Generatore report"
  - "Generatore report 1.0, configurazione dell'accesso"
...
---
# Configurare l&#39;accesso a Generatore report
...
## Abilitazione e disabilitazione di Generatore report  
...
#### Per creare assegnazioni di ruolo che concedono l'accesso a Generatore report  
...
## Autorizzazioni che concedono l'accesso a Generatore report in un server di report in modalità integrata SharePoint  
