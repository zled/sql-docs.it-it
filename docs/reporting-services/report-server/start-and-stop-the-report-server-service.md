...
ms.topic: "article"
helpviewer_keywords: 
  - "arresto del servizio del server di report"
  - "Servizio del server di report Windows."
  - "servizio del server di report, avvio"
  - "avvio del servizio del server di report"
...
### Per avviare o arrestare il servizio utilizzando lo strumento di configurazione di Reporting Services  
...
### Per avviare o arrestare il servizio utilizzando lo strumento Servizi in Strumenti di amministrazione  
...
### Per arrestare e riavviare il servizio utilizzando Gestione configurazione SQL Server.  
