...
ms.topic: "article"
helpviewer_keywords: 
  - "sistemi firewall [Reporting Services]"
...
---
# Configurare un firewall per l&#39;accesso al server di report
...
## Apertura di porte in Windows Firewall  
  
#### Per aprire la porta 80  
...
## Passaggi successivi  
 ...
 È inoltre possibile verificare che la porta sia aperta correttamente avviando Gestione report in un computer diverso. Per altre informazioni, vedere [Gestione report &#40;modalità nativa SSRS&#41;](../Topic/Report%20Manager%20%20\(SSRS%20Native%20Mode\).md) nella documentazione online di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
