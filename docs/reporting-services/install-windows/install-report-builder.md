...
## Installare [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] da un portale Web o da una raccolta di SharePoint 
...
### Sito di SharePoint integrato con [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]
...
## Installare [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] con System Center Configuration Manager 
...
## Per installare [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] da una condivisione  
...
## Per installare [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)] dalla riga di comando 
...
## Impostare i valori predefiniti di [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
