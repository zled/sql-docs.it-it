...
ms.topic: "article"
helpviewer_keywords: 
  - "servizio Windows ReportServer, directory virtuali"
  - "server di report [Reporting Services], directory virtuali"
  - "directory virtuali [Reporting Services]"
  - "Gestione report [Reporting Services], directory virtuali"
...
-   http://\<nomecomputer>/serverreport  
