...
ms.topic: "article"
helpviewer_keywords: 
  - "configurazione di URL [Reporting Services]"
...
#### URL per la connessione di [!INCLUDE[ssRSWebPortal](../../includes/ssrswebportal.md)] e delle web part al servizio Web ReportServer  
