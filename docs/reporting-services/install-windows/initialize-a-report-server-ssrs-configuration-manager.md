...
ms.topic: "article"
helpviewer_keywords: 
  - "server di report [Reporting Services], inizializzazione"
  - "processo di inizializzazione [Reporting Services]"
  - "controllo di inizializzazioni di server di report"
  - "distribuzioni con scalabilità orizzontale [Reporting Services]"
  - "inizializzazione di server di report [Reporting Services]"
  - "verifica di inizializzazioni di server di report"
