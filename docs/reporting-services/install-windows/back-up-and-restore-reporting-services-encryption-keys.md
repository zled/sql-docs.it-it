...
ms.topic: "article"
helpviewer_keywords: 
  - "backup di chiavi di crittografia [Reporting Services]"
  - "ripristino di chiavi di crittografia [Reporting Services]"
...
## Ripristinare le chiavi di crittografia  
