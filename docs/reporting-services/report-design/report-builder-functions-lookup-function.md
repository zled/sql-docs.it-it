---
title: Funzione lookup (Generatore Report e SSRS) | Documenti Microsoft
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---lookup-function"></a>Funzioni di Generatore report - funzione di ricerca
