...
---
# Specificare un intervallo dell&#39;asse (Generatore report e SSRS)
...
Per provare a impostare l'intervallo dell'asse con dati di esempio, vedere [Esercitazione: Aggiungere un istogramma al report](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md).
...
## Per visualizzare tutte le etichette delle categorie sull'asse X  
...
## Modificare l'intervallo di etichette nel riquadro Proprietà
...
## Per abilitare il calcolo di intervalli variabili su un asse  
