...
|Icona|Description|  
|----------|-----------------|  
|![Handle di riga con 3 linee parallele per la riga di dettaglio](../../reporting-services/report-design/media/rs-icontablix-detailsrow.png "Handle di riga con 3 linee parallele per la riga di dettaglio")|Solo il gruppo di dettagli nella gerarchia dei gruppi di righe|  
|![Handle di riga con riga di dettaglio e un gruppo esterno](../../reporting-services/report-design/media/rs-icontablix-groupwithdetails.png "Handle di riga con riga di dettaglio e un gruppo esterno")|Un gruppo esterno e il gruppo di dettagli figlio|  
|![Due parentesi parallele che indicano gruppi nidificati](../../reporting-services/report-design/media/rs-icontablix-nestedgroupnodetails.png "Due parentesi parallele che indicano gruppi nidificati")|Un gruppo esterno, un gruppo interno. Nessun gruppo di dettagli|  
|![2 parentesi e 3 linee in pila per un gruppo nidificato di dettagli](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithdetails.png "2 parentesi e 3 linee in pila per un gruppo nidificato di dettagli")|Un gruppo esterno, un gruppo interno e il gruppo di dettagli figlio|  
|![Un gruppo esterno con riga di piè di pagina e un gruppo interno](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithparentfooter.png "Un gruppo esterno con riga di piè di pagina e un gruppo interno")|Un gruppo esterno con una riga di piè di pagina per i totali e un gruppo interno|  
|![Parentesi del gruppo esterno, parentesi del gruppo interno, dettagli](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithdetailsandtotals.png "Parentesi del gruppo esterno, parentesi del gruppo interno, dettagli")|Un gruppo esterno con una riga di piè di pagina per i totali, un gruppo interno con una riga piè di pagina per i totali e una riga dettagli|  
|![Intestazione e piè di pagina padre e gruppo figlio](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithparentheaderandfooter.png "Intestazione e piè di pagina padre e gruppo figlio")|Un gruppo esterno con un'intestazione per le etichette e un piè di pagina per i totali e un gruppo interno. Nessun gruppo di dettagli|  
...
-   Indicatori di gruppo che mostrano tutte le appartenenze a gruppi per una cella selezionata.  
 ...
 ![Tabella con gruppi di righe di dettaglio e nidificate](../../reporting-services/report-design/media/rs-tablixrowgroupvisualcues.gif "Tabella con gruppi di righe di dettaglio e nidificate")  
