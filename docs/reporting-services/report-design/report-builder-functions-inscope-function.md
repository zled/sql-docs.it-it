---
title: Funzione InScope (Generatore Report e SSRS) | Documenti Microsoft
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---inscope-function"></a>Funzione InScope - funzioni di generatore di report
