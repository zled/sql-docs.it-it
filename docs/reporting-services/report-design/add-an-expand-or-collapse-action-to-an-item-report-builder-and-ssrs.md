...
---
# Aggiungere un&#39;azione Espandi o Comprimi a un elemento (Generatore report e SSRS)
...
### Per aggiungere a un gruppo un'azione per espandere e comprimere  
...
### Per aggiungere a un elemento del report un'azione per espandere e comprimere  
  
1.  Nella visualizzazione di progettazione report fare clic con il pulsante destro del mouse sull'elemento del report da visualizzare o nascondere e scegliere **Proprietà** *\<elemento report>*. Verrà visualizzata la finestra di dialogo **Proprietà** *\<elemento report>* relativa all'elemento report specifico.  
