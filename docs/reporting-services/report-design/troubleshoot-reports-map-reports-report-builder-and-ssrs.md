---
title: "Risoluzione dei problemi relativi alle parti del report: report mappa (Generatore report e SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Risoluzione dei problemi relativi alle parti del report: report mappa (Generatore report e SSRS)
...
## Informazioni sulla riduzione delle dimensioni della definizione del report.  
...
## Nell'area di progettazione, vengono visualizzati dati spaziali di esempio  
...
## Se si imposta un offset per un singolo elemento della mappa, si verifica uno spostamento di un gruppo di elementi della mappa  
...
## Il livello dell'utente che usa i dati spaziali di un file di forma ESRI dispone sempre di dati incorporati.  
...
## Dopo l'assegnazione di un nome descrittivo a un'origine dati o a un set di dati, sulla mappa non viene più visualizzato alcun dato.  
...
## I dati spaziali dell'utente contengono valori Null e stringhe vuote.  
...
## La mappa dell'utente supera il numero massimo di elementi spaziali  
...
## Impossibile impostare le opzioni di allineamento al centro e di visualizzazione per un elemento della mappa incorporato.  
...
## Nel report sono state impostate le opzioni di allineamento al centro e di visualizzazione della mappa e tuttavia, alla riapertura del report, la vista mappa è cambiata.  
...
## Le opzioni di allineamento al centro e di visualizzazione per un livello mappa non funzionano.  
...
## Uno o più livelli della mappa non vengono visualizzati.  
...
## Nonostante l'impostazione di un filtro sul livello mappa, non si riscontra alcun effetto.  
...
## Informazioni sul controllo dei valori nella legenda della mappa.  
...
## Le regole impostate non hanno fornito i risultati previsti.  
...
## Informazioni sul valore NaN della scala dei colori.  
...
## Quando si esegue il report, la scala dei colori non viene visualizzata.  
...
## Lo sfondo a tessere mappa di Bing non viene visualizzato.  
...
## Informazioni sul controllo del testo su un livello sezione.  
...
## Quando si imposta un'etichetta o una descrizione comando su un'espressione, viene restituito un errore di espressione relativo all'ambito del set di dati.  
...
## Vedere anche  
 ...
 [Risoluzione dei problemi relativi a Generatore report](http://msdn.microsoft.com/it-it/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
