...
-   In [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] sono disponibili molte formule calcolate da utilizzare con i grafici azionari, tra cui Indicatori prezzo, Indice di forza relativa, MACD e così via.  
