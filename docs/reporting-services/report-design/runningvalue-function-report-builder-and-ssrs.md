...
-   *Expression* non deve contenere aggregazioni nidificate che specificano *recursive*.  
 ...
 Per calcolare il valore corrente del numero di righe, usare **RowNumber**. Per altre informazioni, vedere [Funzione RowNumber &#40;Generatore report e SSRS&#41;](../../reporting-services/report-design/rownumber-function-report-builder-and-ssrs.md).  
