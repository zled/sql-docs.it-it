...
---
# Formattazione dei punti dati di un grafico (Generatore report e SSRS)
...
|#MEDIO|Media di tutti i valori Y della serie|Tutto|`=Avg(Fields!MyDataField.Value)`|  
