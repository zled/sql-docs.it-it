---
title: Ultimo (funzione) (Generatore Report e SSRS) | Documenti Microsoft
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---last-function"></a>Report Builder funzioni - funzione Last
