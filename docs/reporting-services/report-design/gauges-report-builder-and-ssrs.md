...
-   [Impostazione di un intervallo di blocco su un misuratore (Generatore report e SSRS)](http://msdn.microsoft.com/it-it/0ece7297-6e2f-47fb-835d-b9e9cce53fe2)  
  
-   [Specificare un'immagine come indicatore di misura su un misuratore (Generatore report e SSRS)](http://msdn.microsoft.com/it-it/9d73b3c3-a068-4868-a2be-0cd261b6e92b)  
