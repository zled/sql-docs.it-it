---
title: Funzione Min (Generatore Report e SSRS) | Documenti Microsoft
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---min-function"></a>Funzioni di Generatore report - Min (funzione)
