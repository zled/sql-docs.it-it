---
title: Integrazione di Reporting Services con accesso tramite URL | Documenti Microsoft
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>Argomenti della sezione  
 [Accesso tramite URL in un'applicazione Web](../../reporting-services/application-integration/integrating-reporting-services-using-url-access-web-application.md)  
