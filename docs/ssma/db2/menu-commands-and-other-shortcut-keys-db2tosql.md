...
|Visualizzare la connessione o riconnettersi a DB2, finestra di dialogo.|ALT + F + T|  
...
|Aggiornamento dal database di DB2.|ALT + T + R|  
...
|PER ESEGUIRE QUESTA OPERAZIONE|PREMERE|  
|--------------|---------|  
|Visualizzare su SSMA per la finestra di dialogo di DB2.|ALT + H + A|  
