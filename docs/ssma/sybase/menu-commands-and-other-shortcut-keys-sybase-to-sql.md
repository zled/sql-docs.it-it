...
|Visualizzare la connessione o riconnettersi alla finestra di dialogo di Sybase.|ALT + F + T|  
...
|Aggiornamento dal database di Sybase.|ALT + T + R|  
...
|Accedere a sottomenu di gestione dei backup di Sybase.|ALT + S + B|  
