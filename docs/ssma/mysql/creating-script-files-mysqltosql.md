...
7.  **Operazione di arresto:** durante l'operazione a metà, se l'utente desidera arrestare l'operazione, quindi **'Ctrl + C'** tasti di scelta rapida può essere utilizzato. SSMA per la MySQL Console attenderà il completamento dell'operazione e termina l'esecuzione della console.  
