...
---
# Compilazione di una Knowledge Base
...
|||  
|-|-|  
|Creare una nuova Knowledge Base da zero, da una Knowledge Base esistente o da un file di dati DQS.|[Create a Knowledge Base](../data-quality-services/create-a-knowledge-base.md)|  
|Aprire una Knowledge Base esistente per eseguire l'individuazione delle informazioni e la gestione del dominio o per aggiungere i criteri di corrispondenza.|[Open a Knowledge Base](../data-quality-services/open-a-knowledge-base.md)|  
...
|Analizzare un campione di dati per i criteri di qualità dei dati.|[Esecuzione dell'individuazione di informazioni](../data-quality-services/perform-knowledge-discovery.md)|  
