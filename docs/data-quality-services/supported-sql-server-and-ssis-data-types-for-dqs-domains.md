...
---
# Tipi di dati di SQL Server e SSIS supportati per i domini DQS
...
|String|char<br /><br /> nchar<br /><br /> nvarchar<br /><br /> varchar|  
 ...
 I tipi di dati di SQL Server restanti non sono supportati in DQS. Per informazioni su tutti i tipi di dati di SQL Server, vedere [tipi di dati e 40 #; Transact-SQL & #41;](../t-sql/data-types/data-types-transact-sql.md).  
