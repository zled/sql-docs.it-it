...
> [!NOTE]  
>  Questa implementazione non supporta il `local` prefisso come descritto nella specifica XQuery in https://www.w3.org/2004/07/xquery-local-functions.  
