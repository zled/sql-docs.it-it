...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  In questo argomento e nei relativi sottoargomenti descrivono le funzioni quando si specifica espressione XQuery, è possibile usare la **xml** tipo di dati. Per le specifiche W3C, vedere [ http://www.w3.org/TR/2004/WD-xpath-functions-20040723 ](http://go.microsoft.com/fwlink/?LinkId=4873).  
...
|--------------|-------------------|  
|[Funzioni su valori numerici](http://msdn.microsoft.com/library/d5740a32-b174-43b9-b64d-1cc6edc50cff)|[funzione CEILING](../xquery/numeric-values-functions-ceiling.md)|  
...
|[Funzioni per le sequenze](http://msdn.microsoft.com/library/672d2795-53ab-49c2-bf24-bc81a47ecd3f)|[vuota](../xquery/functions-on-sequences-empty.md)|  
...
|[Funzioni delle estensioni XQuery SQL Server](http://msdn.microsoft.com/library/4bc5d499-5fec-4c3f-b11e-5ab5ef9d8f97)|[funzione SQL: Column (XQuery)](../xquery/xquery-extension-functions-sql-column.md)|  
