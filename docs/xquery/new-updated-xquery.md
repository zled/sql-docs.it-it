---
title: Aggiornato - XQuery per i documenti del Server SQL | Documenti Microsoft
description: Visualizzare i frammenti di contenuto aggiornato per modificati di recente nella documentazione, XQuery per Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739303"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>Nuovi e aggiornati: XQuery per SQL Server
...
- *Area di interesse:* &nbsp; **XQuery per SQL Server**.
