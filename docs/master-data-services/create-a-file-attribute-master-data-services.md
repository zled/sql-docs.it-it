...
ms.topic: "article"
helpviewer_keywords: 
  - "creazione di attributi di file [Master Data Services]"
  - "attributi [Master Data Services], creazione di attributi di file"
...
---
# Creare un attributo di file (Master Data Services)
...
### Per creare un attributo di file  
