...
ms.topic: "article"
helpviewer_keywords: 
  - "posta elettronica [Master Data Services], configurazione"
  - "notifiche [Master Data Services], configurazione di notifiche"
...
1.  Nella pagina **Database** di [!INCLUDE[ssMDScfgmgr](../includes/ssmdscfgmgr-md.md)] selezionare il database [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)].  
