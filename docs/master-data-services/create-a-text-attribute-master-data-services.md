...
ms.topic: "article"
helpviewer_keywords: 
  - "attributi [Master Data Services], creazione di attributi di testo"
  - "creazione di attributi di testo [Master Data Services]"
...
---
# Creare un attributo di testo (Master Data Services)
...
### Per creare un attributo di testo  
