---
title: 'Panoramica: Importazione di dati dalle tabelle (Master Data Services) | Documenti Microsoft'
ms.custom: 
ms.date: 03/14/2017
...
-   stg. udp_\<nome > _Relationship  
 ...
 ![Stored procedure nel database MDS di gestione temporanea](../master-data-services/media/mds-staging-storedprocedures.png "stored procedure nel database MDS di gestione temporanea")  
