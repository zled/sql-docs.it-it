---
title: "Installazione di Master Data Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/24/2017"
...
##  <a name="postinstall"></a> Attività successive all'installazione  
...
|Distribuire un modello di esempio|I pacchetti del modello di esempio sono installati con Master Data Services e possono essere distribuiti tramite MDSModelDeploy.exe.|[Distribuzione di esempi MDS in SQL Server](../Topic/Samples:%20Model%20Deployment%20Packages%20\(Master%20Data%20Services\).md)|
