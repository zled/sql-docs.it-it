---
title: Impostazioni di sistema (Master Data Services) | Documenti Microsoft
ms.custom: 
ms.date: 03/01/2017
...
|**Intervallo batch di gestione temporanea**|**StagingBatchInterval**|Nell'area funzionale [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] **di** , numero di secondi dopo la selezione di **Avvia batch** trascorsi i quali il batch verrà elaborato. Il valore predefinito è **60** secondi (1 minuto).|  
...
|Impostazione di Gestione configurazione|Impostazione di sistema|Description|  
|-----------------------------------|--------------------|-----------------|  
|**Numero di cui incrementare nuove regole business**|**BusinessRuleDefaultPriorityIncrement**|Nell'area funzionale [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] **di** , numero in base a cui viene incrementata la priorità di ogni nuova regola di business. Il valore predefinito è **10**.|  
|**Numero di membri a cui applicare regole business**|**BusinessRuleRealtimeMemberCount**|Nell'area funzionale [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] **di** , numero massimo di membri nella griglia a cui applicare regole di business. Nel [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)], numero massimo di membri nel foglio di lavoro attivo a cui applicare le regole di business. Il valore predefinito è **10000**.|  
...
|Impostazione di Gestione configurazione|Impostazione di sistema|Description|  
|-----------------------------------|--------------------|-----------------|  
|**URL di Gestione dati master per le notifiche**|**MDMRootURL**|L'URL per il [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] applicazione web, viene utilizzato nel collegamento presente nelle notifiche tramite posta elettronica, ad esempio `http://constoso/mds`.|  
...
|**Espressione regolare per indirizzo di posta elettronica**|**EmailRegExPattern**|Nell'area funzionale [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] **di** , espressione regolare usata per convalidare l'indirizzo di posta elettronica immesso nella scheda **Generale** dell'utente. Per altre informazioni sulle espressioni regolari, vedere [Elementi del linguaggio di espressioni regolari](http://go.microsoft.com/fwlink/?LinkId=164401) in MSDN Library.|  
...
|Impostazione di Gestione configurazione|Impostazione di sistema|Description|  
|-----------------------------------|--------------------|-----------------|  
||**SecurityMemberProcessInterval**|Nell'area funzionale [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)] **di** , la frequenza in secondi con cui vengono applicate le autorizzazioni di utenti e gruppi impostate in **Membri gerarchia** . Il valore predefinito è **3600** secondi (60 minuti).|  
