...
ms.topic: "article"
helpviewer_keywords: 
  - "attributi [Master Data Services], creazione di attributi di collegamento"
  - "creazione di attributi di collegamento [Master Data Services]"
...
---
# Creare un attributo di collegamento (Master Data Services)
...
### Per creare un attributo di collegamento  
