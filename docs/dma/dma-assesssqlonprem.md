...
- Scaricare e installare:
    - [Data Migration Assistant](https://www.microsoft.com/en-us/download/details.aspx?id=53595) v3.6 o versione successiva.
    ...
    - [SQL Server Management Studio](https://docs.microsoft.com/en-us/sql/ssms/download-sql-server-management-studio-ssms) 17.0 o versione successiva.
...
2. Aprire il [moduli di PowerShell](https://msdnshared.blob.core.windows.net/media/2018/03/PowerShell-Modules.zip)e quindi salvarle nella cartella creata.
      ...
      ![Moduli di PowerShell](../dma/media//dma-assesssqlonprem/dma-powershell-modules.png)

    Ogni cartella contiene il file psm1 associati, come illustrato nella figura seguente:

   ![File psm1 i moduli di PowerShell](../dma/media//dma-assesssqlonprem/dma-powershell-modules-psm1-files.png)
   ...
   ![proprietà file psm1](../dma/media//dma-assesssqlonprem/dma-psm1-file-properties.png)
...
Quando si usa un file csv per importare i dati, assicurarsi che esistono solo due colonne di dati – **nome istanza** e **Nome Database**, e che le colonne non includono le righe di intestazione.
 ...
 ![contenuto del file CSV](../dma/media//dma-assesssqlonprem/dma-csv-file-contents.png)
...
- AssessmentFlag
 ...
 ![Contenuto della tabella SQL Server](../dma/media//dma-assesssqlonprem/dma-sql-server-table-contents.png)
...
Dopo il caricamento di moduli di PowerShell nella directory dei moduli e creazione di un inventario, è necessario eseguire una valutazione con scalabilità, aprire PowerShell e che esegue la funzione dmaDataCollector.
  ...
  ![elenchi di dmaDataCollector (funzione)](../dma/media//dma-assesssqlonprem/dma-dmaDataCollector-function-listing.png)
...
Se si verifica un errore imprevisto, quindi la finestra di comando che ottiene avviata da questo processo verrà terminata.  Esaminare il log degli errori per determinare il motivo dell'errore.
  ...
  ![Percorso log degli errori](../dma/media//dma-assesssqlonprem/dma-error-log-file-location.png)
...
Al termine della valutazione, si è ora pronti per importare i dati in SQL Server per l'analisi. Per utilizzare il file JSON di valutazione, aprire PowerShell ed eseguire la funzione dmaProcessor.
  ...
  ![elenco di dmaProcessor (funzione)](../dma/media//dma-assesssqlonprem/dma-dmaProcessor-function-listing.png)
...
2. Caricare il data warehouse.
      ...
      ![LoadWarehouse contenuto caricato](../dma/media//dma-assesssqlonprem/dma-LoadWarehouse-loaded.png)
...
È anche possibile usare lo script LoadWarehouse per fornire le istruzioni TSQL di base per impostare i proprietari di database.
  ...
  ![Proprietari di impostazione LoadWarehouse](../dma/media//dma-assesssqlonprem/dma-LoadWarehouse-set-owners.png)
...
2. Immettere i dettagli del server che puntano alle **DMAWarehouse** del database e quindi selezionare **carico**.
    ...
    > Non premere INVIO per accettare i valori.
      ...
      ![Caricare il modello DMA i report Power BI](../dma/media//dma-assesssqlonprem/dma-reports-powerbi-template-loaded.png)

   Dopo che il report ha aggiornato i dati di **DMAWarehouse** database, viene visualizzato un report simile al seguente.

   ![Visualizzazione di report DMAWarehouse](../dma/media//dma-assesssqlonprem/dma-DMAWarehouse-report.png)
...
- Valutazioni in locale
  ...
  ![Segnalibri report DMA](../dma/media//dma-assesssqlonprem/dma-report-bookmarks.png)
...
### <a name="readiness-"></a>% Conformità
  ...
  ![Percentuale conformità DMA](../dma/media//dma-assesssqlonprem/dma-readiness-percentage.png)
...
### <a name="readiness-count"></a>Conteggio di conformità
  ...
  ![Conteggio di conformità DMA](../dma/media//dma-assesssqlonprem/dma-readiness-count.png)
...
### <a name="readiness-bucket"></a>Bucket di conformità
  ...
  ![Bucket Readiness DMA](../dma/media//dma-assesssqlonprem/dma-readiness-bucket.png)
...
### <a name="issues-word-cloud"></a>Problemi Word Cloud
  ...
  ![Problemi DMA WordCloud](../dma/media//dma-assesssqlonprem/dma-issues-word-cloud.png)
...
### <a name="database-readiness"></a>Preparazione del database
  ...
  ![Report di conformità Database DMA](../dma/media//dma-assesssqlonprem/dma-database-readiness-report.png)
...
- ImpactedObjectName
 ...
 ![Drill-down report di conformità Database DMA](../dma/media//dma-assesssqlonprem/dma-database-readiness-report-drilldown.png)
...
Questa attività consente di filtrare il report piano di correzione per il livello della gerarchia corrente in base al punto in cui si selezionano il drill-through opzione.
  ...
  ![DMA Database Readiness drill-down report filtrato](../dma/media//dma-assesssqlonprem/dma-database-readiness-report-drilldown-filtered.png)

  ![Report piano di correzione DMA](../dma/media//dma-assesssqlonprem/dma-remediation-plan-report.png)
...
È possibile usare anche il report piano di correzione sul proprio per compilare una risoluzione personalizzata piano usando i filtri nel **filtri di visualizzazioni** pannello.
  ...
  ![Opzioni di filtro report piano di correzione DMA](../dma/media//dma-assesssqlonprem/dma-remediation-plan-report-filter-options.png)
