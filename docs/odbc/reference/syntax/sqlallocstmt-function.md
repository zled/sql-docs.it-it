---
title: Funzione SQLAllocStmt | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32916186"
---
# <a name="sqlallocstmt-function"></a>SQLAllocStmt (funzione)
**Conformità**  
 Introdotta: versione ODBC standard 1.0 conformità: deprecato  
  
 **Riepilogo**  
 In ODBC 3. *x*, ODBC 2. *x* funzione **SQLAllocStmt** è stata sostituita da **SQLAllocHandle**. Per ulteriori informazioni, vedere [SQLAllocHandle-funzione](../../../odbc/reference/syntax/sqlallochandle-function.md).  
