...
|HY090|Lunghezza di stringa o di buffer non valida|*(DM) \*ValuePtr* è una stringa di caratteri e il *StringLength* argomento è minore di 0 ma non è stato SQL_NTS.|  
