 ...
 *ColumnCountPtr*  
 [Output] Puntatore a un buffer in cui restituire il numero di colonne nel risultato impostato. Questo conteggio non include una colonna del segnalibro associato.  
  
## <a name="returns"></a>Valori di codice restituiti  
 SQL_SUCCESS, SQL_SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, SQL_ERROR o SQL_INVALID_HANDLE.  
  
## <a name="diagnostics"></a>Diagnostica  
 Quando **SQLNumResultCols** restituisce SQL_ERROR o SQL_SUCCESS_WITH_INFO, un valore SQLSTATE associato possono essere ottenuti chiamando **SQLGetDiagRec** con un *HandleType* di Impostato su SQL_HANDLE_STMT e *gestire* di *StatementHandle*. Nella tabella seguente sono elencati i valori SQLSTATE comunemente restituiti da **SQLNumResultCols** e illustra ognuno nel contesto di questa funzione; la notazione "(DM)" precede le descrizioni di SQLSTATE restituiti da Gestione Driver. Il codice restituito associato a ogni valore SQLSTATE è SQL_ERROR, se non diversamente specificato.  
 ...
 **SQLNumResultCols** possibile può essere chiamato solo quando l'istruzione si trova nello stato preparato, posizionato o eseguito.  
 ...
 Per ulteriori informazioni, vedere [è stato creato di impostare un risultato?](../../../odbc/reference/develop-app/was-a-result-set-created.md) e [è come utilizzare i metadati?](../../../odbc/reference/develop-app/how-is-metadata-used.md).  
...
|Preparazione per l'esecuzione di un'istruzione SQL|[Funzione SQLPrepare](../../../odbc/reference/syntax/sqlprepare-function.md)|  
|Impostazione opzioni di scorrimento di cursore|[Funzione SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md)|  
