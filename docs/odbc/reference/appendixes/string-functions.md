...
|**INSERT (** *string_exp1*, *avviare*, *lunghezza*, *string_exp2 e***)** (ODBC 1.0)|Restituisce un carattere stringa dove *lunghezza* caratteri sono stati eliminati dal *string_exp1*, a partire da *avviare*e in cui *string_exp2 e* è stato inserito in *string_exp,* a partire da *avviare*.|  
