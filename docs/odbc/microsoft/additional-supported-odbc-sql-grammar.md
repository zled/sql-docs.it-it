...
-   [Operazione aritmetica di data](../../odbc/microsoft/date-arithmetic.md)  
  
-   [Jet: Date, Time e Timestamp letterali](../../odbc/microsoft/jet-date-time-and-timestamp-literals.md)  
  
-   [DROP INDEX-istruzione](../../odbc/microsoft/drop-index-statement.md)  
  
-   [File di testo a larghezza fissa](../../odbc/microsoft/fixed-width-text-file.md)  
  
-   [GRUPPO dall'elenco di espressioni](../../odbc/microsoft/group-by-expression-list.md)  
  
-   [ORDERBY-elenco di espressioni](../../odbc/microsoft/order-by-expression-list.md)  
