---
title: SQLTransact (Driver di File di testo) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32905006"
---
# <a name="sqltransact-text-file-driver"></a>SQLTransact (Driver di File di testo)
> [!NOTE]  
