---
title: Operazioni di SQL Studio domande frequenti (anteprima) | Documenti Microsoft
description: Domande frequenti (FAQ) per Studio operazioni SQL (anteprima).
ms.custom: tools|sos
ms.date: 11/15/2017
ms.prod: sql
...
[!INCLUDE[name-sos](../includes/name-sos-short.md)] è basato su codice di Visual Studio e offre un leggero, tastiera con stato attivo di esperienza di flussi di lavoro di codice moderne, quando si lavora con SQL. 
