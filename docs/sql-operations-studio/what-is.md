...
[!INCLUDE[name-sos](../includes/name-sos-short.md)]offre un'esperienza di sviluppo in T-SQL moderna e focalizzata sull'utilizzo della tastiera che rende semplici i compiti di tutti i giorni con le funzionalità integrate come la gestione a tab delle finestre, un editor T-SQL avanzato, l' intellisense, il completamento automatico delle parole chiavi, la gestione di frammenti di codice, la navigazione tra il codice, e l'integrazione con GIT. Sono presenti inoltre la possibilità di eseguire query T-SQL on-demand i cui risultati possono essere salvati come file di testo, JSON o Excel, modificare i dati, organizzare tramite preferiti le proprie connessioni e navigare tra gli oggetti con un'esperienza di navigazione familiare.  Per informazioni su come utilizzare l'editor T-SQL, vedere [utilizzare l'editor T-SQL per creare oggetti di database](tutorial-sql-editor.md).
