...
2. Selezionare **Ricarica** per abilitare l'estensione (richiesto solo alla prima di installare un'estensione).
1. Passare al dashboard di gestione facendo clic su server o nel database e selezionando **Gestisci**.
2. Le estensioni installate vengono visualizzati come schede nel dashboard di gestione:
