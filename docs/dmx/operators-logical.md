---
title: Operatori logici (DMX) | Documenti Microsoft
ms.custom: 
ms.date: 03/02/2016
...
[!INCLUDE[ssas-appliesto-sqlas](../includes/ssas-appliesto-sqlas.md)]
  ...
  È possibile utilizzare gli operatori logici nelle espressioni di Data Mining Extensions (DMX) per valutare i valori e restituire un valore booleano in [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)].  
