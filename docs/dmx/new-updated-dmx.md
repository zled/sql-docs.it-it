---
title: Aggiornato - DMX per la documentazione di SQL Server | Documenti Microsoft
description: Visualizzare i frammenti di contenuto aggiornato per la documentazione modificato di recente in, per le estensioni DMX (Data Mining) per Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
---
# <a name="new-and-recently-updated-data-mining-extensions-dmx-for-sql-server"></a>Nuovi e aggiornati: Data Mining Extensions (DMX) per SQL Server
...
- *Area di interesse:* &nbsp; **Data Mining DMX (Data Extensions) per SQL Server**.
