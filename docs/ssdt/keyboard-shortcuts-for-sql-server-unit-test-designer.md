...
[Tasti di scelta rapida per l'editor Transact-SQL (Visual Studio 2010)](http://go.microsoft.com/fwlink/?LinkId=160735)  
[Funzionalità di accessibilità di Visual Studio (Visual Studio 2010)](http://msdn.microsoft.com/library/y4b5z3y3(VS.90).aspx)  
[Funzionalità di accessibilità di Visual Studio (Visual Studio 2012)](http://msdn.microsoft.com/library/y4b5z3y3.aspx)  
