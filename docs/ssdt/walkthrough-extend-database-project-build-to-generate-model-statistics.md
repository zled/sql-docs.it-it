...
-   Definire una classe denominata ModelStatistics che erediti da [BuildContributor](http://msdn.microsoft.com/library/microsoft.sqlserver.dac.deployment.buildcontributor.aspx).  
