...
Ora è disponibile la versione di anteprima di SSDT per Visual Studio 2017 (anteprima 15.3.0). Questa versione introduce un'esperienza di installazione Web autonoma per i progetti SQL Server Database, Analysis Services, Reporting Services e Integration Services in Visual Studio 2017 15.3 o versioni successive.

| SSDT per Visual Studio 2017 (anteprima) | SSDT per Visual Studio 2015 | 
|:--|:--|
|[![download](../ssdt/media/download.png) Download di SSDT per Visual Studio 2017 (anteprima 15.3.0) ](https://go.microsoft.com/fwlink/?linkid=853836) | [![download](../ssdt/media/download.png) Download di SSDT per Visual Studio 2015 (17.2)](https://go.microsoft.com/fwlink/?linkid=852922)|
|||

> [!IMPORTANT]
> Prima di installare SSDT per Visual Studio 2017 (anteprima) chiudere tutte le istanze di Visual Studio e disinstallare SSAS e SSRS se sono già installati in VS 2017.
> 


Sia SSDT per Visual Studio 2015 che SSDT per Visual Studio 2017 usano DacFx 17.2: [scaricare Data-Tier Application Framework (DacFx) 17.2](https://www.microsoft.com/download/details.aspx?id=55713)
...
Numero di versione: anteprima 15.3.0  
Numero di build per questa versione: 14.0.16121.0
...
-   [Esercitazione SSIS: Creare un pacchetto ETL semplice](/sql-docs/docs/integration-services/ssis-how-to-create-an-etl-package)  
  
-   [Esercitazioni su Analysis Services](/sql-docs/docs/analysis-services/analysis-services-tutorials-ssas)  
  
-   [Creare un report tabella semplice (esercitazione su SSRS)](/sql-docs/docs/reporting-services/create-a-basic-table-report-ssrs-tutorial)  
