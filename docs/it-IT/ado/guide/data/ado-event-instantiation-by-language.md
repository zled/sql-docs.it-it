---
title: Creazione di istanze di ADO evento dal linguaggio | Documenti Microsoft
ms.prod: sql
...
---
# <a name="ado-event-instantiation-by-language"></a>Creazione di istanze di ADO evento dal linguaggio
Ogni linguaggio di programmazione crea istanze degli eventi di ADO in modo diverso. Creare tutti gli esempi seguenti una **ConnectComplete** gestore dell'evento.  
