...
### Per definire una nuova origine dati  
...
2.  Nella pagina **Creazione guidata origine dati****** fare clic su **Avanti** per aprire la pagina **Selezione metodo di definizione connessione**.  
