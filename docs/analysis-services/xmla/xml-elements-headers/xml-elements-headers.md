...
## <a name="in-this-section"></a>Contenuto della sezione  
 Gli argomenti seguenti descrivono gli elementi di intestazione XMLA implementati da Analysis Services.  
...
|[Elemento di sessione &#40;XMLA&#41;](../../../analysis-services/xmla/xml-elements-headers/session-element-xmla.md)|Utilizza l'intestazione SOAP in un messaggio di richiesta SOAP per identificare una sessione esplicita esistente in un'istanza di [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)].|  
