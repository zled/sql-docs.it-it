...
## <a name="example"></a>Esempio  
 Nell'esempio di codice seguente, il client invia il **Discover** chiamata per richiedere un elenco di cubi dal [!INCLUDE[ssAWDWsp](../../includes/ssawdwsp-md.md)] database di Analysis Services di esempio:  
