...
|Metodo|Description|  
|------------|-----------------|  
|[Elemento DiscoverResponse &#40; XMLA &#41;](../../analysis-services/xmla/xml-elements-objects-discoverresponse.md)|Contiene le informazioni restituite da un'istanza di [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] in risposta a un [Discover](../../analysis-services/xmla/xml-elements-methods-discover.md) chiamata al metodo.|  
|[Elemento ExecuteResponse &#40; XMLA &#41;](../../analysis-services/xmla/xml-elements-objects-executeresponse.md)|Contiene le informazioni restituite da un'istanza di [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] in risposta a un [Execute](../../analysis-services/xmla/xml-elements-methods-execute.md) chiamata al metodo.|  
