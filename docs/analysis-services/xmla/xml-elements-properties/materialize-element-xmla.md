---
title: Elemento Materialize (XMLA) | Documenti Microsoft
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Specifica se materializzare le aggregazioni progettate dal [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md) comando.  
