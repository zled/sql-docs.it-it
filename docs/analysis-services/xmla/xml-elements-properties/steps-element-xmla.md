...
# <a name="steps-element-xmla"></a>Elemento Steps (XMLA)
  Specifica il numero massimo di passaggi utilizzati per il [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md) comando per progettare aggregazioni.  
