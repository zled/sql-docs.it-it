...
## <a name="remarks"></a>Note  
 Per la **RelationshipEndVisualizationProperties** gli elementi, il **FolderPosition** elemento contiene la posizione dell'elemento cartella predefinita in una raccolta di cartelle. Il valore predefinito **false** non indica è presente alcuna cartella predefinita da utilizzare.  
