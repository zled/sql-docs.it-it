...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Identifica una partizione all'interno di un elemento padre che contiene un riferimento all'oggetto.  
