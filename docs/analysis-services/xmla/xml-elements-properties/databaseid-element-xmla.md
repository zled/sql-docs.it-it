...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Identifica un database all'interno di un elemento padre che contiene un riferimento all'oggetto.  
