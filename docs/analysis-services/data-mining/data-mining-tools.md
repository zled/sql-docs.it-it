...
ms.topic: "article"
helpviewer_keywords: 
  - "strumenti [Analysis Services]"
  - "modelli di data mining [Analysis Services], strumenti"
  - "data mining [Analysis Services], strumenti"
...
## Attività di data mining e trasformazioni in Integration Services  
