...
ms.topic: "article"
helpviewer_keywords: 
  - "algoritmi di segmentazione [Analysis Services]"
  - "adiacente più prossimo [data mining]"
  - "clustering [Data Mining]"
  - "cluster [Analysis Services]"
  - "relazioni [Analysis Services], cluster"
...
## Funzionamento dell'algoritmo  
 ...
 ![Grafico a dispersione dei case in un set di dati](../../analysis-services/data-mining/media/clustering-plot.png "Grafico a dispersione dei case in un set di dati")  
