...
# Algoritmo Microsoft Association Rules
 ...
 ![Set di regole per un modello Association Rules](../../analysis-services/data-mining/media/association.gif "Set di regole per un modello Association Rules")  
