...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Progettazione di Data Mining in [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] include diversi strumenti che è possibile utilizzare per esplorare i modelli di data mining. Gli argomenti seguenti contengono istruzioni dettagliate su come completare le attività correlate all'uso della scheda **Visualizzatore modello di data mining** nella finestra di progettazione.  
