...
ms.topic: "article"
helpviewer_keywords: 
  - "esclusione di colonne di modelli di data mining"
  - "modelli di data mining [Analysis Services], colonne"
  - "colonne [data mining], esclusione"
...
---
# Escludere una colonna da un modello di data mining
...
### Per escludere una colonna da un modello di data mining  
