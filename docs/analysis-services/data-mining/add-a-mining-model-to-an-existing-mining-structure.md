...
ms.topic: "article"
helpviewer_keywords: 
  - "modelli di data mining [Analysis Services], aggiunta"
  - "strutture di data mining [Analysis Services], modelli di data mining"
  - "aggiunta di modelli di data mining"
...
---
# Aggiungere un modello di data mining a una struttura di data mining esistente
...
### Per aggiungere un modello di data mining alla struttura  
