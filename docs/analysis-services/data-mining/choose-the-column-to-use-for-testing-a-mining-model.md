...
ms.topic: "article"
helpviewer_keywords: 
  - "colonne [data mining], colone stimabili di modello di data mining"
  - "grafico accuratezza modello di data mining [Analysis Services], colonne"
  - "colone stimabili di modello di data mining [Analysis Services]"
