...
helpviewer_keywords: 
  ...
  - "colonne discrete [Analysis Services]"
...
### Stima di colonne continue  
 ...
 ![Più rette di regressione che indicano la non linearità](../../analysis-services/data-mining/media/regression-tree1.png "Più rette di regressione che indicano la non linearità")  
