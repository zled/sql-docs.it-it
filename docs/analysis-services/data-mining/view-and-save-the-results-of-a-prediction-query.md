...
helpviewer_keywords: 
  ...
  - "risultati di query di stima - visualizzazione"
  - "visualizzazione di risultati di query di stima"
  - "Stima modello di data mining [Analysis Services], visualizzazione dei risultati"
...
---
# Visualizzare e salvare i risultati di una query di stima
...
### Eseguire una query e visualizzare i risultati  
...
### Salvare i risultati di una query di stima in una tabella  
