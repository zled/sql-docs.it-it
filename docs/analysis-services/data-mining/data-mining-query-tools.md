...
helpviewer_keywords: 
  ...
  - "stime (DMX)"
  - "DMX [Analysis Services], query di stima"
  - "query di stima [DMX]"
  - "stime [Analysis Services]"
