...
helpviewer_keywords: 
  ...
  - "oggetti di Analysis Services, oggetti di data mining"
...
# Strutture di data mining (Analysis Services – Data mining)
 ...
 ![Elaborazione dei dati: origine-struttura-modello](../../analysis-services/data-mining/media/dmcon-modelarch.gif "Elaborazione dei dati: origine-struttura-modello")  
...
### Suddivisione dei dati in set di training e di testing  
...
### Visualizzazione delle strutture di data mining  
 ...
 L'istruzione `SELECT * FROM <model>.CASES` restituisce le stesse colonne, ma solo per i case di quel modello specifico. Per altre informazioni, vedere [SELECT FROM &#60;structure&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) e [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
|Utilizzare le strutture di data mining basate su cubi OLAP|[Creare una nuova struttura di data mining OLAP](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [Filtrare il cubo di origine per una struttura di data mining](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
