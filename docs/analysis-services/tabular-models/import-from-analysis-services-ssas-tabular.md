...
---
# Importare da Analysis Services (SSAS tabulare)
...
## Creare un nuovo modello importando i metadati da un modello esistente in Analysis Services  
...
#### Per creare un nuovo modello importando metadati da un modello esistente  
