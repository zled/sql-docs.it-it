---
title: "Filtri incrociati bidirezionali per i modelli tabulari in SQL Server 2016 Analysis Services | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# Filtri incrociati bidirezionali per i modelli tabulari in SQL Server 2016 Analysis Services
 ...
 In SSDT, il meccanismo di configurazione di un filtro incrociato passa attraverso l'opzione Direzione filtro nella finestra di dialogo delle relazioni tra tabelle. Questa funzionalità è disponibile solo per i modelli tabulari creati al livello di compatibilità 1200 in [SQL Server Data Tools per Visual Studio 2015 (SSDT)](http://go.microsoft.com/fwlink/p/?LinkID=627574).  
...
4.  Verificare che il livello di compatibilità del modello sia impostato su **SQL Server 2016 RTM (1200)**.  
...
### Esaminare le relazioni tra tabelle predefinite  
...
### Modificare il filtro incrociato  
...
## Vedere anche  
 ...
 [Esempio pratico di gestione di semplici relazioni molti-a-molti nei modelli tabulari Power Pivot e SSAS](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
