---
title: "Configurare le propriet&#224; Comportamento tabella per i report Power View (SSAS tabulare) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "erikre"
---
# Configurare le propriet&#224; Comportamento tabella per i report Power View (SSAS tabulare)
...
### Una o più righe mancanti nelle tabelle  
 ...
 ![Dati della riga contenenti duplicati basati sull'ID di riga](../../analysis-services/tabular-models/media/ssas-jonyang.gif "Dati della riga contenenti duplicati basati sull'ID di riga")  
 ...
 **Prima: raggruppamento predefinito basato sui campi nella matrice**  
 ...
 ![Layout di matrice raggruppato per identificatore di riga](../../analysis-services/tabular-models/media/ssas-rptprop-matrixrowid.gif "Layout di matrice raggruppato per identificatore di riga")  
