...
### DAX  
 ...
 Per esempi di esecuzione di query su un modello tabulare usando DAX, vedere [Riferimento alla sintassi di query DAX](http://msdn.microsoft.com/it-it/4dd0cf0e-191d-411d-987c-f606813fc39e).  
...
-   [Set di righe DISCOVER_XEVENT_TRACE_DEFINITION](../Topic/DISCOVER_XEVENT_TRACE_DEFINITION%20Rowset.md)  
