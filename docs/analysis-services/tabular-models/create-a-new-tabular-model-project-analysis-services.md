...
3.  In **Nome**digitare un nome per il progetto, quindi specificare un percorso e un nome per la soluzione e scegliere **OK**.  
 ...
 Una volta creato il nuovo progetto, è importante impostare le proprietà del progetto e del modello. Per ulteriori informazioni, vedere [le proprietà del progetto](../../analysis-services/tabular-models/project-properties-ssas-tabular.md) e [proprietà del modello](../../analysis-services/tabular-models/model-properties-ssas-tabular.md).  
