...
ms.topic: "reference"
helpviewer_keywords: 
  - "PriorityRatio - proprietà"
  - "thread [Analysis Services]"
  - "MinThreads - proprietà"
  - "NumThreads - proprietà"
  - "MaxThreads - proprietà"
...
##  <a name="bkmk_pernumanode"></a> Impostare PerNumaNode per creare affinità fra i thread I/O e i processori in un nodo NUMA  
 ...
 **Impostazione PerNumaNode=0**  
 ...
 ![Corrispondenza NUMA, processore e pool di thread](../../analysis-services/server-properties/media/ssas-threadpool-numaex0.PNG "Corrispondenza NUMA, processore e pool di thread")  
 ...
 **Impostazione PerNumaNode=1**  
 ...
 ![Corrispondenza NUMA, processore e pool di thread](../../analysis-services/server-properties/media/ssas-threadpool-numaex1.PNG "Corrispondenza NUMA, processore e pool di thread")  
 ...
 **Impostazione PerNumaNode=2**  
 ...
 ![Corrispondenza NUMA, processore e pool di thread](../../analysis-services/server-properties/media/ssas-threadpool-numaex2.PNG "Corrispondenza NUMA, processore e pool di thread")  
...
##  <a name="bkmk_currentsettings"></a> Determinare le impostazioni del pool di thread corrente  
...
## Vedere anche  
 ...
 [Processori multipli](http://msdn.microsoft.com/library/windows/desktop/ms684251\(v=vs.85\).aspx)   
