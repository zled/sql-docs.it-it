...
2.  Fare clic sul pulsante **Nuovo indicatore KPI** sulla barra degli strumenti della scheda **KPI**.  
    ...
    ![Modello di indicatore KPI vuoto nel riquadro di visualizzazione](../analysis-services/media/l7-kpi-2.gif "Modello di indicatore KPI vuoto nel riquadro di visualizzazione")  
...
## Esplorazione del cubo utilizzando l'indicatore KPI Reseller Revenue  
...
## Definizione dell'indicatore KPI Product Gross Profit Margin  
...
## Esplorazione del cubo utilizzando l'indicatore KPI Total Gross Profit Margin  
