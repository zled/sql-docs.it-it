...
2.  Fare clic su **Nuovo membro calcolato** sulla barra degli strumenti della scheda **Calcoli**.  
    ...
    ![Form del riquadro Espressioni di calcolo](../analysis-services/media/l6-calculatedmembers-02.gif "Form del riquadro Espressioni di calcolo")  
...
9. Nell'elenco **Gestione NON EMPTY** selezionare le caselle di controllo corrispondenti a **Internet Sales-Sales Amount** e **Reseller Sales-Sales Amount** e fare clic su **OK**.  
    ...
    ![Riquadro Espressioni di calcolo compilato](../analysis-services/media/l6-calculatedmembers-03.gif "Riquadro Espressioni di calcolo compilato")  
...
11. Aggiungere una nuova riga nello script di calcolo dopo il comando **Calculate;** e prima dello script di calcolo appena aggiunto, poi aggiungere il testo seguente allo script su una riga a sé stante:  
    ...
    ![Script nel riquadro Espressioni di calcolo](../analysis-services/media/l6-calculatedmembers-04.gif "Script nel riquadro Espressioni di calcolo")  
...
8.  Aggiungere le misure **Total GPM**, **Internet GPM** e **Reseller GPM** all'area Valori e controllare i risultati.  
    ...
    ![Vendite dei rivenditori visualizzate nel riquadro dei dati](../analysis-services/media/l6-calculatedmembers-7b.gif "Vendite dei rivenditori visualizzate nel riquadro dei dati")  
...
[Definizione dei set denominati](../analysis-services/defining-named-sets.md)  
