...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene la raccolta di [membro](../../../analysis-services/scripting/objects/member-element-assl.md) gli elementi dell'elemento padre.  
