...
ms.locfileid: "34031882"
---
# <a name="action-element-assl"></a>Elemento Action (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  Contiene informazioni su un'azione disponibile in un elemento [Cube](../../../analysis-services/scripting/objects/cube-element-assl.md) o [Perspective](../../../analysis-services/scripting/objects/perspective-element-assl.md) .  
