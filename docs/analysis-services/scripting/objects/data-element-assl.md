...
# <a name="data-element-assl"></a>Elemento Data (ASSL)
  Contiene (nella raccolta di figlio [blocco &#40; ASSL &#41; ](../../../analysis-services/scripting/objects/block-element-assl.md) elementi) del contenuto binario di un [ClrAssemblyFile](../../../analysis-services/scripting/data-type/clrassemblyfile-data-type-assl.md) elemento.  
