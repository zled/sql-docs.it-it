...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Specifica se la password dell'utente viene rimossa dalla stringa di connessione all'origine dati per motivi di sicurezza.  
