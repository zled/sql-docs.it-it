...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene le informazioni utilizzate per determinare il comportamento di rappresentazione durante la connessione all'origine dati per un [Database](../../../analysis-services/scripting/objects/database-element-assl.md) elemento.  
