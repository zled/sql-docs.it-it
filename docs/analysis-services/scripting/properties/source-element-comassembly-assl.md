...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene il nome file o l'identificatore programmatico (ProgID) per un componente del modello COM (Component Object).  
