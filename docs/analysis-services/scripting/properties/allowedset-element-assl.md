...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene un'espressione set che definisce il set di autorizzazioni consentite per un [ruolo](../../../analysis-services/scripting/objects/role-element-assl.md) elemento in un attributo.  
