...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene l'identificatore (ID) della dimensione del cubo che correla la dimensione di data mining al gruppo di misure.  
