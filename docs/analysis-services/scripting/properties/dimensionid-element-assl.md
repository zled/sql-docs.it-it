...
## <a name="remarks"></a>Note  
 Gli elementi che corrispondono ai padri di **DimensionID** nel modello a oggetti oggetti AMO (Analysis Management) vengono <xref:Microsoft.AnalysisServices.CubeDimension> e <xref:Microsoft.AnalysisServices.DimensionBinding>.  
