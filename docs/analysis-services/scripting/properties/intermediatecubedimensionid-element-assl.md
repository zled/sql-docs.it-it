...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene l'identificatore (ID) della dimensione che correla una dimensione di riferimento a un gruppo di misure.  
