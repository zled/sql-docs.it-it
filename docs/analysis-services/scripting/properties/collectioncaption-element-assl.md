...
|Relazione|Elemento|  
|------------------|-------------|  
|Elementi padre|[RelationshipEndTranslation](../../../analysis-services/scripting/data-type/relationshipendtranslation-element-assl.md)|  
|Elementi figlio|Nessuno|  
  
## <a name="remarks"></a>Osservazioni  
 L'elemento che corrisponde all'elemento padre **CollectionCaption** nell'oggetto oggetti AMO (Analysis Management) modello è t:Microsoft.AnalysisServices.relationshipendtranslation..  
