---
title: Tipo di dati TimeAttributeBinding (ASSL) | Documenti Microsoft
ms.custom: ''
ms.date: 03/03/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Definisce un tipo di dati derivato che rappresenta un'associazione "segnaposto" per gli elementi di dati generati, ad esempio le colonne chiave di un attributo, in una dimensione temporale del server.  
...
## <a name="remarks"></a>Osservazioni  
 ...
 L'elemento corrispondente nel modello a oggetti oggetti AMO (Analysis Management) è <xref:Microsoft.AnalysisServices.TimeAttributeBinding>.  
