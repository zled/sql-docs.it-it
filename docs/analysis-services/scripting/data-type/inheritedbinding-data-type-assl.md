...
# <a name="inheritedbinding-data-type-assl"></a>Tipo di dati InheritedBinding (ASSL)
  Definisce un tipo di dati derivato che indica che un [MeasureGroupAttribute](../../../analysis-services/scripting/data-type/measuregroupattribute-data-type-assl.md) elemento eredita le associazioni dall'attributo.  
