---
title: Il tipo di dati DataSourceViewBinding (ASSL) | Documenti Microsoft
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Definisce un tipo di dati derivato che rappresenta un'associazione tra una vista origine dati e l'elemento padre.  
...
|------------------|-------------|  
|Elementi padre|None|  
|Elementi figlio|[DataSourceViewID](../../../analysis-services/scripting/properties/datasourceviewid-element-assl.md)|  
