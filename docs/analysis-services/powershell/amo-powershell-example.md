---
title: "Esempio di PowerShell per AMO | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Esempio di PowerShell per AMO
  Di seguito è riportato uno script di PowerShell che chiama i tipi AMO (Analysis Services Management Object) per creare un database tabulare, con livello di compatibilità 1200, basato su un database relazionale di SQL Server.  
  
 Questo esempio viene fornito solo per scopi dimostrativi. Si interrompe prima di definire le relazioni tra tabelle e non include l'importazione dei dati.  Rende lo script un frammento di codice più che un codice pronto per l'esecuzione. Per essere eseguito, sono necessarie altre funzioni di supporto e altri comandi per colmare le lacune.  
  
## Esempio DatabaseGenerate.ps1  
