...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Restituisce le proprietà globali del [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] oggetto servizio di sistema in una farm. 
