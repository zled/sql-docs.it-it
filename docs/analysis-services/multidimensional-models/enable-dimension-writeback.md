...
ms.topic: "article"
helpviewer_keywords: 
  - "modifica di dimensioni"
  - "writeback [Analysis Services], impostazione"
  - "dimensioni [Analysis Services], miglioramenti di Business Intelligence"
  - "miglioramenti di Business Intelligence [Analysis Services], writeback"
  - "dimensioni [Analysis Services], writeback"
  - "writeback [Analysis Services]"
  - "dimensioni [Analysis Services], modifica"
  - "modifiche manuali di struttura dimensione"
...
## Impostazione della funzionalità di writeback della dimensione  
