...
ms.topic: "article"
helpviewer_keywords: 
  - "NameColumn - proprietà"
  - "discretizzazione [Analysis Services]"
  - "gruppi di membri [Analysis Services]"
  - "raggruppamento di membri"
  - "DiscretizationNumber - proprietà"
  - "tipi di ordinamento [Analysis Services]"
  - "DiscretizationMethod - proprietà"
  - "aggiunta di membri a gruppo"
  - "numero di gruppi di membri"
  - "membri [Analysis Services], gruppi"
  - "nomi [Analysis Services], gruppi di membri"
...
manager: "erikre"
---
# Raggruppare membri di attributo (discretizzazione)
