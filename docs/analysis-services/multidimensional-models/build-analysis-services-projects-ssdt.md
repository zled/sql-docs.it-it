...
ms.topic: "article"
helpviewer_keywords: 
  - "progetti [Analysis Services], compilazione"
  - "Business Intelligence Development Studio, compilazione progetti [Analysis Services]"
...
|\<Nome configurazione>\LastBuilt.xml|Contiene il timestamp e il codice hash che identificano l'ultima compilazione del progetto di [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)].|  
 ...
 Questi file XML non contengono i tag \<Create> e \<Alter>, costruiti durante la distribuzione.  
