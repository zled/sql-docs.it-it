---
title: "Concedere le autorizzazioni per il database (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "autorizzazioni [Analysis Services], controllo completo"
  - "autorizzazioni di controllo completo [Analysis Services]"
...
# Concedere le autorizzazioni per il database (Analysis Services)
 ...
 ![Finestra di dialogo Creazione ruolo con autorizzazioni database](../../analysis-services/multidimensional-models/media/ssas-permsdbrole.png "Finestra di dialogo Creazione ruolo con autorizzazioni database")  
