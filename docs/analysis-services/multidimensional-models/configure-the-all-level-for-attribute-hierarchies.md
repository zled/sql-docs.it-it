...
helpviewer_keywords: 
  - "tutti i membri"
  - "IsAggregatable - proprietà"
  - "livelli superiori [Analysis Services]"
  - "livelli (Totale)"
  - "AttributeAllMemberName - proprietà"
  - "livelli [Analysis Services]"
  - "membri [Analysis Services], Totale"
...
## Determinazione del livello superiore  
...
## Membro Totale e livello (Totale)  
...
## Vedere anche  
 [Definire un membro predefinito](../../analysis-services/multidimensional-models/define-a-default-member.md)  
