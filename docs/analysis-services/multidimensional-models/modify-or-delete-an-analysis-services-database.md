...
ms.topic: "article"
helpviewer_keywords: 
  - "database [Analysis Services], modifica"
  - "rimozione di database"
  - "eliminazione di database"
  - "database - eliminazione"
  - "database [Analysis Services], eliminazione"
...
---
# Modificare o eliminare un database di Analysis Services
...
## Modifica di databases tramite SQL Server Management Studio  
...
## Modifica di database tramite SQL Server Data Tools  
...
#### Per eliminare un database di Analysis Services  
