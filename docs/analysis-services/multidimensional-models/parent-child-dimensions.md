...
ms.topic: "article"
helpviewer_keywords: 
  - "gerarchie [Analysis Services], padre-figlio"
  - "dimensioni [Analysis Services], padre-figlio"
  - "attributi padre [Analysis Services]"
...
## Schema della dimensione  
 ...
 ![Join autoreferenziale nella tabella DimOrganization](../../analysis-services/multidimensional-models/media/dimorganization.png "Join autoreferenziale nella tabella DimOrganization")  
