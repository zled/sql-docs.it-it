...
ms.topic: "article"
helpviewer_keywords: 
  - "distribuzione [Analysis Services], prompt dei comandi"
  - "utilità del prompt dei comandi [SQL Server], Microsoft.AnalysisServices.Deployment"
  - "Microsoft.AnalysisServices.Deployment - utilità"
  - "distribuzioni di Analysis Services, prompt dei comandi"
