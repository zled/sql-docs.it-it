...
ms.topic: "article"
helpviewer_keywords: 
  - "SSAS, interfacce di accesso ai dati"
  - "oggetti [Analysis Services], interfacce di accesso ai dati"
  - "Interfacce di accesso ai dati di Analysis Services"
  - "recupero di dati [Analysis Services]"
  - "recupero di dati"
  - "metadati [Analysis Services]"
  - "interfacce di accesso ai dati [Analysis Services]"
  - "modifica di oggetti [Analysis Services]"
  - "interfacce di accesso ai dati di Analysis Services, informazioni sulle interfacce di accesso ai dati"
