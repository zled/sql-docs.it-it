...
|**BACK_COLOR**|Il colore di sfondo per la visualizzazione della proprietà **VALUE** o **FORMATTED_VALUE**. Per altre informazioni, vedere [Contenuto di FORE_COLOR e BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
...
|**FORE_COLOR**|Il colore di primo piano per la visualizzazione della proprietà **VALUE** o **FORMATTED_VALUE**. Per altre informazioni, vedere [Contenuto di FORE_COLOR e BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
|**FORMAT**|Come **FORMAT_STRING**.|  
|**FORMAT_STRING**|La stringa di formato utilizzata per creare il valore della proprietà **FORMATTED_VALUE**. Per altre informazioni, vedere [Contenuto di FORMAT_STRING &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/format-string-contents-mdx.md).|  
