...
ms.topic: "article"
helpviewer_keywords: 
  - "writeback [Analysis Services], cubi"
  - "cubi [Analysis Services], modifica"
  - "modifica di cubi"
  - "UPDATE CUBE - istruzione"
  - "cubi [Analysis Services], writeback"
...
## Vedere anche  
 [Modifica dei dati &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/modifying-data-mdx.md)  
