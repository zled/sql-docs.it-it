...
ms.topic: "article"
helpviewer_keywords: 
  - "oggetti OLAP [Analysis Services], cubi"
  - "cubi [Analysis Services], informazioni"
  - "cubi [Analysis Services]"
  - "OLAP [Analysis Services], cubi"
...
## Vantaggi derivanti dall'utilizzo dei cubi  
...
|Gerarchie|[Creare gerarchie definite dall'utente](../../analysis-services/multidimensional-models/create-user-defined-hierarchies.md)|  
