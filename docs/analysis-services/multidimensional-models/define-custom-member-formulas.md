...
ms.topic: "article"
helpviewer_keywords: 
  - "membri [Analysis Services], personalizzati"
  - "formule personalizzate di rollup [Analysis Services]"
  - "MDX [Analysis Services], formule personalizzate di rollup"
...
manager: "erikre"
---
# Definire formule personalizzate membro
...
## Valutazione delle formule personalizzate membro  
...
## Vedere anche  
 ...
 [Impostare formule personalizzate membro per gli attributi in una dimensione](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
