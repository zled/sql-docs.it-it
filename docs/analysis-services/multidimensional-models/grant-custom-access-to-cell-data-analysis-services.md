...
helpviewer_keywords: 
  - "diritti di accesso utente [Analysis Services], dati delle celle"
  - "autorizzazioni [Analysis Services], celle"
  - "autorizzazioni di lettura condizionale"
  - "autorizzazioni di lettura"
  - "celle [Analysis Services]"
  - "accesso personalizzato a dati di celle [Analysis Services]"
...
## Consentire l'accesso a misure specifiche  
...
## Negare l'accesso a misure specifiche  
...
## Impostare le autorizzazioni di lettura nelle misure calcolate  
...
```  
 ...
 ![Tabella di Excel con celle disponibili e non disponibili](../../analysis-services/multidimensional-models/media/ssas-permscalculatedcells.png "Tabella di Excel con celle disponibili e non disponibili")  
  
## Impostare le autorizzazioni di lettura condizionale nelle misure calcolate  
...
## Impostare le autorizzazioni di lettura/scrittura in una cella  
...
## Vedere anche  
 [Generatore MDX &#40;Analysis Services - Dati multidimensionali&#41;](../Topic/MDX%20Builder%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
