...
helpviewer_keywords: 
  - "viste origine dati [Analysis Services], diagrammi"
  - "diagrammi [Analysis Services]"
...
##  <a name="bkmk_add"></a> Aggiungere un diagramma  
 ...
 Quando si definisce inizialmente una vista origine dati in un progetto di Analysis Services, tutte le tabelle e le viste aggiunte alla vista origine dati vengono aggiunte al diagramma \<Tutte le tabelle>. Questo diagramma viene visualizzato nel riquadro Libreria diagrammi di Progettazione vista origine dati, mentre le tabelle di tale diagramma e le relative colonne e relazioni vengono elencate nel riquadro Tabelle e visualizzate graficamente nel riquadro degli schemi. Con l'aggiunta di tabelle, viste e query denominate al diagramma \<Tutte le tabelle>, tuttavia, il numero degli oggetti nel diagramma rende complessa la visualizzazione delle relazioni, in particolare quando vengono aggiunte più tabelle dei fatti al diagramma e sono presenti tabelle delle dimensioni correlate a più tabelle dei fatti.  
 ...
 È possibile raggruppare query denominate e tabelle correlate in diagrammi separati per scopi aziendali, nonché per rendere maggiormente comprensibile una vista origine dati contenente un numero elevato di tabelle e query denominate. La stessa tabella o query denominata può essere inclusa in più diagrammi, ad eccezione del diagramma \<Tutte le tabelle>. In tale diagramma vengono visualizzati una sola volta tutti gli oggetti contenuti nella vista origine dati.  
...
## Vedere anche  
 ...
 [Progettazione vista origine dati &#40;Analysis Services - Dati multidimensionali&#41;](../Topic/Data%20Source%20View%20Designer%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
