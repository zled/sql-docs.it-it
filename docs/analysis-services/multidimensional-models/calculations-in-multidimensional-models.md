...
ms.topic: "article"
helpviewer_keywords: 
  - "calcoli [Analysis Services], creazione"
  - "eliminazione di calcoli"
  - "calcoli [Analysis Services], script"
  - "Progettazione cubi"
  - "modifica di script"
  - "rimozione di calcoli"
  - "calcoli [Analysis Services], eliminazione"
  - "script [Analysis Services], calcoli"
  - "cubi [Analysis Services], calcoli"
  - "ordini di valutazione [Analysis Services]"
...
---
# Calcoli nei modelli multidimensionali
