...
ms.topic: "article"
helpviewer_keywords: 
  - "autorizzazioni [Analysis Services], assembly"
  - "chiamate a funzioni definite dall'utente"
  - "rappresentazione utente [Analysis Services]"
  - "rappresentazione [Analysis Services]"
  - "Data Mining Extensions [Analysis Services], assembly"
  - "MDX [Analysis Services], assembly"
  - "funzioni definite dall'utente [Analysis Services]"
  - "oggetti di Analysis Services, assembly"
  - "assembly [Analysis Services]"
  - "domini di applicazioni [Analysis Services]"
