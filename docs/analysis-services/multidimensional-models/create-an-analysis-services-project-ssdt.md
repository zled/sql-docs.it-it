...
ms.topic: "article"
helpviewer_keywords: 
  - "modelli [Analysis Services]"
  - "modelli [Analysis Services], progetti"
  - "progetti [Analysis Services], creazione"
  - "progetti [Analysis Services], Business Intelligence Development Studio"
  - "Business Intelligence Development Studio, definizione di progetti [Analysis Services]"
