...
helpviewer_keywords: 
  - "diritti di accesso [Analysis Services], utenti"
  - "autorizzazioni [Analysis Services], utenti"
  - "sicurezza [Analysis Services], accesso utente"
  - "diritti di accesso utente [Analysis Services]"
  - "concessione di autorizzazioni [Analysis Services], utenti"
