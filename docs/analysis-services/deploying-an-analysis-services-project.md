---
title: "Distribuzione di un progetto di Analysis Services | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
### Per distribuire il progetto di Analysis Services  
...
2.  Nel nodo **Proprietà di configurazione** fare clic su **Distribuzione**.  
    ...
    > [!NOTE]  
    > Per distribuire il progetto a un'istanza denominata di [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] sul computer locale o in un'istanza su un server remoto, modificare la proprietà **Server** impostando il nome dell'istanza appropriata, ad esempio \<*NomeServer**>\\<**NomeIstanza**>*.  
...
[Esplorazione del cubo](../analysis-services/browsing-the-cube.md)  
