...
1. [Compatibilità con le versioni precedenti di Analysis Services (2017 SQL)](analysis-services-backward-compatibility-sql2017.md)
2. [Sicurezza a livello di oggetto](tabular-models/object-level-security.md)
