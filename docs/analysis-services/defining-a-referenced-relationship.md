---
title: "Definizione di una relazione di tipo Riferimento | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
3.  Dalla dimensione **Geography** nel riquadro Metadati trascinare la gerarchia definita dall'utente **Geographies** nell'area **Rilasciare qui i campi riga** del riquadro Dati.  
    ...
    ![Misura dimensionata Reseller Sales-Sales Amount](../analysis-services/media/l5-referencedrelationship-1.gif "Misura dimensionata Reseller Sales-Sales Amount")  
...
8.  Fare clic sul pulsante con i puntini di sospensione (**…**) nella cella **Nome completo** nel punto di intersezione tra la dimensione **Customer** e il gruppo di misure **Internet Sales**.  
    ...
    ![Finestra di dialogo Definisci relazione](../analysis-services/media/l5-referencedrelationship-4.gif "Finestra di dialogo Definisci relazione")  
...
3.  Nel riquadro Metadati espandere **Reseller Geography**, fare clic con il pulsante destro del mouse su **Geographies** e quindi scegliere **Aggiungi all'area riga**.  
    ...
    ![Finestra di dialogo Definisci relazione](../analysis-services/media/l5-referencedrelationship-5.gif "Finestra di dialogo Definisci relazione")  
  
## Attività successiva della lezione  
[Definizione di una relazione di tipo Fatti](../analysis-services/defining-a-fact-relationship.md)  
