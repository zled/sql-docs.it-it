...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Una prospettiva è un meccanismo per semplificare o concentrare il modello in una parte più piccola di esso per l'applicazione client.  
