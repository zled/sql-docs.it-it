...
manager: "erikre"
---
# Impossibile aggiornare i dati per una connessione dati della cartella di lavoro. Riprovare o contattare l&#39;amministratore di sistema. Impossibile aggiornare le connessioni seguenti: Dati PowerPivot
 ...
 **Scenario 2a: apertura di una versione precedente della cartella di lavoro nel server**  
 ...
 In tal caso, il log ULS conterrà questo messaggio: "Aggiornamento non riuscito per 'dati [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]' nella cartella di lavoro '\<URL della cartella di lavoro>'", seguito da "Impossibile stabilire una connessione".  
