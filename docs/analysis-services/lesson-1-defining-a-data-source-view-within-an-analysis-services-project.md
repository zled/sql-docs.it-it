...
In questa attività, specificare il **AdventureWorksDW** database come origine dati per il [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] dimensioni e cubi che verranno definiti nelle lezioni successive.  
