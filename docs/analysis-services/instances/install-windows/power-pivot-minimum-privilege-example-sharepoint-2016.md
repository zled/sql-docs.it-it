---
title: "Esempio di una configurazione con privilegi minimi per Power Pivot per SharePoint 2016 | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
---
# Esempio di una configurazione con privilegi minimi per Power Pivot per SharePoint 2016
...
### Account del servizio per il servizio Power Pivot (SPsvc)  
 Se una nuova farm di SharePoint non viene configurata prima dell'esecuzione dello strumento di configurazione di [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)], quest'ultimo, per impostazione predefinita, creerà gli elementi seguenti:  
...
3.  Selezionare **Registra nuovo account gestito**.  
 ...
 L'account **SPSvc** non dispone dei privilegi di amministratore locale e SPsvc non disporrà di alcun privilegio nel database di SharePoint. Gli unici privilegi richiesti da SPsvc sono i diritti di amministratore per l'istanza di [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] di Analysis Services.  
