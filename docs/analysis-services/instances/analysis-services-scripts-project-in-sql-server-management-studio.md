...
ms.topic: "article"
helpviewer_keywords: 
  - "script [Analysis Services]"
  - "script [Analysis Services], progetti"
  - "progetti [Analysis Services], progetto script Analysis Server"
  - "progetti [Analysis Services], creazione"
  - "progetto script Analysis Server"
  - "elementi [Analysis Services]"
...
3.  Fare clic con il pulsante destro del mouse su **Query** per creare script MDX (Multidimensional Expressions), DMX (Data Mining Extensions) e XMLA (XML for Analysis) nella cartella Script del progetto Script di Analysis Server in Esplora soluzioni. Per altre informazioni, vedere [Creare script per le attività amministrative in Analysis Services](../../analysis-services/instances/script-administrative-tasks-in-analysis-services.md).  
