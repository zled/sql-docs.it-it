...
manager: "erikre"
---
# Installare dati di esempio e progetti per l&#39;esercitazione di modellazione multidimensionale di Analysis Services
...
## Passaggio 1: Installare il software SQL Server  
...
## Passaggio 2: Scaricare SQL Server Data Tools per Visual Studio 2015  
...
## Passaggio 3: installare database  
...
2.  Copiare il file AdventureWorksDW2012_Data.mdf nella directory dei dati dell'istanza locale del motore di database di SQL Server. Per impostazione predefinita, il percorso di questo file è C:\Programmi\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\Data.  
...
## Passaggio 4: concedere autorizzazioni per il database  
...
## Passaggio 5: installare i progetti  
