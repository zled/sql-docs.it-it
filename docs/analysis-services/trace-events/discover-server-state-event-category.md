...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]La categoria di eventi individuazione stato del Server include le classi di eventi descritte nella tabella seguente.  
