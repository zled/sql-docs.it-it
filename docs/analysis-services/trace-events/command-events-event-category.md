...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]La categoria di eventi eventi di comando include le classi di eventi descritte nella tabella seguente.  
