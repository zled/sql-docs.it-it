...
8.  Selezionare **SpanishMonthName** nell'elenco **Colonne per la traduzione**, come illustrato nella figura seguente.  
    ...
    ![Traduzione dati attributo - finestra di dialogo](../analysis-services/media/l9-translations-4.gif "Traduzione dati attributo - finestra di dialogo")  
...
1.  Passare a Progettazione cubi per il cubo [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Tutorial, poi passare alla scheda **Traduzioni**.  
    ...
    ![Lingua predefinita nella scheda Traduzioni](../analysis-services/media/l9-translations-5.gif "Lingua predefinita nella scheda Traduzioni")  
...
5.  Nella barra degli strumenti selezionare **Spagnolo (Spagna)** nell'elenco **Lingua**.  
    ...
    ![Riquadro dei metadati ripopolato](../analysis-services/media/l9-translations-6.png "Riquadro dei metadati ripopolato")  
...
9. Nel riquadro dei metadati fare clic con il pulsante destro del mouse su **Mes del Ano** e scegliere **Aggiungi a query**.  
    ...
    ![Nomi dei mesi in spagnolo nel riquadro dei dati](../analysis-services/media/l9-translations-7.gif "Nomi dei mesi in spagnolo nel riquadro dei dati")  
