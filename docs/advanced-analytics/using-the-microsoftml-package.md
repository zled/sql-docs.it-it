...
In SQL Server 2017 è stato aggiunto il supporto per il linguaggio Python. Il **microsoftml** dal pacchetto per Python contiene funzioni equivalenti a quelli del pacchetto MicrosoftML per R. 
