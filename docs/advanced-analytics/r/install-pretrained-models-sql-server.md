...
Questo articolo descrive come aggiungere i modelli con training preliminare a un'istanza di SQL Server che già dispone di R Services o SQL Server Machine Learning Services installato. 
