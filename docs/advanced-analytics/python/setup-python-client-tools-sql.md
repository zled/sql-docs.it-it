---
title: Configurare gli strumenti client Python per l'uso con SQL Server | Documenti Microsoft
ms.custom: ''
ms.date: 03/13/2018
...
---
# <a name="set-up-python-client-tools-for-use-with-sql-server"></a>Impostare Python gli strumenti client per l'uso con SQL Server 
