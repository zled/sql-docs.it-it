---
title: Eventi estesi per Python in SQL Server Machine Learning | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "31201633"
---
# <a name="extended-events-for-python-in-sql-server-machine-learning"></a>Eventi estesi per Python in SQL Server Machine Learning
