...
1. [Installazione dei componenti di machine learning senza accesso a internet](#TitleNum_1)
...
### <a name="1-nbsp-installing-machine-learning-components-without-internet-accessrinstalling-ml-components-without-internet-accessmd"></a>1. &nbsp;[Installazione dei componenti di machine learning senza accesso a internet](r/installing-ml-components-without-internet-access.md)
