...
4. La stored procedure restituisce una serie di valori che rappresentano la stima per ogni trip i primi dieci. Tuttavia, il superiore sono anche trip singolo passeggeri con una distanza di andata e ritorno relativamente breve, per cui il driver è improbabile che venga restituito un suggerimento.
...
In questa sezione si apprenderà come creare singole stime utilizzando una stored procedure.
...
3. I risultati indicano che la probabilità di ottenere un suggerimento è molto bassa in queste prime 10 trip, perché tutti sono trip singolo passeggeri su una distanza relativamente breve.
