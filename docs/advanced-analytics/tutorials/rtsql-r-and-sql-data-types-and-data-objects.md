...
Come si può notare, una leggera modifica nella sintassi di R ha un effetto notevole sullo schema dei risultati. Non verrà esaminato in per questo motivo, in quanto le differenze nei tipi di dati R sono descritte più approfonditamente in questo articolo di Hadley Wickham: [strutture di dati R](https://adv-r.had.co.nz/Data-structures.html).
