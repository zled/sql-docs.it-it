...
# [<server> SQL Server Agent (Gestione configurazione SQL Server)](sql-server-agent-server-sql-server-configuration-manager.md)
# [<server> Report Server (Gestione configurazione SQL Server)](report-server-server-sql-server-configuration-manager.md)
...
# [Proprietà SQL Server (sempre nella scheda disponibilità elevata)](sql-server-properties-always-on-high-availability-tab.md)
...
# [Protocolli client - Proprietà TCP IP (scheda Protocolli)](client-protocols-tcp-ip-properties-protocol-tab.md)
...
# [<server> SQL Server (Gestione configurazione SQL Server)](sql-server-server-sql-server-configuration-manager.md)
# [NS$<nome servizio> Proprietà (scheda Avanazate)](ns-service-name-properties-advanced-tab.md)
...
# [Creazione di una stringa di connessione valida mediante il protocollo di memoria condivisa](creating-a-valid-connection-string-using-shared-memory-protocol.md)
# [Proprietà NS$<nome servizio> (scheda Accesso)](ns-service-name-properties-log-on-tab.md)
...
# [Proprietà NS$<nome servizio> (scheda Servizio)](ns-service-name-properties-service-tab.md)
