...
ms.topic: "article"
helpviewer_keywords: 
  - "stringhe di connessione [Motore di database]"
  - "porte [SQL Server], connessione"
  - "TCP/IP [SQL Server], stringhe di connessione"
  - "stringhe di connessione [Motore di database], TCP/IP"
