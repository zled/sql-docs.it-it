...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Contiene le opzioni di ottimizzazione per una specifica sessione di ottimizzazione.  
