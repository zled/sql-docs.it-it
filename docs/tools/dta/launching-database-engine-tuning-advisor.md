...
![Finestra predefinita di Ottimizzazione guidata motore di database](../../tools/dta/media/defaultdtagui.gif "Finestra predefinita di Ottimizzazione guidata motore di database")  
...
[Impostazione del layout e delle opzioni dello strumento](../../tools/dta/setting-tool-options-and-layout.md)  
