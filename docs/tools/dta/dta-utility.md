...
ms.topic: "article"
helpviewer_keywords: 
  - "strutture di progettazione fisica [SQL Server]"
  - "utilità del prompt dei comandi [SQL Server]"
  - "dta - utilità"
  - "ottimizzazione database [SQL Server], Ottimizzazione guidata motore di database"
  - "carichi di lavoro [SQL Server], analisi"
  - "utilità dta, informazioni sull'utilità dta"
  - "prestazioni [SQL Server], Ottimizzazione guidata motore di database"
  - "Ottimizzazione guidata motore di database [SQL Server], prompt dei comandi"
