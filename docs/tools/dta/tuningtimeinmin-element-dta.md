...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Specifica la lunghezza massima di una sessione di ottimizzazione espressa in minuti.  
