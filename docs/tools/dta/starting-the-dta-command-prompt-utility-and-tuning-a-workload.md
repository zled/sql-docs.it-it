...
Le attività seguenti consentono di aprire un prompt dei comandi, avviare l'utilità della riga di comando **dta**, visualizzare la Guida relativa alla sintassi e ottimizzare un carico di lavoro semplice, ovvero MyScript.sql, creato in [Ottimizzazione di un carico di lavoro](../../tools/dta/tuning-a-workload.md).  
  
### Per avviare l'utilità del prompt dei comandi dta e visualizzare la Guida  
...
### Per ottimizzare un carico di lavoro semplice utilizzando l'utilità del prompt dei comandi dta  
