...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Indica il server di prova da utilizzare durante l'ottimizzazione di un server di produzione.  
