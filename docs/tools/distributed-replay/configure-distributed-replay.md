...
|Impostazione|Elemento XML|Description|Valori consentiti|Required|  
|-------------|-----------------|-----------------|--------------------|--------------|  
