...
**-h** ***"load hints***[ ,... *n*]**"**<a name="h"></a> Specifica gli hint da usare per l'importazione bulk di dati in una tabella o in una vista.  
