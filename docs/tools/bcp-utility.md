...
helpviewer_keywords: 
  ...
  - "esportazione di righe [SQL Server]"
  - "copia di dati [SQL Server], utilità bcp"
  - "utilità del prompt dei comandi [SQL Server], bcp"
  - "tabelle [SQL Server], importazione di dati"
  - "importazione di colonne [SQL Server]"
  - "utilità bcp [SQL Server], opzioni di comando"
  - "esportazione di file [SQL Server]"
  - "copia bulk [SQL Server]"
  - "utilità bcp [SQL Server], informazioni sull'utilità bcp"
  - "tabelle [SQL Server], esportazione di dati"
  - "importazione di righe [SQL Server]"
  - "importazione di dati, utilità bcp"
  - "importazione di file [SQL Server]"
  - "esportazione di colonne [SQL Server]"
...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../includes/tsql-appliesto-ss2008-all-md.md)]
 ...
 ![Icona di collegamento a un argomento](../database-engine/configure-windows/media/topic-link.png "Icona di collegamento a un argomento") Per informazioni sulle convenzioni adottate per la sintassi di**bcp**, vedere [Convenzioni della sintassi Transact-SQL (Transact-SQL)&#40;Transact-SQL &#41;](../t-sql/language-elements/transact-sql-syntax-conventions-transact-sql.md).  
...
**-h*****"carica hint***[ ,... *n*]**"**<a name="h"></a> Specifica gli hint da usare per l'importazione bulk di dati in una tabella o in una vista.  
...
L'utilità bcp può anche essere scaricata separatamente dal [Microsoft SQL Server 2016 Feature Pack](https://www.microsoft.com/download/details.aspx?id=526760).  Selezionare `ENU\x64\MsSqlCmdLnUtils.msi` o `ENU\x86\MsSqlCmdLnUtils.msi`.
