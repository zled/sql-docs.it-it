...
ms.topic: "article"
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], autorizzazioni"
  - "tracce [SQL Server], riproduzione"
  - "riproduzione di tracce"
  - "SQL Server Profiler, autorizzazioni"
  - "sicurezza [SQL Server], SQL Server Profiler"
...
6.  Viene verificata l'esistenza di un utente Guest nel database di destinazione e, in base ai risultati, si può verificare una delle situazioni seguenti:  
 ...
 ![Autorizzazioni per la riproduzione di tracce di SQL Server Profiler](../../tools/sql-server-profiler/media/replaytracedecisiontree.gif "Autorizzazioni per la riproduzione di tracce di SQL Server Profiler")  
