...
ms.topic: "article"
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], visualizzazione di tracce"
  - "SQL Server Profiler, visualizzazione di tracce"
  - "tracce [SQL Server], visualizzazione"
  - "SQL Server Profiler, risoluzione dei problemi"
  - "risoluzione dei problemi [SQL Server], tracce"
  - "eventi [SQL Server], ricerca all'interno di una traccia"
  - "Profiler [SQL Server Profiler], risoluzione dei problemi"
