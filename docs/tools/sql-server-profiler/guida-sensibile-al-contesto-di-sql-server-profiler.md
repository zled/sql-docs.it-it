---
title: "Guida sensibile al contesto di SQL Server Profiler | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], Guida"
  - "SQL Server Profiler, Guida"
  - "Proprietà traccia - finestra di dialogo"
  - "Proprietà modello di traccia - finestra di dialogo"
  - "Proprietà file di traccia - finestra di dialogo"
  - "Limite contatori prestazioni - finestra di dialogo"
  - "Opzioni generali - finestra di dialogo"
  - "Seleziona tabella carico di lavoro - finestra di dialogo"
  - "Tabella di destinazione - finestra di dialogo"
 ...
 **Data e ora di arresto della traccia**  
 Consente di impostare la data e l'ora di interruzione della traccia e la relativa chiusura. Usare la scheda **Selezione eventi** della finestra di dialogo **Proprietà traccia** per visualizzare o specificare le colonne di dati e gli eventi inseriti nella traccia.  
  
 ## Proprietà traccia (scheda Selezione eventi)
...
#### Opzioni  
 ...
 Per specificare i filtri, fare clic sull'intestazione della colonna di dati e immettere i criteri di filtro. Le colonne di dati filtrate sono contrassegnate da un'icona di filtro a sinistra dell'etichetta della colonna nella finestra di dialogo **Modifica filtro** . Per altre informazioni, vedere [SQL Server Profiler - Modifica filtro](../Topic/SQL%20Server%20Profiler%20-%20Edit%20Filter.md).  
...
## Proprietà modello di traccia (scheda Generale)
...
## Modifica modello di traccia (scheda Generale)
 ...
 **Usa come modello predefinito per il tipo di server selezionato**  
 ...
 ## Proprietà modello di traccia (scheda Selezione eventi)
 ...
 **Organizza colonne**  
 ...
 ## Proprietà file di traccia (scheda Generale) 
 ...
 **Ultima modifica**  
 ...
 ## Proprietà file di traccia (scheda Selezione eventi)
 ...
 **Organizza colonne**  
 ...
 ## Proprietà tabella di traccia (scheda Selezione eventi)
 ...
 **Organizza colonne**  
 Dopo avere selezionato **Eventi** e le colonne di dati da inserire nella traccia, fare clic su **Organizza colonne** per forzare il riordinamento della colonna nella finestra dei risultati della traccia.  
  ...
  ## SQL Server Profiler - Limite contatori prestazioni
...
### Per selezionare i contatori e gli oggetti prestazioni da correlare con una traccia  
...
2.  Selezionare i contatori da correlare con il file di traccia di [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] .  
 ...
 ## SQL Server Profiler - Strumenti/Opzioni (pagina Opzioni generali)
...
> **NOTA:** l'abilitazione o disabilitazione di questa casella di controllo consente di modificare il formato di visualizzazione delle colonne relative all'ora, ad esempio **StartTime** ed **EndTime**. Tuttavia, non vengono modificati i parametri del valore **DateTime** negli eventi del linguaggio o nelle RPC (Remote Procedure Call).  
 ...
 **Intervallo di polling predefinito Health Monitor (sec)**  
 ...
 ## SQL Server Profiler - Tabella di origine/Ottimizzazione guidata motore di database - Seleziona tabella carico di lavoro
...
#### Opzioni  
 **SQL Server**  
 Specifica l'istanza di SQL Server a cui si è attualmente connessi. Questo campo viene popolato automaticamente e non è possibile aggiornarlo.  
 ...
 **Tabella**  
 ...
 ## SQL Server Profiler - Tabella di destinazione
 ...
 **Tabella**  
 ...
 ## SQL Server Profiler - Configurazione riproduzione (Opzioni di base di riproduzione)
 ...
 **Visualizza risultati di riproduzione**  
 ...
 ## SQL Server Profiler - Configurazione riproduzione (Opzioni avanzate di riproduzione)
 ...
 **Intervallo di attesa monitoraggio processi bloccati (sec)**  
 ...
 ## SQL Server Profiler - Finestra di dialogo Trova
 ...
 **Trova precedente**  
 ...
 ## SQL Server Profiler - Organizza colonne
 ...
 **Giù**  
 ...
 ## SQL Server Profiler - Modifica filtro
...
> **NOTA:** per le colonne di dati di tipo stringa, i criteri di filtro saranno visualizzati come un valore di stringa LIKE o NOT LIKE.  

## Seleziona nome modello
