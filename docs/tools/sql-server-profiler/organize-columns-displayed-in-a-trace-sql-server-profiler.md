...
ms.topic: "article"
helpviewer_keywords: 
  - "organizzazione delle colonne di traccia visualizzate [SQL Server]"
  - "modifica dell'ordine delle colonne di traccia visualizzate"
  - "tracce [SQL Server], colonne dati"
...
|Durata|StartTime|EventClass|ClientProcessID|  
|--------------|---------------|----------------|---------------------|  
...
|EventClass|StartTime|Durata|ClientProcessID|  
|----------------|---------------|--------------|---------------------|  
...
### Per raggruppare le colonne di dati visualizzate in una traccia  
...
### Per raggruppare e aggregare le colonne di dati di una traccia  
