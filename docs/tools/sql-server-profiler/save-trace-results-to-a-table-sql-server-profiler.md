...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Questo argomento descrive la procedura per salvare i risultati della traccia in una tabella di database tramite [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
