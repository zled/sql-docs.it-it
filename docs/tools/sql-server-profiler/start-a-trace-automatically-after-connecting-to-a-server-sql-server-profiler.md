---
title: Avviare una traccia automaticamente dopo la connessione a un Server (SQL Server Profiler) | Documenti Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]In questo argomento viene descritto come avviare tracce automaticamente dopo la connessione a un'istanza di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] utilizzando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
