...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Identifica l'utilità che ha generato il file XML di output di **ssbdiagnose**.  
