...
ms.topic: "article"
helpviewer_keywords: 
  - "Service Broker, report di runtime"
  - "Service Broker, utilità del prompt dei comandi"
  - "risoluzione dei problemi [Service Broker], conversazioni"
  - "risoluzione dei problemi [Service Broker], configurazioni"
  - "utilità della riga di comando [Service Broker]"
  - "Service Broker, risoluzione dei problemi"
  - "Servizio Broker, report di configurazione"
  - "Service Broker, strumenti"
  - "risoluzione dei problemi [Service Broker], runtime"
  - "conversazioni [Service Broker], risoluzione dei problemi"
  - "risoluzione dei problemi [Service Broker], utilità ssbdiagnose"
  - "strumenti [Service Broker], ssbdiagnose"
  - "Service Broker, utilità ssbdiagnose"
  - "ssbdiagnose"
