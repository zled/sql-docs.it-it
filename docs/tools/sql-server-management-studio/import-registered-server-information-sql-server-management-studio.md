...
helpviewer_keywords: 
  - "trasferimento di informazioni sui server registrati"
  - "server registrati [SQL Server], importazione"
  - "importazione di informazioni sui server registrati"
...
---
# Importazione di informazioni relative a server registrati (SQL Server Management Studio)
...
#### Per importare informazioni relative ai server registrati  
