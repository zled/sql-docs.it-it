---
title: "Creazione di un server di gestione centrale e di un gruppo di server (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
5.  Nella scheda **Proprietà connessione** rivedere o modificare le proprietà di connessione e della rete. Per altre informazioni, vedere [Connettersi al server &#40;pagina Proprietà connessione&#41; Motore di database](../../ssms/f1-help/connect-to-server-connection-properties-page-database-engine.md)  
...
#### Creare un gruppo di server e aggiungere server al gruppo  
...
#### Per eseguire query su più destinazioni di configurazione contemporaneamente  
