...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], apertura"
  - "utilità del prompt dei comandi [SQL Server], sqlwb"
  - "utilità sqlwb"
  - "Management Studio - riga di comando"
