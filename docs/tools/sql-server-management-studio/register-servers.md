...
helpviewer_keywords: 
  - "connessioni [SQL Server], server registrati"
  - "registrazione di server"
  - "server [SQL Server], registrazione"
  - "gestione server [SQL Server], registrazione di server"
  - "registrazione di server [SQL Server]"
