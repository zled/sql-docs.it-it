---
title: "Registrazione di un server connesso (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "07/28/2016"
...
helpviewer_keywords: 
  - "server registrati [SQL Server], registrazione di server connessi"
  - "registrazioni di server connessi [SQL Server]"
...
#### Per registrare un server connesso  
