...
helpviewer_keywords: 
  - "Server registrati [SQL Server], esportazione"
  - "esportazione di informazioni sui server registrati"
...
---
# Esportare informazioni relative a server registrati (SQL Server Management Studio)
...
#### Per esportare informazioni relative a server registrati  
