...
ms.topic: "article"
helpviewer_keywords: 
  - "utilità del prompt dei comandi [SQL Server], sqlservr"
  - "prompt dei comandi [SQL Server], sospensione/ripresa di un'istanza di SQL Server"
  - "avvio di un'istanza di SQL Server"
  - "prompt dei comandi [SQL Server], continuazione di un'istanza di SQL Server"
  - "sqlservr -utilità"
  - "sospensione di un'istanza di SQL Server"
  - "arresto di un'istanza di SQL Server"
  - "ripresa dell'esecuzione di SQL Server"
  - "prompt dei comandi [SQL Server], arresto di un'istanza di SQL Server"
  - "prompt dei comandi [SQL Server], avvio di un'istanza di SQL Server"
  - "riavvio di un'istanza di SQL Server"
...
## Informazioni sulla compatibilità  
 Il parametro **-h** non è supportato in [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]. Questo parametro è stato utilizzato in versioni precedenti di istanze a 32 bit di [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] per riservare spazio di indirizzi della memoria virtuale per metadati della memoria a caldo quando AWE è abilitato. Per altre informazioni, vedere [Funzionalità di SQL Server sospese in SQL Server 2016](../Topic/Discontinued%20SQL%20Server%20Features%20in%20SQL%20Server%202016.md).  
