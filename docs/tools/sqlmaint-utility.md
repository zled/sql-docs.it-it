...
ms.topic: "article"
helpviewer_keywords: 
  - "piani di manutenzione di un database [SQL Server]"
  - "utilità sqlmaint"
  - "manutenzione di database [SQL Server]"
  - "backup [SQL Server], utilità sqlmaint"
  - "utilità del prompt dei comandi [SQL Server], sqlmaint"
  - "piani di manutenzione [SQL Server], prompt dei comandi"
  - "esecuzione di backup [SQL Server], utilità sqlmaint"
