...
helpviewer_keywords: 
  - "oggetti [SQL Server]"
  - "specifiche di capacità numerica [SQL Server]"
  - "dimensioni [SQL Server], specifiche di capacità"
  - "numero di oggetti"
  - "specifiche di capacità [SQL Server]"
  - "specifiche di capacità massima [SQL Server]"
  - "dimensioni [SQL Server]"
  - "specifiche di capacità di replica [SQL Server]"
  - "oggetti [SQL Server], specifiche di capacità"
  - "Motore di database [SQL Server], specifiche di capacità"
...
|Colonne per ogni chiave esterna||16||  
|Colonne per ogni chiave primaria||16||  
...
|Riferimenti alla tabella della chiave esterna per ogni tabella||In uscita = 253. In ingresso = 10.000.|Per informazioni sulle restrizioni, vedere [Create Foreign Key Relationships](../relational-databases/tables/creare-relazioni-di-chiave-esterna.md).|  
