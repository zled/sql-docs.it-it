---
title: "Novità di SQL Server 2016 | Microsoft Docs"
ms.custom:
- SQL2016_New_Updated
ms.date: 12/15/2016
...
---
# <a name="what39s-new-in-sql-server-2016"></a>Novità di SQL Server 2016
 [!INCLUDE[ssSQL15_md](../includes/sssql15-md.md)] è la principale innovazione nella storia delle piattaforme di dati Microsoft. Ottenere informazioni in tempo reale dai dati transazionali e analitici con una piattaforma di database scalabile che integra tutto ciò che serve, dalle eccezionali prestazioni in memoria, le innovazioni per la sicurezza e la disponibilità elevata all'analisi avanzata che rende intelligenti le applicazioni di importanza cruciale.
 
 Questo argomento riepiloga i collegamenti alle informazioni dettagliate sulle novità per i componenti di [!INCLUDE[ssCurrent_md](../includes/sscurrent-md.md)] .   
 
  ![SQL Server 2016](../sql-server/media/sql-server-2016.png) 
 
[Leggere il foglio dati relativo alle edizioni di SQL Server 2016](http://download.microsoft.com/download/8/A/2/8A2BC8C5-BBA0-4A9C-90BC-AC957D3454D9/SQL_Server_2016_Editions_datasheet.pdf)
...
[![Macchina virtuale di Azure piccola](../analysis-services/media/azure-virtual-machine-small.png)](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1standardwindowsserver2016/) Se si ha un account di Azure,  fare clic **[qui](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1standardwindowsserver2016/)** per creare rapidamente una macchina virtuale in cui è già installato SQL Server 2016 SP1.  
 ...
 ## <a name="whats-new-in-sql-server"></a>Novità di SQL Server
Collegamenti a singoli argomenti:
 
 - [Installazione di SQL Server](../database-engine/install-windows/installation-for-sql-server-2016.md)   
  
 - [Motore Analysis Services (SSAS)](../analysis-services/what-s-new-in-analysis-services.md)  
  
 - [Motore di database](../database-engine/configure-windows/what-s-new-in-sql-server-2016-database-engine.md)
