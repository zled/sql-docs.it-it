...
ms.topic: "article"
helpviewer_keywords: 
  - "porte [SQL Server], computer multihomed"
  - "computer multihomed [SQL Server] configurazione di porte"
  - "sistemi firewall [Motore di database], computer multihomed"
...
#### Per determinare le porte e gli indirizzi IP usati da [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
2.  In **Gestione configurazione [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]** nel riquadro della console espandere **Configurazione di rete di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**, quindi **Protocolli per <nome istanza>\>** e infine fare doppio clic su **TCP/IP**.  
