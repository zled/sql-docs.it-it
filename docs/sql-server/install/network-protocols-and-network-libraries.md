...
ms.topic: "article"
helpviewer_keywords: 
  - "protocolli [SQL Server]"
  - "opzioni di configurazione [SQL Server], protocolli"
  - "librerie di rete [SQL Server]"
  - "protocolli [SQL Server], informazioni sui protocolli di rete"
  - "pipe [SQL Server]"
  - "protocolli di rete [SQL Server]"
  - "configurazioni predefinite di SQL Server"
  - "libreria [SQL Server]"
  - "protocolli di rete [SQL Server], informazioni sui protocolli di rete"
  - "opzioni di configurazione [SQL Server], librerie"
...
-   [!INCLUDE[tsql](../../includes/tsql-md.md)] TCP predefinito  
 ...
 Per ulteriori informazioni sulle configurazioni di rete di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], vedere gli argomenti seguenti nella documentazione online di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]:  
