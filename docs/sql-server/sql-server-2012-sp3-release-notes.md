...
In queste note sulla versione sono illustrate informazioni da conoscere prima di installare o risolvere i problemi di SQL Server 2012 Service Pack 3. Le note sulla versione sono disponibili solo online, non nel supporto di installazione. Sono aggiornate periodicamente, in caso di rilevamento di nuovi problemi. Per un elenco di miglioramenti e correzioni, vedere [Informazioni sulla versione di Service Pack 3 di SQL Server 2012](http://support.microsoft.com/help/3072779/sql-server-2012-service-pack-3-release-information) per altre informazioni.  
