...
ms.topic: "article"
helpviewer_keywords: 
  - "correzione automatica della pagina"
  - "Gruppi di disponibilità [SQL Server], correzione automatica della pagina"
  - "mirroring del database [SQL Server], correzione automatica della pagina"
...
|------------------|-----------------|---------------------------------------------------------|  
|[823](../Topic/MSSQLSERVER_823.md)|Viene eseguita un'azione solo se il sistema operativo ha eseguito un controllo di ridondanza ciclico (CRC, Cyclic Redundancy Check) che ha generato un errore sui dati.|ERROR_CRC. Il valore del sistema operativo per questo errore è 23.|  
|[824](../Topic/MSSQLSERVER_824.md)|Errori logici.|Errori logici dei dati, come ad esempio un errore di checksum relativo a una pagina danneggiata o di scrittura incompleta.|  
...
##  <a name="UnrepairablePageTypes"></a> Tipi di pagine che non possono essere corrette automaticamente  
...
##  <a name="DevBP"></a> Procedura consigliata dagli sviluppatori  
