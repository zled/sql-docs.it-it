...
ms.topic: "article"
helpviewer_keywords: 
  - "account utente [SQL Server], clustering di failover"
  - "cluster [SQL Server], gestione"
  - "nodi [clustering di failover]"
  - "clustering di failover [SQL Server], gestione"
  - "aggiunta di nodi"
  - "server virtuali [SQL Server], rimozione di nodi"
  ...
  - "rimozione di nodi"
  - "server virtuali [SQL Server], aggiunta di nodi"
...
## Gestione un'istanza del cluster di failover  
...
### Aggiunta di un nodo a un'istanza del cluster di failover esistente  
...
### Rimozione di un nodo da un'istanza del cluster di failover esistente  
...
### Modifica degli account del servizio  
...
## Amministrazione di un'istanza del cluster di failover  
