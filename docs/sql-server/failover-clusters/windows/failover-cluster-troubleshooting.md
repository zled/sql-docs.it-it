---
title: "Risoluzione dei problemi relativi al clustering di failover | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "10/21/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "risoluzione dei problemi, clustering di failover"
  - "clustering di failover, risoluzione dei problemi"
  - "risoluzione dei problemi relativi al clustering"
...
#### Procedura di riconvalida del cluster  
...
### Problema: errore di installazione del cluster: "Impossibile continuare l'installazione. Windows Installer non dispone di privilegi sufficienti per l'accesso alla directory \<unità>\Microsoft SQL Server. Accedere come amministratore oppure contattare l'amministratore del sistema"  
