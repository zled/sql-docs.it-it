...
ms.topic: "article"
helpviewer_keywords: 
  - "cluster [SQL Server], rimozione dell'istanza cluster di failover"
  - "cluster di failover [SQL Server], rimozione dell'istanza cluster di failover"
  - "disinstallazione di istanze cluster di failover"
  - "rimozione di istanze cluster di failover"
...
---
# Rimuovere un&#39;istanza del cluster di failover di SQL Server (programma di installazione)
...
### Per disinstallare un cluster di failover di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
