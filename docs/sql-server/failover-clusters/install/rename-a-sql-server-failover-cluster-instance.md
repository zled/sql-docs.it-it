---
title: "Ridenominare un&#39;istanza del cluster di failover di SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "cluster [SQL Server], server virtuali"
  - "ridenominazione di server virtuali"
  - "server virtuali [SQL Server], clustering di failover"
  - "clustering di failover [SQL Server], server virtuali"
...
---
# Ridenominare un&#39;istanza del cluster di failover di SQL Server
...
### Per rinominare un server virtuale  
...
#### Per ridurre al minimo il ritardo nella propagazione  
...
## Ulteriori considerazioni dopo la ridenominazione dell'operazione  
