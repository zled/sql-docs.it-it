...
| Java     | [JDBC](http://go.microsoft.com/fwlink/?LinkId=245496)<br />[Scaricare 6.2](http://www.microsoft.com/download/details.aspx?id=55539) |
...
| PHP      | *Sistema operativo:*<br /><br />[Windows PHP driver](http://www.microsoft.com/download/details.aspx?id=20098)<br />[Ubuntu o MacOS PHP driver, da Github](http://github.com/Microsoft/msphpsql/tree/dev#install-unix) |
