...
# [Microsoft Drivers per PHP per SQL Server](microsoft-php-driver-for-sql-server.md)
...
## [Passaggio 3: Modello di verifica per la connessione a SQL Server tramite PHP](step-3-proof-of-concept-connecting-to-sql-using-php.md)
...
## [Matrice di supporto dei driver Microsoft per PHP per SQL Server](microsoft-php-drivers-for-sql-server-support-matrix.md)
...
### [Supporto per LocalDB](php-driver-for-sql-server-support-for-localdb.md)
### [Supporto per il ripristino di emergenza a disponibilità elevata](php-driver-for-sql-server-support-for-high-availability-disaster-recovery.md)
