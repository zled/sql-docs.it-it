---
title: Guida di programmazione per i driver Microsoft per PHP per SQL Server | Documenti Microsoft
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
|[Uso di Always Encrypted con driver Microsoft per PHP per SQL Server](../../connect/php/using-always-encrypted-php-drivers.md)|Vengono fornite informazioni sull'utilizzo di funzionalità crittografia sempre attiva con i driver PHP.|  
