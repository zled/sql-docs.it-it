...
- Red Hat: Glibc da e2fsprogs, krb5 librerie, openssl, unixODBC
- SuSE: Glibc da libuuid1, krb5, openssl, unixODBC
...
#### <a name="redhat-linux-enterprise-server-7"></a>Redhat Linux Enterprise Server 7
  - Scaricare il più recente rpm ha qui: http://packages.microsoft.com/rhel/7/prod/
...
#### <a name="ubuntu-1604"></a>Ubuntu 16.04
- Scaricare il DEB ha più recenti da qui: http://packages.microsoft.com/ubuntu/16.04/prod/pool/main/m/msodbcsql/ 
- Installare il driver e dipendenze 
...
#### <a name="suse-linux-enterprise-server-12"></a>SUSE Linux Enterprise Server 12
- Scaricare il più recente rpm ha qui: http://packages.microsoft.com/sles/12/prod/
...
7.  Quando si è pronti a installare il driver ODBC in Linux, eseguire il comando seguente: **./install.sh install**. Se è necessario specificare un comando di installazione (**bin-dir** o **lib-dir**), specificare il comando dopo l'opzione **install** .  
