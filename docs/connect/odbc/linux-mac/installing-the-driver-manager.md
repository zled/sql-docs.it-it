...
3.  Passare alla directory `msodbcsql-11.0.2270.0` contenente un file denominato `build_dm.sh`install.sh. È possibile eseguire `build_dm.sh` per installare Gestione Driver unixODBC.
