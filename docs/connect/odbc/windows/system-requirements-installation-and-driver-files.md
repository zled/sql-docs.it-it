...
[!NOTE]
Per coloro che dispongono di Driver 17.1.0.1 installato, è consigliabile che disinstallato manualmente prima di installare Driver 17.2.0.1 o versione successiva
...
|msodbcsql.h|File di intestazione che contiene tutte le nuove definizioni necessarie per usare il driver.<br /><br /> **Nota:**  non è possibile fare riferimento a msodbcsql.h e odbcss.h nello stesso programma.<br /><br /> msodbcsql.h per ODBC Driver 17 viene installato in %PROGRAMFILES%\Microsoft SQL Server\Client SDK\ODBC\13\SDK. <br /> msodbcsql.h per ODBC Driver 11 viene installato in %PROGRAMFILES%\Microsoft SQL Server\Client SDK\ODBC\110\SDK.| 
