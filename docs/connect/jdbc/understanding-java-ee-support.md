...
## <a name="driver-name"></a>Nome del driver  
 Il nome della classe del driver è **com.microsoft.sqlserver.jdbc.SQLServerDriver**. Per JDBC Driver 4.1, 4.2 e 6.0, il driver è incluso nel file sqljdbc.jar, sqljdbc4.jar, sqljdbc41.jar o sqljdbc42.jar. Per JDBC Driver 6.2, il driver è incluso in mssql-jdbc-6.2.1.jre7.jar o mssql-jdbc-6.2.1.jre8.jar. Per JDBC Driver 6.4, il driver è incluso in mssql-jdbc-6.4.0.jre7.jar, mssql-jdbc-6.4.0.jre8.jar o mssql-jdbc-6.4.0.jre9.jar.
