...
|[L'accesso a informazioni di diagnostica nel Log degli eventi estesi](../../connect/jdbc/accessing-diagnostic-information-in-the-extended-events-log.md)|Viene descritto come utilizzare il contenuto dei log degli eventi estesi del server per ottenere informazioni sugli errori di connessione.|  
