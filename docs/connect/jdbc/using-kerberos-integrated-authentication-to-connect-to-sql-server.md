...
> [!NOTE]  
> Prima di rilasciare 6.2.0 del driver JDBC per, per l'utilizzo corretto della Cross dell'area di autenticazione Kerberos, è necessario impostare in modo esplicito il **serverSpn**.
>
> Al momento della stesura di 6.2.0 versione, il driver sarà in grado di compilare le **serverSpn** per impostazione predefinita, anche quando si Usa Cross dell'area di autenticazione Kerberos. Anche se è possibile usare **serverSpn** esplicitamente troppo. 
