...
|[Utilizzo del Driver JDBC](../../connect/jdbc/using-the-jdbc-driver.md)|Viene descritto come configurare l'ambiente per utilizzare il driver Microsoft JDBC e come creare una semplice connessione a un [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] database.|  
|[Informazioni sul supporto di Java EE](../../connect/jdbc/understanding-java-ee-support.md)|Descrive come usare Microsoft JDBC Driver in un ambiente Java Platform, Enterprise Edition (Java EE).|  
...
|[Ricerca di informazioni sul Driver JDBC aggiuntive](../../connect/jdbc/finding-additional-jdbc-driver-information.md)|Descrive dove trovare risorse aggiuntive su Microsoft JDBC Driver, inclusi i collegamenti a risorse esterne.|  
|[Microsoft JDBC Driver per una matrice di supporto SQL Server](../../connect/jdbc/microsoft-jdbc-driver-for-sql-server-support-matrix.md)|Criteri relativi al ciclo di vita e alla matrice del supporto di Microsoft JDBC Driver per SQL Server.|  
