---
title: Costruttore di SQLServerXADataSource () | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Inizializza una nuova istanza di [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) classe.  
