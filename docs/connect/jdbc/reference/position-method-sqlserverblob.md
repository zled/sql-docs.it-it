...
|Nome|Description|  
|----------|-----------------|  
|[posizione (Java.SQL. BLOB, long)](../../../connect/jdbc/reference/position-method-java-sql-blob-long.md)|Restituisce la posizione di un modello specificato nell'oggetto BLOB in base al modello specificato e all'indice iniziale.|  
