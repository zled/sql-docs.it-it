---
title: Metodo isNamed (SQLServerSavepoint) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32839966"
---
# <a name="isnamed-method-sqlserversavepoint"></a>Metodo isNamed (SQLServerSavepoint)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Verifica se il punto di salvataggio è stato denominato.  
 ...
 **true** il punto di salvataggio viene denominato. In caso contrario, **false**.  
