...
## <a name="remarks"></a>Osservazioni  
 ...
 Se sono presenti più colonne con lo stesso nome, il metodo findColumn restituisce la prima corrispondenza tra maiuscole e minuscole. Se non esiste alcuna corrispondenza con distinzione tra maiuscole e minuscole, questo metodo restituisce la prima corrispondenza senza tale distinzione.  
