---
title: Campo TYPE_SS_SCROLL_DYNAMIC (SQLServerResultSet) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32848226"
---
# <a name="typessscrolldynamic-field-sqlserverresultset"></a>Campo TYPE_SS_SCROLL_DYNAMIC (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Utilizzato per specificare un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)] tipo di cursore dinamico.  
