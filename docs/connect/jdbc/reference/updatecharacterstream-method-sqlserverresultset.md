...
|Nome|Description|  
|----------|-----------------|  
|[updateCharacterStream metodo &#40; int, Java.IO. Reader &#41;](../../../connect/jdbc/reference/updatecharacterstream-method-int-java-io-reader.md)|Aggiorna la colonna designata con un valore del flusso di caratteri.|  
...
|[updateCharacterStream metodo &#40; int, Java.IO. Reader, long &#41;](../../../connect/jdbc/reference/updatecharacterstream-method-int-java-io-reader-long.md)|Aggiorna la colonna designata con un valore del flusso di caratteri, che conterrà il numero specificato di caratteri.|  
