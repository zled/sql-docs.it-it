---
title: Metodo getDatabaseMinorVersion (SQLServerDatabaseMetaData) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valore restituito  
 Un **int** che indica la versione secondaria del database.  
  
## <a name="exceptions"></a>Eccezioni  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Osservazioni  
 Questo metodo getDatabaseMinorVersion viene specificato dal metodo getDatabaseMinorVersion nell'interfaccia DatabaseMetaData.  
