---
title: Metodo getByte (int) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32830206"
---
# <a name="getbyte-method-int"></a>Metodo getByte (int)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Recupera il valore del parametro designato come un **byte** valore in base all'indice del parametro.  
