---
title: Metodo getBigDecimal (SQLServerCallableStatement) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|[getBigDecimal (lang)](../../../connect/jdbc/reference/getbigdecimal-method-java-lang-string.md)|Recupera il valore del parametro designato come oggetto java.math.BigDecimal con la massima precisione in base al nome del parametro.|  
|[getBigDecimal (lang. String, int)](../../../connect/jdbc/reference/getbigdecimal-method-java-lang-string-int.md)|(Deprecato) Recupera il valore del parametro designato come oggetto java.math.BigDecimal in base al nome del parametro e alla scala.|  
