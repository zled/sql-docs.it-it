---
title: Metodo getMaxSchemaNameLength (SQLServerDatabaseMetaData) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Osservazioni  
 Questo metodo getMaxSchemaNameLength viene specificato dal metodo getMaxSchemaNameLength nell'interfaccia DatabaseMetaData.  
