---
title: Metodo (SQLServerPreparedStatement) setLong | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
---
# <a name="setlong-method-sqlserverpreparedstatement"></a>setLong, metodo (SQLServerPreparedStatement)
