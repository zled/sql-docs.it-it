---
title: Metodo (SQLServerPreparedStatement) setByte | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
---
# <a name="setbyte-method-sqlserverpreparedstatement"></a>setByte (metodo) (SQLServerPreparedStatement)
