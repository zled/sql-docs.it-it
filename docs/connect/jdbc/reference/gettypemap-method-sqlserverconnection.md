---
title: Metodo getTypeMap (SQLServerConnection) | Documenti Microsoft
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Recupera l'oggetto mappa associato a questo [SQLServerConnection](../../../connect/jdbc/reference/sqlserverconnection-class.md) oggetto.  
