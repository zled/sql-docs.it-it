---
title: Metodo (SQLServerPreparedStatement) setNull | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32844406"
---
# <a name="setnull-method-sqlserverpreparedstatement"></a>setNull (metodo) (SQLServerPreparedStatement)
...
|[setNull (int, int, lang)](../../../connect/jdbc/reference/setnull-method-int-int-java-lang-string.md)|Imposta il parametro designato su un valore Null, in base al tipo e al nome del parametro da impostare.|  
