---
title: Metodo (SQLServerDataSource) setTrustManagerClass | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2018
ms.prod: sql
...
---
# <a name="settrustmanagerclass-method-sqlserverdatasource"></a>setTrustManagerClass metodo (SQLServerDataSource)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Imposta il valore di stringa della proprietà di connessione TrustManagerClass.
