---
title: Metodo updateDouble (int, double) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32849576"
---
# <a name="updatedouble-method-int-double"></a>Metodo updateDouble (int, double)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Aggiorna la colonna designata con un **doppie** valore in base all'indice di colonna.  
