---
title: I membri di SQLServerSavepoint | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32848796"
---
# <a name="sqlserversavepoint-members"></a>Membri di SQLServerSavepoint
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Le tabelle seguenti elencano i membri esposti dal [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md) classe.  
  
## <a name="constructors"></a>Costruttori  
  
|Nome|Description|  
|----------|-----------------|  
|[SQLServerSavepoint (SQLServerConnection, java.lang.StringName)](../../../connect/jdbc/reference/sqlserversavepoint-constructor-sqlserverconnection-java-lang-stringname.md)|Inizializza una nuova istanza di [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md) classe in base alla connessione specificata e il nome.|  
