---
title: Metodo getJDBCMinorVersion (SQLServerDatabaseMetaData) | Documenti Microsoft
ms.custom: 
ms.date: 01/19/2017
...
## <a name="return-value"></a>Valore restituito  
 Un **int** che indica la versione secondaria di JDBC.  
  
## <a name="exceptions"></a>Eccezioni  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Osservazioni  
 Questo metodo getJDBCMinorVersion viene specificato dal metodo getJDBCMinorVersion nell'interfaccia DatabaseMetaData.  
