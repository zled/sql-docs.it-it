---
title: Costruttore di SQLServerResource () | Documenti Microsoft
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Inizializza una nuova istanza di [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) classe. Questo costruttore è destinato al solo uso interno.  
