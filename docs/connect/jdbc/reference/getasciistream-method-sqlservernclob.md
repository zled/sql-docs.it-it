---
title: Metodo getAsciiStream (SQLServerNClob) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32831956"
---
# <a name="getasciistream-method-sqlservernclob"></a>Metodo getAsciiStream (SQLServerNClob)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Recupera il **NCLOB** valore designato dall'oggetto **NClob** oggetto come flusso ASCII.  
...
## <a name="return-value"></a>Valore restituito  
 Un oggetto InputStream che contiene i dati NCLOB.  
