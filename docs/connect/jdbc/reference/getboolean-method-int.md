---
title: Metodo getBoolean (int) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32830626"
---
# <a name="getboolean-method-int"></a>Metodo getBoolean (int)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Recupera il valore del parametro designato come un **booleano** valore in base all'indice del parametro.  
