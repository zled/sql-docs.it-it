---
title: Metodo getReference (SQLServerXADataSource) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32837936"
---
# <a name="getreference-method-sqlserverxadatasource"></a>Metodo getReference (SQLServerXADataSource)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Restituisce un riferimento a questo [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md) oggetto.  
