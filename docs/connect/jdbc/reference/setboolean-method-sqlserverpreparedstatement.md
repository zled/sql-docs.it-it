---
title: Metodo (SQLServerPreparedStatement) setBoolean | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32843806"
---
# <a name="setboolean-method-sqlserverpreparedstatement"></a>setBoolean (metodo) (SQLServerPreparedStatement)
