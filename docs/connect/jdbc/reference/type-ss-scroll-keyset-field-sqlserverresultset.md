---
title: Campo TYPE_SS_SCROLL_KEYSET (SQLServerResultSet) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32847456"
---
# <a name="typessscrollkeyset-field-sqlserverresultset"></a>Campo TYPE_SS_SCROLL_KEYSET (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Utilizzato per specificare un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)] il tipo di cursore keyset.  
