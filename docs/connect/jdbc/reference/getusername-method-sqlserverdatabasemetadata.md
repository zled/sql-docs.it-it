---
title: Metodo getUserName (SQLServerDatabaseMetaData) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Osservazioni  
 Questo metodo getUserName viene specificato dal metodo getUserName nell'interfaccia DatabaseMetaData.  
