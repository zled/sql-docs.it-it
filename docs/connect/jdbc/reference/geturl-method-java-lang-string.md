---
title: getURL (metodo) (lang) | Documenti Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Recupera il valore del parametro designato come oggetto nel linguaggio di programmazione Java specificato il nome del parametro URL.  
