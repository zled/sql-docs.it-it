...
## <a name="example"></a>Esempio  
 ...
 Infine, l'esempio aggiorna i dati nel set di risultati e quindi chiama il metodo personalizzato displayRow nuovamente per visualizzarlo.  
