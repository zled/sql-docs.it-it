...
## <a name="requirements"></a>Requisiti  
 ...
 Per eseguire questa applicazione di esempio è anche necessario accedere al database di esempio di [!INCLUDE[ssSampleDBnormal](../../../includes/sssampledbnormal_md.md)].  
