---
title: Driver OLE DB per SQL Server (OLE DB) | Documenti Microsoft
description: Driver OLE DB per SQL Server (OLE DB)
ms.custom: ''
ms.date: 03/26/2018
...
---
# <a name="ole-db-driver-for-sql-server-ole-db"></a>Driver OLE DB per SQL Server (OLE DB)
