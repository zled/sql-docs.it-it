 ...
 **Nota** il [ibcpsession:: Bcpwritefmt](../../oledb/ole-db-interfaces/ibcpsession-bcpwritefmt-ole-db.md) funzione può essere utilizzata per rendere persistente la specifica di formato fornita tramite **BCPColFmt**.  
