...
## <a name="remarks"></a>Remarks  
 Il **BCPExec** metodo copia i dati da un file utente in una tabella di database o viceversa, a seconda del valore del *eDirection* parametro utilizzato con il [ibcpsession:: BCPInit](../../oledb/ole-db-interfaces/ibcpsession-bcpinit-ole-db.md)metodo.  
