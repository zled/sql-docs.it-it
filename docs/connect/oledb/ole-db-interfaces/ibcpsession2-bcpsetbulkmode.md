...
description: Utilizzo IBCPSession2::BCPSetBulkMode per creare la copia bulk all'esterno di una query o una tabella
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
