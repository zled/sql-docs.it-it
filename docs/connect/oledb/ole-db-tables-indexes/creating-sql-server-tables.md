...
## <a name="dbcolumndesc-usage"></a>Utilizzo di DBCOLUMNDESC  
 Il consumer può indicare un tipo di dati della colonna, utilizzando il *pwszTypeName* membro o *wType* membro. Se il consumer specifica il tipo di dati *pwszTypeName*, il Driver OLE DB per SQL Server ignora il valore di *wType*.  
