...
1. [Home page per client di programmazione per Microsoft SQL Server](homepage-sql-connection-programming.md)
2. [Connessione tramite l'autenticazione di Azure Active Directory](php/azure-active-directory.md)
3. [Resilienza delle connessioni inattive](php/connection-resiliency.md)
4. [Esercitazione di installazione di driver Mac e Linux PHP](php/installation-tutorial-linux-mac.md)
5. [Moduli di connessione per i database SQL di Microsoft](sql-connection-libraries.md)
