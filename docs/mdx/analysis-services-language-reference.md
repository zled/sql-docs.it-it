---
title: Riferimenti al linguaggio di Analysis Services | Documenti Microsoft
ms.custom: 
ms.date: 03/02/2016
...
## <a name="see-also"></a>Vedere anche  
 [Guida di riferimento di PowerShell per PowerPivot per SharePoint](../analysis-services/powershell/powershell-reference-for-power-pivot-for-sharepoint.md)   
