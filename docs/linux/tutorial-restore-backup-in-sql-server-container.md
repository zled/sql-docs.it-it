...
1. Innanzitutto, utilizzare **exec docker** per creare una cartella di backup. Il comando seguente crea un **/var/opt/mssql/backup** directory all'interno del contenitore di SQL Server.
