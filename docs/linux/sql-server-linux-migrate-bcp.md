...
In questo argomento viene illustrato come utilizzare il [bcp](/sql-docs/docs/tools/bcp-utility) utilità della riga di comando di copia bulk dei dati tra un'istanza di SQL Server 2017 RC2 in Linux e un file di dati in un formato specificato dall'utente.
...
- [utilità bcp](/sql-docs/docs/tools/bcp-utility)
- [Formati di dati per la compatibilità mediante bcp](/sql-docs/docs/relational-databases/import-export/specify-data-formats-for-compatibility-when-using-bcp-sql-server)
- [Importazione Bulk dei dati tramite BULK INSERT](/sql-docs/docs/relational-databases/import-export/import-bulk-data-by-using-bulk-insert-or-openrowset-bulk-sql-server)
