...
Dopo l'installazione, connettersi all'istanza di SQL Server nel computer Linux. È possibile connettersi in locale o in modalità remota e con un'ampia gamma di strumenti e driver. Le esercitazioni illustrano come usare lo strumento da riga di comando [sqlcmd](sql-server-linux-setup-tools.md). Altri strumenti includono:
