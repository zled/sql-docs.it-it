...
## <a id="upgrade"></a>Aggiornamento di SQL Server

Per aggiornare il **mssql server** pacchetto in Linux, utilizzare uno dei seguenti comandi basati sulla piattaforma:
