...
```  
 ...
 Il consumer può annullare il comando tramite l'utilizzo [issabort:: Abort](../native-client-ole-db-interfaces/issabort-abort-ole-db.md) oppure rilasciando tutti i riferimenti mantenuti sull'oggetto comando e il set di righe derivato.  
