...
|BCP_OPTION_FILECP|L'argomento *iValue* contiene il numero della tabella codici per il file di dati. È possibile specificare il numero della tabella codici, ad esempio 1252 o 850, o uno dei valori seguenti:<br /><br /> -BCP_FILECP_ACP: i dati nel file sono nella tabella codici Microsoft Windows® del client.<br />-BCP_FILECP_OEMCP: i dati nel file sono nella tabella codici OEM del client (impostazione predefinita).<br />-BCP_FILECP_RAW: i dati nel file sono nella tabella codici di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|  
