...
> [!NOTE]  
>  Per modificare i valori di formato dati specificati per un file di dati, utilizzare il [ibcpsession:: BCPColumns](ibcpsession-bcpcolumns-ole-db.md) e [ibcpsession:: BCPColFmt](ibcpsession-bcpcolfmt-ole-db.md) metodi.  
