---
title: Le informazioni sul server di pubblicazione, sottoscrizione osservi (pubblicazione di tipo Merge, SQL Server 2005 e versioni successive) | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
