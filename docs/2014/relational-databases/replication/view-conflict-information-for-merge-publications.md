---
title: Visualizzare le informazioni sui conflitti per le pubblicazioni di tipo Merge (programmazione Transact-SQL della replica) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
