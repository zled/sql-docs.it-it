...
1.  Per ogni colonna associata, eseguire le operazioni seguenti:  
    ...
    -   Chiamare [SQLBindCol](../../native-client-odbc-api/sqlbindcol.md) per associare la colonna valore dei dati e le matrici di lunghezza dei dati per la colonna del set di righe.  
...
3.  Per ogni colonna nel set di risultati, chiamare [SQLBindCol](../../native-client-odbc-api/sqlbindcol.md) in modo da puntare alle relative variabili nel primo elemento della matrice di strutture allocate nel passaggio 1 il valore di dati e il puntatore di lunghezza dati della colonna.  
...
## <a name="see-also"></a>Vedere anche  
 [Utilizzare procedure per cursori &#40;ODBC&#41;](using-cursors-how-to-topics-odbc.md)   
