...
1.  In **Pannello di controllo**, fare doppio clic su **strumenti di amministrazione** e quindi fare doppio clic su **origine dati (ODBC)**. In alternativa, è possibile richiamare odbcad32.exe.  
...
5.  In guidata di Microsoft SQL Server configura DSN, passare alla pagina contenente **statistiche del driver ODBC nel file di log**.  
...
1.  Chiamare [SQLSetConnectAttr](../native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_DATA_LOG e il nome di file e percorso completo del file di log di dati delle prestazioni. Esempio:  
  
    ```  
    "C:\\Odbcperf.log"  
    ```  
  
2.  Chiamare [SQLSetConnectAttr](../native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_DATA e SQL_PERF_START per avviare la registrazione dei dati delle prestazioni.  
...
4.  Chiamare [SQLSetConnectAttr](../native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_DATA e SQL_PERF_STOP per arrestare la registrazione dei dati delle prestazioni.  
...
3.  Chiamare [SQLSetConnectAttr](../native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_DATA e SQL_PERF_STOP per arrestare la registrazione dei dati delle prestazioni.  
...
## <a name="see-also"></a>Vedere anche  
 [Procedure ODBC Driver delle prestazioni di analisi &#40;ODBC&#41;](profiling-odbc-driver-performance-odbc.md)   
