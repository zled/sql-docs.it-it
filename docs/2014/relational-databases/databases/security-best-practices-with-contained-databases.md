...
-   Se l'account di accesso duplicato è disponibile, connettersi alla **master** del database senza specificare un catalogo iniziale e quindi eseguire il `USE` comando per passare al database indipendente.  
