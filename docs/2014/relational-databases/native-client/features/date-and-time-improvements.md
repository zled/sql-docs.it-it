...
# <a name="date-and-time-improvements"></a>Data e ora miglioramenti
 ...
 Per ulteriori informazioni sui miglioramenti di data/ora, vedere [data e ora miglioramenti &#40;OLE DB&#41; ](../../native-client-ole-db-date-time/date-and-time-improvements-ole-db.md) e [data e ora miglioramenti &#40;ODBC&#41;](../../native-client-odbc-date-time/date-and-time-improvements-odbc.md).  
