...
|Versione del driver ODBC di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client|Risultato della lunghezza o dell'indicatore|Description|  
|-----------------------------------------------------------------|---------------------------------|-----------------|  
|[!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)] Native Client o versioni precedenti|20|-   **SQLFetch** viene segnalata la presenza un troncamento a destra dei dati.<br />-Length è la lunghezza dei dati restituiti, non di quelli archiviati (si presuppone * 2 CHAR a conversione WCHAR che potrebbe essere errata per i glifi).<br />-Dati archiviati nel buffer sono 123 \ 0. Viene garantito che la terminazione del buffer sia NULL.|  
|[!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] Native Client (versione 11.0.2100.60) o successive|-4 (SQL_NO_TOTAL)|-   **SQLFetch** viene segnalata la presenza un troncamento a destra dei dati.<br />-Lunghezza viene indicato -4 (SQL_NO_TOTAL) poiché il resto dei dati non è stato convertito.<br />-Dati archiviati nel buffer sono 123 \ 0. - Viene garantito che la terminazione del buffer sia NULL.|  
...
|Versione del driver ODBC di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client|Risultato della lunghezza o dell'indicatore|Description|  
|-----------------------------------------------------------------|---------------------------------|-----------------|  
|[!INCLUDE[ssKilimanjaro](../../../includes/sskilimanjaro-md.md)] Native Client o versioni precedenti|2468|-   **SQLFetch** non restituisce nessun altro dato disponibile.<br />-   **SQLMoreResults** non restituisce nessun altro dato disponibile.<br />-Lunghezza indica le dimensioni dei dati restituiti dal server, non memorizzato nel buffer.<br />-Buffer originale sono contenuti 63 byte e un carattere di terminazione NULL. Viene garantito che la terminazione del buffer sia NULL.|  
|[!INCLUDE[ssSQL11](../../../includes/sssql11-md.md)] Native Client (versione 11.0.2100.60) o successive|-4 (SQL_NO_TOTAL)|-   **SQLFetch** non restituisce nessun altro dato disponibile.<br />-   **SQLMoreResults** non restituisce nessun altro dato disponibile.<br />-Lunghezza viene indicato (-4) SQL_NO_TOTAL poiché il resto dei dati non è stato convertito.<br />-Buffer originale sono contenuti 63 byte e un carattere di terminazione NULL. Viene garantito che la terminazione del buffer sia NULL.|  
