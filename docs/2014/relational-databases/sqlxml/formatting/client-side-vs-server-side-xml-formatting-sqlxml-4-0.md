---
title: lato client Formattazione XML sul lato server sul (SQLXML 4.0) | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   Quando si specifica **client-side-xml = "1"** (true) in un modello, si richiede formattazione XML sul lato client. In questo caso, è possibile specificare FOR XML NESTED. Se si specifica FOR XML AUTO, la formattazione XML viene eseguita sul lato server anche se **client-side-xml = "1"** specificate nel modello.  
  
## <a name="see-also"></a>Vedere anche  
 [Per motivi di sicurezza XML &#40;SQLXML 4.0&#41;](../../sqlxml-annotated-xsd-schemas-xpath-queries/security/for-xml-security-considerations-sqlxml-4-0.md)   
