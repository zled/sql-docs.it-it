---
title: Utilizzare transazioni contrassegnate per recuperare coerentemente i database correlati (modello di recupero con registrazione completa) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
