...
-   Non includere costanti di dati nelle istruzioni SQL; utilizzare invece i marcatori di parametro associati alle variabili di programma. Per altre informazioni, vedere [utilizzando i parametri delle istruzioni](../using-statement-parameters.md).  
