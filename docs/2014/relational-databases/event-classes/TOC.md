# [Guida di riferimento alle classi di evento SQL Server](sql-server-event-class-reference.md)
...
## [Classe di evento Assembly Load](dbengine-assembly-load-event-class.md)
