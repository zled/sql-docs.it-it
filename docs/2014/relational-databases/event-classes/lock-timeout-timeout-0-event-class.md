...
|DatabaseID|`int`|ID del database in cui si è verificato il timeout. [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] Visualizza il nome del database se la `ServerName` colonna di dati viene acquisita nella traccia e il server è disponibile. Determinare il valore per un database utilizzando la funzione DB_ID.|3|Sì|  
