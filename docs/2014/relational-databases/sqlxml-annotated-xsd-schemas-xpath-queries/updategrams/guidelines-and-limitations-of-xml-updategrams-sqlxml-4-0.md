...
-   Se si utilizza un updategram con più  **\<prima di >** e  **\<dopo >** in blocco il  **\<sync >** tag, entrambi  **\<prima di >** blocchi e  **\<dopo >** per modulo è necessario specificare blocchi  **\<prima >** e  **\<dopo >** coppie.  
