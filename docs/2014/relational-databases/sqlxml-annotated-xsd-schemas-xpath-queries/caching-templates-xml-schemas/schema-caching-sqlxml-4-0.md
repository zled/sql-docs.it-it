...
>  [!INCLUDE[ssNoteRegistry](../../../includes/ssnoteregistry-md.md)]  
 ...
 Per ulteriori informazioni sull'installazione side-by-side, vedere [novità in SQLXML 4.0 SP1](../../sqlxml/what-s-new-in-sqlxml-4-0-sp1.md).  
 ...
 Per motivi di prestazioni, è consigliabile impostare **SchemaCacheSize** superiore al numero di schemi di mapping generalmente utilizzati. Come aumenta il numero di schemi, se **SchemaCacheSize** è minore del numero di schemi in uso, le prestazioni diminuiscono.  
