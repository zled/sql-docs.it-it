...
## <a name="remarks"></a>Remarks  
 Questa funzione Copia dati da un file utente a una tabella di database o viceversa, in base al valore di *eDirection* parametro [bcp_init](bcp-init.md).  
