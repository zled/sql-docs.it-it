...
-   Per le colonne tranne calcolate, identity o `timestamp` , i valori sono facoltativi per qualsiasi colonna che ammette valori null, o le colonne con una definizione DEFAULT non NULL.  
