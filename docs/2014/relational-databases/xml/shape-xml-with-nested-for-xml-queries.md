...
```  
 ...
 L'esempio precedente Usa la `query()` metodo il `xml` dati digitare per eseguire una query il codice XML restituito dalla query FOR XML interna e costruire il risultato previsto.  
