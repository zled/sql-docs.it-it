...
```  
 ...
 L'esempio precedente Usa la `query()` metodo di `xml` dati digitare per eseguire una query il codice XML restituito dalla query FOR XML interna e costruire il risultato previsto.  
