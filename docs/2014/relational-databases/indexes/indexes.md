...
|XML|Una rappresentazione suddivisa e persistente, il XML binari oggetti di grandi dimensioni (BLOB) nei `xml` colonna tipo di dati.|[Indici XML &#40;SQL Server&#41;](../xml/xml-indexes-sql-server.md)|  
