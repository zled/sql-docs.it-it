...
# <a name="ole-automation-procedures-server-configuration-option"></a>Opzione di configurazione del server Ole Automation Procedures
 ...
 Il valore corrente di `Ole Automation Procedures` opzione può essere visualizzata e modificata utilizzando il **sp_configure** stored procedure di sistema.  
