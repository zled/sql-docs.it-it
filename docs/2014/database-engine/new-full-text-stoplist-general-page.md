---
title: Nuovo oggetto Stoplist Full-Text (pagina generale) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Utilizzare SQL Server Management Studio per creare un elenco di parole non significative**  
