---
title: Stabilire una sessione utilizzando l'autenticazione di Windows (SQL Server Management Studio) di mirroring del Database | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
