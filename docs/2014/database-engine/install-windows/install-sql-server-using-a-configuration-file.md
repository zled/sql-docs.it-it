---
title: Installazione di SQL Server 2014 tramite un File di configurazione | Documenti Microsoft
ms.custom: ''
ms.date: 01/20/2016
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Aggiornare un Cluster di Failover SQL Server](../../sql-server/failover-clusters/windows/upgrade-a-sql-server-failover-cluster-instance.md)  
