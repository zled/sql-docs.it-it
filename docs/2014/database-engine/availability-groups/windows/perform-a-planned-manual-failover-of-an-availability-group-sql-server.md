...
1.  Spostarsi nella directory (`cd`) all'istanza del server che ospita la replica secondaria di destinazione.  
  
2.  Utilizzare il `Switch-SqlAvailabilityGroup` cmdlet.  
