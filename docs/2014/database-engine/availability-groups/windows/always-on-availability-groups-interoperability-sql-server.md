...
|Crittografia del database|[Crittografia dei database con gruppi di disponibilità AlwaysOn &#40;SQL Server&#41;](encrypted-databases-with-always-on-availability-groups-sql-server.md)|  
|Snapshot di database|[Gli snapshot con gruppi di disponibilità AlwaysOn del database &#40;SQL Server&#41;](database-snapshots-with-always-on-availability-groups-sql-server.md)|  
...
|Log shipping|[Prerequisiti per la migrazione da Log Shipping ai gruppi di disponibilità AlwaysOn &#40;SQL Server&#41;](prereqs-migrating-log-shipping-to-always-on-availability-groups.md)|  
|Archivio BLOB remoto (RBS)|[Archivio Blob remoti di &#40;RBS&#41; e i gruppi di disponibilità AlwaysOn &#40;SQL Server&#41;](remote-blob-store-rbs-and-always-on-availability-groups-sql-server.md)|  
...
|Analysis Services|[Analysis Services con gruppi di disponibilità AlwaysOn](analysis-services-with-always-on-availability-groups.md)|  
...
##  <a name="NoInterop"></a> Funzionalità non di interoperabilità con i gruppi di disponibilità AlwaysOn  
