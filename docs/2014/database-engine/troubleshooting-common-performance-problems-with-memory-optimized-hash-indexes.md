---
title: Risoluzione dei problemi di prestazioni comuni con gli indici Hash con ottimizzazione per la memoria | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Sintomo:** ciò comporta una riduzione delle prestazioni, come [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] è necessario eseguire analisi complete di tabella anziché una ricerca nell'indice, ovvero in genere un'operazione più veloce.  
 ...
 **Soluzioni alternative:** esistono soluzioni alternative possibili. Esempio:  
