---
title: Aggiornare i riferimenti all'interfaccia utente di Advisor | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="upgrade-advisor-user-interface-reference"></a>Guida di riferimento all'interfaccia utente di Preparazione aggiornamento
  In questa sezione include argomenti della Guida [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Preparazione aggiornamento. Questi argomenti sono disponibili tramite guidata di preparazione aggiornamento premendo il tasto F1 o facendo clic **Guida** in pagine della procedura guidata e nelle finestre di dialogo.  
