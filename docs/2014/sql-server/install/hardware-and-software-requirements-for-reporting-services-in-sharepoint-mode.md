---
title: Requisiti hardware e Software per Reporting Services in modalità SharePoint | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="bkmk_more_information"></a> Ulteriori informazioni  
 Per informazioni sulle modifiche di SharePoint, vedere [cambia da SharePoint 2010 a SharePoint 2013](http://technet.microsoft.com/library/ff607742\(office.15\).aspx) (http://technet.microsoft.com/en-us/library/ff607742(office.15).aspx).  
