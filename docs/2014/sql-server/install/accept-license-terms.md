---
title: Accettare le condizioni di licenza | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36170706"
---
# <a name="accept-license-terms"></a>Accettazione delle condizioni di licenza
  Usare la **accettare le condizioni di licenza** pagina del [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] installazione guidata consente di accettare le condizioni di licenza per questa versione di [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Programma di installazione  
 ...
 Per disabilitare la segnalazione CEIP al termine dell'installazione, usare il  **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] segnalazione errori e utilizzo** strumento il [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **strumenti di configurazione** menu.  
...
## <a name="error-reporting"></a>Segnalazione errori  
 Usare la **utilizzo Impostazioni segnalazione errori e** pagina del [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] installazione guidata per abilitare la funzionalità degli errori e utilizzo funzionalità di reporting [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
### <a name="options"></a>Opzioni  
 Per impostazione predefinita, la raccolta dati sull'utilizzo delle caratteristiche e funzionalità di segnalazione errori sono disabilitate per [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] e i relativi componenti in [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
 Segnalazione errori  
 Se si abilita la funzionalità Segnalazione errori [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] è configurato per inviare un report per [!INCLUDE[msCoName](../../includes/msconame-md.md)] automaticamente se si verifica un errore irreversibile in uno dei seguenti [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] componenti:  
...
-   Replica  
 ...
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] utilizza le segnalazioni per migliorare [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] funzionalità e considera tutte le informazioni riservate.  
...
-   Le informazioni ricavate dalla memoria o dai file del processo che ha generato l'errore.  
 ...
 Per ulteriori informazioni sul [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sulla privacy e i criteri di raccolta dati, vedere [informativa sulla Privacy di Microsoft SQL Server](../../../2014/getting-started/microsoft-sql-server-privacy-statement.md).  
