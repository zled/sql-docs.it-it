...
-   Gestire le sessioni di report  
 ...
 Per l'elenco completo dei comandi e le impostazioni disponibili tramite l'accesso con URL, vedere [riferimento ai parametri di accesso URL](url-access-parameter-reference.md).  
