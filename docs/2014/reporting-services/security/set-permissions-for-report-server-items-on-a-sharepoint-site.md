---
title: Impostare le autorizzazioni per elementi del Server di Report in un sito di SharePoint (Reporting Services in modalità integrata SharePoint) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
