...
3.  Nel **Aggiungi nuovo elemento** finestra di dialogo, fare clic su **Creazione guidata Report**, immettere un nome per il file di report e quindi fare clic su **Aggiungi**.  
  
     Verrà avviata la Creazione guidata report.  
  
4.  Nel **proprietà set di dati** nella pagina di **origine dati** fare clic su **DataSet2**.  
...
8.  Con il file con estensione rdlc aperto, aggiungere un parametro effettuando le operazioni seguenti:  
    ...
    1.  Fare clic su **parametri** nel **i dati del Report** riquadro e quindi fare clic su **aggiungere parametri**.  
