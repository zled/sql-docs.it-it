...
# <a name="schedule-properties-reports-page"></a>Proprietà pianificazione (pagina Report)
 ...
 Per aprire questa pagina, avviare [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], connettersi a un server di report, aprire il **pianificazioni condivise** cartella, fare doppio clic su una pianificazione condivisa, selezionare **delle proprietà**, quindi fare clic su **report** .  
