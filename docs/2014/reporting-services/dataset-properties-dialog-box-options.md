---
title: Finestra di dialogo Proprietà set di dati, opzioni | Documenti Microsoft
ms.custom: ''
ms.date: 03/07/2017
...
ms.locfileid: "36055887"
---
# <a name="dataset-properties-dialog-box-options"></a>Finestra di dialogo Proprietà set di dati, Opzioni
  Selezionare **opzioni** sul **DatasetProperties** finestra di dialogo per modificare le opzioni di dati, ad esempio le regole di confronto e i subtotali, per la query. Per altre informazioni, vedere [Collation and Unicode Support](../relational-databases/collations/collation-and-unicode-support.md).  
...
## <a name="see-also"></a>Vedere anche  
 [Impostazioni locali per un Report o una casella di testo &#40;Reporting Services&#41;](report-design/set-the-locale-for-a-report-or-text-box-reporting-services.md)   
 ...
 [Funzione di aggregazione &#40;SSRS e Generatore Report&#41;](report-design/report-builder-functions-aggregate-function.md)  
