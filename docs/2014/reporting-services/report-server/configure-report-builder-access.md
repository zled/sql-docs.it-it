...
-   Per visualizzare uno script di esempio che imposta una proprietà server di report, vedere [Script di distribuzione e le attività amministrative](../tools/script-deployment-and-administrative-tasks.md).  
