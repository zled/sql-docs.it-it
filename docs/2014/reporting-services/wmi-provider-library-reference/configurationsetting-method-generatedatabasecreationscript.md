---
title: Metodo GenerateDatabaseCreationScript (MSReportServer_ConfigurationSetting WMI) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
> [!IMPORTANT]  
>  A partire da [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)], *IsSharePointMode* = `True` non è supportata perché in modalità SharePoint, [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] è un SharePoint servizio condiviso e non è controllato dal provider WMI. È necessario impostare sempre questo parametro `False`.  
