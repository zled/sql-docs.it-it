...
-   Da un'installazione del prompt dei comandi, utilizzare l'opzione **RS_SHPWFE** per installare il componente aggiuntivo. Per ulteriori informazioni sul [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] le installazioni del prompt dei comandi, vedere [prompt dei comandi di installazione di Reporting Services SharePoint Mode e modalità nativa](install-reporting-services-at-the-command-prompt.md).  
...
##  <a name="bkmk_sql2008sp2"></a> SQL Server 2008 SP2 Reporting Services componente aggiuntivo per prodotti SharePoint 2007 e tecnologie  
 ...
 La versione più aggiornata di questo file è disponibile online la [!INCLUDE[msCoName](../../includes/msconame-md.md)] area download [Microsoft SQL Server 2008 SP2 Reporting Services componente aggiuntivo per le tecnologie Microsoft SharePoint](http://go.microsoft.com/fwlink/?LinkID=204594).  
...
##  <a name="bkmk_sql2008"></a> SQL Server 2008 Reporting Services componente aggiuntivo per prodotti SharePoint 2007 e tecnologie  
 ...
 La versione più aggiornata di questo file è disponibile online la [!INCLUDE[msCoName](../../includes/msconame-md.md)] area download [Microsoft SQL Server 2008 Reporting Services componente aggiuntivo per le tecnologie Microsoft SharePoint](http://go.microsoft.com/fwlink/?LinkID=204813).  
