...
-   **Sola lettura** esegue l'override **aggiornamento**.  
...
## <a name="example-2"></a>Esempio 2  
 ...
 Nel **membri della gerarchia** scheda, il nodo della sottocategoria Mountain Bikes in una gerarchia derivata viene assegnato in modo esplicito **Read-only** l'autorizzazione.  
  
 Risultato: In **Explorer**, l'utente ha **Read-only** dell'autorizzazione per i valori dell'attributo Subcategory per i membri del nodo Mountain Bikes. Tutti gli altri membri e attributi sono nascosti.  
...
## <a name="example-3"></a>Esempio 3  
 ...
 Nel **modelli** scheda, all'attributo Subcategory è **Read-only** assegnata l'autorizzazione.  
 ...
 Risultato: In **Explorer**, l'utente ha **Read-only** autorizzazione ai valori di attributo. Tutti gli altri membri e attributi sono nascosti.  
