...
2.  Selezionare la linea di join nel riquadro Diagramma, quindi dal **progettazione Query** menu, scegliere **Seleziona tutte le righe da \<tablename >**, selezionando il comando che include la tabella cui extra righe da includere.  
