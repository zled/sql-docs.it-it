...
## Vedere anche  
 [Isolamento delle transazioni basati sul controllo delle versioni delle righe di Server 2005 SQL](http://msdn.microsoft.com/library/ms345124(v=sql.90).aspx)   
