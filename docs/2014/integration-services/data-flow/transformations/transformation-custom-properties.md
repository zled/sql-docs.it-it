...
|Nome proprietà|Tipo di dati|Description|  
|-------------------|---------------|-----------------|  
|copyColumnId|Valore intero|Il `LineageID` della colonna di input da cui viene copiata la colonna di output.|  
...
|SourceInputColumnLineageId|Valore intero|Il `LineageID` della colonna di input che rappresenta l'origine della colonna di output.|  
...
|DropExistingMatchIndex|Boolean|Un valore che specifica se l'indice delle corrispondenze specificato in MatchIndexName viene eliminato quando MatchIndexOptions non è impostata su ReuseExistingIndex. Il valore predefinito per questa proprietà è `True`.|  
...
|Nome proprietà|Tipo di dati|Description|  
|-------------------|---------------|-----------------|  
|InputColumnID|Valore intero|Il `LineageID` della colonna di input da cui i dati vengono copiati in questa colonna di output.|  
...
|SourceColumn ID|Valore intero|Il `LineageID` di una colonna di input che contiene un valore trasformato tramite pivot oppure -1. Il valore -1 indica che la colonna non viene utilizzata in un'operazione pivot.|  
...
|Nome proprietà|Tipo di dati|Description|  
|-------------------|---------------|-----------------|  
|CustomLineageID|Valore intero|Il `LineageID` della colonna di input corrispondente se il `InputColumnType` di tale colonna è 0 o 2.|  
