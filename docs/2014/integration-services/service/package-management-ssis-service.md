...
-   [Visualizzazione di pacchetti in SQL Server Management Studio di Integration Services &#40;servizio SSIS&#41;](../view-integration-services-packages-in-sql-server-management-studio-ssis-service.md)  
