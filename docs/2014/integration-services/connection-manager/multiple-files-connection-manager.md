...
> [!NOTE]  
>  Le attività predefinite e i componenti del flusso di dati in [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] non utilizzano la gestione connessione per più file. È tuttavia possibile utilizzare la gestione connessione nell'attività Script o nel componente di script. Per informazioni sull'uso delle gestioni connessioni nell'attività Script, vedere [Connessione a origini dati nell'attività Script](../extending-packages-scripting/task/connecting-to-data-sources-in-the-script-task.md). Per informazioni sull'utilizzo di gestioni connessioni nel componente Script, vedere [connessione alle origini dati nel componente Script] (... / extending-packages-scripting/data-flow-script-component/connecting-to-data-sources-in-the-script-component.md.  
...
## <a name="configuration-of-the-multiple-files-connection-manager"></a>Configurazione della gestione connessione per più file  
 ...
 Il `ConnectionManagerType` proprietà della gestione connessione è impostata su `MULTIFILE`.  
...
-   Se si utilizzano più file e cartelle, specificare l'ordine con cui accedere a tali elementi.  
 ...
 Per specificare più file o cartelle è inoltre possibile utilizzare caratteri jolly. Ad esempio, per tutti i file di testo C unità, il valore di riferimento il `ConnectionString` può essere impostata su c:\\*. txt.  
