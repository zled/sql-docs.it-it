---
title: Azure Feature Pack | Documenti Microsoft
ms.custom: ''
ms.date: 08/24/2017
...
-   Enumeratore Blob di Azure & ADLS File enumeratore. Vedere [Foreach Loop Container](control-flow/foreach-loop-container.md).  
