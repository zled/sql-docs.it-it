...
## <a name="related-tasks"></a>Related Tasks  
 [Mapping dei parametri di Query a variabili in un'attività Esegui SQL](control-flow/execute-sql-task.md)  
