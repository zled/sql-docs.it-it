---
title: Backup e ripristino di pacchetti (servizio SSIS) | Documenti Microsoft
ms.custom: ''
ms.date: 03/07/2017
...
-   [Backup e ripristino di database di sistema &#40;SQL Server&#41;](../relational-databases/backup-restore/back-up-and-restore-of-system-databases-sql-server.md)  
 ...
 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] include il **dtutil** utilità (DTUtil. Exec), è possibile utilizzare per gestire i pacchetti della riga di comando. Per altre informazioni, vedere [dtutil Utility](dtutil-utility.md).  
