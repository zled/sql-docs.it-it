---
title: 'Attività 3: Creazione ed esecuzione di un progetto Data Quality per la corrispondenza | Documenti Microsoft'
ms.custom: ''
ms.date: 04/27/2017
...
2.  Tipo di **Rimuovi duplicati fornitore** dal **nome del progetto**.  
...
4.  Selezionare **corrispondenza** dal **elenco delle attività** dal riquadro in basso a destra.  
...
8.  Mappa **SupplierID** la colonna di origine per il **Supplier ID** dominio, **Supplier Name** colonna **Supplier Name** dominio e **ContactEmailAddress** colonna **Contact Email** dominio.  
  
9. Fare clic su **successivo** per attivare il **corrispondenza** pagina.  
...
12. Fare clic su **successivo** per attivare il **esportare** pagina.  
