---
title: "Attività 4: Esportazione dei risultati dell'attività di corrispondenza in un File di Excel | Documenti Microsoft"
ms.custom: ''
ms.date: 03/06/2017
...
1.  Nel **esportare** pagina, selezionare **File di Excel** per il **tipo destinazione**.  
  
2.  Selezionare **risultati sopravvivenza** opzione. Nel processo di sopravvivenza, DQS viene determinato un record superstite per ogni cluster in base il **regola di sopravvivenza** è stato selezionato.  
  
3.  Fare clic su **Sfoglia** e passare alla cartella in cui si desidera archiviare il file di output.  
  
4.  Tipo di **Cleansed and Matched Suppliers. xls** per il nome e fare clic su **Apri**.  
...
5.  Verificare che **Record Pivot** sia selezionata per il **regola di sopravvivenza**. Quando si seleziona questa opzione, come output da un cluster viene selezionato il record pivot per ogni cluster. Di seguito sono riportate le altre opzioni per la regola di sopravvivenza:  
    ...
    2.  **Record più lungo:** il record superstite è quello con il maggior numero di termini in campi di origine.  
...
7.  Fare clic su **chiudere** per chiudere la **esportazione corrispondenze** finestra di dialogo.  
  
8.  Fare clic su **fine** per completare l'attività corrispondente.  
  
9. Aprire la **Cleansed and Matched Suppliers. xlsx** file e verificare di non visualizzare alcun duplicato (SupplierID).  
