---
title: Aggiunta di dati di un vista di origine per la previsione (esercitazione intermedia di Data Mining) | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
3.  Nel **selezionare un'origine dati** nella pagina **origini dati relazionali**, selezionare il [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] origine dati. Scegliere **Avanti**.  
  
    > [!NOTE]  
    >  Se non si dispone di questa origine dati, è possibile trovare i passaggi per creare l'origine dati nel [Basic Data Mining Tutorial](../../2014/tutorials/basic-data-mining-tutorial.md).  
...
6.  Nel **Completamento procedura guidata** pagina, per impostazione predefinita la vista origine dati è denominata [!INCLUDE[ssAWDWsp](../includes/ssawdwsp-md.md)]. Modificare il nome in **SalesByRegion**, quindi fare clic su **fine**.  
     ...
     Verrà visualizzata la finestra di progettazione vista origine dati e il **SalesByRegion** verrà visualizzata la vista origine dati.  
...
-   Fare clic su **opzioni di campionamento** e quindi usare il **opzioni di esplorazione dati** finestra di dialogo per modificare il metodo di campionamento. Fare clic su **aggiornare** per caricare i dati nella tabella utilizzando le nuove impostazioni dell'opzione. Ad esempio, è possibile specificare il numero di righe da restituire nel campione o scegliere le prime n righe.  
...
-   Fare doppio clic su una tabella e selezionare **nuovo calcolo denominato** per creare colonne derivate, incluse le aggregazioni. È inoltre possibile aggiungere nuove tabelle e viste dall'origine dati della vista corrente.  
