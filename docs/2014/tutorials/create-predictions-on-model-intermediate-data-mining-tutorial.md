...
3.  Nel **Seleziona tabella** della finestra di dialogo per l'origine dati, selezionare gli ordini. Nel **nome tabella/vista** elenco, selezionare vAssocSeqOrders e quindi fare clic su **OK**.  
