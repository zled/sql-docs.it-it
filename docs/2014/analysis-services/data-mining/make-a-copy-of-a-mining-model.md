...
4.  Nel **delle proprietà** finestra, nel `AlgorithmParameters` casella di testo, fare clic su **Setalgorithm parametri**e modificare i parametri dell'algoritmo, se lo si desidera.  
