...
## <a name="calculating-cell-ordinal-values"></a>Calcolo dei valori ordinali di cella  
 Il riferimento dell'asse per una cella può essere calcolato in base a un valore dell'attributo `CellOrdinal`. Concettualmente, le celle sono numerate in un set di dati come se fosse il set di dati un *p*-matrice dimensionale, dove *p* è il numero di assi. Le celle sono indirizzate in ordine di riga.  
...
||Q4|34235|29172.72|73016.34|11217|  
 ...
 Per i = 0, Ei = 1, in questo caso per i = 0 la somma è 1 * 1 = 1 e per i = 1, la somma è 2 (ordinale della tupla) orari 4 (il valore di Ei calcolato come 1 \* 4), o 8. La somma di 1 + 8 è quindi 9, l'ordinale della cella per quella cella.  
