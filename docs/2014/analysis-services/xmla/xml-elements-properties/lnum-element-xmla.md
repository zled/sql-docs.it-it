...
## <a name="remarks"></a>Remarks  
 ...
 Per `Member` elementi, il `LNum` elemento contiene la posizione ordinale in base zero, dal livello radice della gerarchia, del membro rappresentato dall'elemento padre [membro](member-element-xmla.md) elemento. Un valore zero rappresenta il livello radice della gerarchia.  
