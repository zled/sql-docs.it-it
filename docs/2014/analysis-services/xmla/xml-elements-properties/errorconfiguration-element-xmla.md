...
## <a name="remarks"></a>Remarks  
 La struttura di questo elemento è identica alla struttura dell'elemento `ErrorConfiguration` in Analysis Services Scripting Language (ASSL). Per ulteriori informazioni sul `ErrorConfiguration` elemento, vedere [elemento ErrorConfiguration &#40;ASSL&#41;](../../scripting/objects/errorconfiguration-element-assl.md).  
