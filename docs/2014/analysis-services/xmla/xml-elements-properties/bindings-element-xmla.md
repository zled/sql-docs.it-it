...
ms.locfileid: "36158291"
---
# <a name="bindings-element-xmla"></a>Elemento Bindings (XMLA)
  Contiene una raccolta di [associazione](binding-element-xmla.md) elementi per l'elemento padre [Batch](../xml-elements-commands/batch-element-xmla.md) oppure [processo](../xml-elements-commands/process-element-xmla.md) elemento.  
