...
## <a name="remarks"></a>Remarks  
 ...
 L'elemento che corrisponde al padre di `CurrentTimeMember` nell'oggetto oggetti AMO (Analysis Management) è modello <xref:Microsoft.AnalysisServices.Kpi>.  
