---
title: Tipo di dati DSVTableBinding (ASSL) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="remarks"></a>Remarks  
 Per ulteriori informazioni sul `Binding` tipo, incluse le tabelle di oggetti di Analysis Services Scripting Language (ASSL) del `Binding` tipo e la gerarchia di ereditarietà dei `Binding` tipi, vedere [associazione](binding-data-type-assl.md) elemento.  
