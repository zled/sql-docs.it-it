---
title: Dimensione del tipo di dati (ASSL) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   Tutti gli attributi univoci devono disporre *NullProcessing* insieme elementi figlio `Error`  
