...
|-------------|-----------------|  
|[Elemento account &#40;ASSL&#41;](accounts-element-assl.md)|Contiene la raccolta di tipi di conto definiti in un [Database](../objects/database-element-assl.md) elemento.|  
...
|[Elemento AllMemberTranslations &#40;ASSL&#41;](translations-element-assl.md)|Contiene la raccolta di [Translation](../objects/translation-element-assl.md) elementi per la didascalia del membro totale di un [gerarchia](../objects/hierarchy-element-assl.md) elemento.|  
...
|[Elemento Assemblies &#40;ASSL&#41;](assemblies-element-assl.md)|Contiene la raccolta di [Assembly](../objects/assembly-element-assl.md) gli elementi associati a un [Server](../objects/server-element-assl.md) elemento o un [Database](../objects/database-element-assl.md) elemento.|  
...
|[Attributi elemento &#40;ASSL&#41;](attributes-element-assl.md)|Contiene la raccolta di attributi per la dimensione associata.|  
...
|[Elemento i comandi &#40;ASSL&#41;](commands-element-assl.md)|Contiene la raccolta di elementi [Command](../objects/command-element-assl.md) associati a un elemento [MdxScript](../objects/mdxscript-element-assl.md).|  
...
|[Cubi elemento &#40;ASSL&#41;](cubes-element-assl.md)|Contiene la raccolta di [cubo](../objects/cube-element-assl.md) gli elementi associati a un [Database](../objects/database-element-assl.md) elemento.|  
...
|[Elemento DimensionPermissions &#40;ASSL&#41;](dimensionpermissions-element-assl.md)|Contiene la raccolta di autorizzazioni applicabili a un [dimensione](../objects/dimension-element-assl.md) elemento o un [CubePermission](../objects/cubepermission-element-assl.md) elemento.|  
|[Dimensioni elemento di &#40;ASSL&#41;](dimensions-element-assl.md)|Contiene la raccolta di dimensioni associate all'elemento padre.|  
...
|[Gruppi di elemento &#40;ASSL&#41;](groups-element-assl.md)|Contiene la raccolta di gruppi di membri associati a un attributo.|  
...
|[Elemento KPI &#40;ASSL&#41;](kpis-element-assl.md)|Contiene la raccolta di [Kpi](../objects/kpi-element-assl.md) elementi associati all'elemento padre.|  
...
|[Misura l'elemento &#40;ASSL&#41;](measures-element-assl.md)|Contiene la raccolta di [misure](../objects/measure-element-assl.md) elementi associati all'elemento padre.|  
...
|[Elemento ModelingFlags &#40;ASSL&#41;](modelingflags-element-assl.md)|Contiene la raccolta di [ModelingFlag](../objects/modelingflag-element-assl.md) elementi di una colonna in un [MiningStructure](../objects/miningstructure-element-assl.md) o un [MiningModel](../objects/miningmodel-element-assl.md).|  
|[Elemento NamingTemplateTranslations &#40;ASSL&#41;](namingtemplatetranslations-element-assl.md)|Fornisce una raccolta di conversioni localizzate per il [NamingTemplate](../properties/namingtemplate-element-assl.md) dell'elemento padre [DimensionAttribute](../data-type/dimensionattribute-data-type-assl.md).|  
|[Partizioni elemento &#40;ASSL&#41;](partitions-element-assl.md)|Contiene la raccolta di [partizione](../objects/partition-element-assl.md) gli elementi utilizzati da un [MeasureGroup](../objects/group-element-assl.md) elemento o la raccolta di associazioni della partizione che costituiscono un out-of-line [MeasureGroupBinding](../data-type/measuregroupbinding-data-type-out-of-line-assl.md)elemento.|  
...
|[Elemento ReportParameters &#40;ASSL&#41;](reportparameters-element-assl.md)|Contiene la raccolta di [ReportParameter](../objects/reportparameter-element-assl.md) elementi per un [ReportAction](../data-type/action-data-type-assl.md) elemento.|  
