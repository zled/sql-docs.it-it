...
-   **(2)**  Due [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] servizi condivisi e **(4)** il servizio di Windows **SQL Server Analysis Services (POWERPIVOT)** vengono installati nei server applicazioni di SharePoint.  
