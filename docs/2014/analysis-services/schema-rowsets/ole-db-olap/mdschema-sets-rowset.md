...
|`CUBE_SOURCE`|`DBTYPE_UI2`|Facoltativo. **Nota:** può essere inclusa una sola gerarchia e le cui gerarchie corrispondono esattamente alla restrizione vengono restituiti solo i set denominati.|  
