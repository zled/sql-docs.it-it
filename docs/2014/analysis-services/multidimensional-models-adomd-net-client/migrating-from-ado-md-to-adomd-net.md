...
-   `Cellset` per l'esecuzione di un'istruzione MDX (Multidimensional Expressions).  
  
-   `Position`, recuperato dall'oggetto `Cellset`, per il recupero di dati e metadati.  
...
-   `AdomdConnection` per la creazione di una connessione.  
  
-   `AdomdCommand` per l'esecuzione di un'istruzione MDX.  
  
-   `Set`, recuperato dall'oggetto `Cellset`, per il recupero di dati e metadati.  
