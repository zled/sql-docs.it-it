---
title: Finestra di dialogo Proprietà (SSMS) di partizione | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**La memorizzazione nella cache**|La pagina **Memorizzazione nella cache attiva** consente di visualizzare e modificare le impostazioni di archiviazione e memorizzazione nella cache attiva della partizione selezionata nella pagina **Selezione** . Per altre informazioni su questa pagina, vedere [Memorizzazione nella cache attiva &#40;finestra di dialogo Proprietà partizione&#41; &#40;SSMS&#41;](proactive-caching-partition-properties-dialog-box-ssms.md).|  
