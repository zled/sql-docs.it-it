...
3.  Nel **nome** casella, modificare il nome del nuovo set denominato in `[Core Products]`.  
...
4.  Nel **metadati** nella scheda il **strumenti di calcolo** riquadro, espandere **prodotto**, espandere **categoria**, espandere `Members`e quindi Espandere **tutti i prodotti**.  
...
2.  Nel **nome** modificare il nome di questo set denominato in `[Large Resellers]`.  
...
7.  Nel **metadati** nella scheda il **strumenti di calcolo** riquadro, espandere **Number of Employees** nella dimensione Reseller, espandere `Members`, quindi espandere **Tutti i rivenditori**.  
...
9. Nella finestra Proprietà modificare il `DiscretizationMethod` proprietà da **automatica**, quindi modificare il `DiscretizationBucketCount` proprietà da `5`. Per altre informazioni, vedere [Raggruppare membri di attributo &#40;discretizzazione&#41;](multidimensional-models/attribute-properties-group-attribute-members.md).  
...
12. Nel **metadati** nella scheda il **strumenti di calcolo** riquadro, espandere **Number of Employees** nel **Reseller** dimensione, espandere `Members`, quindi espandere **tutti i rivenditori**.  
...
13. Nell'espressione set Exists contenuta nella casella **Espressione** aggiungere una virgola dopo la funzione Members e prima della parentesi di chiusura, quindi trascinare **83 - 100** dal riquadro **Metadati** e posizionarlo dopo la virgola.  
     ...
     La figura seguente mostra la **espressioni di calcolo** riquadro per il `[Large Resellers]` set denominato.  
...
6.  Nel riquadro **Metadati** , nella dimensione **Product** trascinare **Core Products** nell'area filtro.  
     ...
     ![I membri del prodotto principale set denominato](../../2014/tutorials/media/l6-named-set-04.gif "set denominato di membri del prodotto principale")  
...
7.  Nel riquadro **Metadati** espandere **Reseller**, quindi aggiungere **Large Resellers** all'area filtro.  
     ...
     ![Riquadro filtro contenente due denominato imposta](../../2014/tutorials/media/l6-named-set-05.gif "riquadro filtro contenente due denominato imposta")  
