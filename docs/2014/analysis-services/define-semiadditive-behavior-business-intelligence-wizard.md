---
title: Definisci funzioni semiadditive (configurazione guidata Business Intelligence) | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **La procedura guidata ha rilevato il \<nome dimensione > dimensione di tipo conti, che contiene membri semiadditivi. Il server aggregherà i membri di questa dimensione in base a semiadditive specificate per ogni tipo di conto.**  
 ...
 **Definisci funzioni semiadditive per i singoli membri**  
