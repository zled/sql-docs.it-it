...
##  <a name="BU"></a> Metodi backup e Restore  
...
3.  Avvio e arresto della traccia in base alle esigenze.  
     ...
     Anche dopo l'arresto, la traccia esiste nel server e dovrebbe avviarsi nuovamente se è stata definita con AutoRestart = `true`.  
...
1.  Avvio dell'acquisizione del log XMLA impostando l'attributo server CaptureXml su `true`.  
...
3.  Arresto dell'acquisizione del log XMLA impostando CaptureXml su `false`.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [AMO altri metodi e classi](amo-other-classes-and-methods.md)   
