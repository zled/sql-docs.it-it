---
title: Gerarchia padre-figlio | Documenti Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Vedere anche  
 [Attributi in gerarchie padre-figlio](parent-child-dimension-attributes.md)   
