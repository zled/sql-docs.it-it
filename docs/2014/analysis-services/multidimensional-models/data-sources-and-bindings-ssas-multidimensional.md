...
-   Ogni colonna di tabella non nidificata è associata a una misura su un cubo, a un attributo in una dimensione del cubo (specificando il `CubeDimension` per evitare ambiguità nel caso dei ruoli di dimensione), o a un attributo in una dimensione.  
