---
title: Query (SQL Server Data Mining Add-ins) | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
2.  Nella procedura guidata viene quindi visualizzato un elenco dei modelli di data mining disponibili nel server a cui si è connessi. Se si conosce il modello desiderato e si ha familiarità con il data mining, è inoltre possibile fare clic **avanzate** per aprire la **Editor di Query avanzato di Data Mining**.  
...
4.  La procedura guidata consente infine di scegliere una o più stime e di specificare la destinazione di archiviazione dei risultati.  
 ...
 In qualsiasi momento, è possibile fare clic su **avanzate** per passare al **Editor avanzato Data Mining Query**, che offre maggiore controllo su qualsiasi parte dell'istruzione DMX. Per ulteriori informazioni su come usare la query avanzata strumenti di modifica, vedere [avanzato Editor di Query di Data Mining](advanced-data-mining-query-editor.md).  
