---
title: Dimensioni abilitati per scrittura | Documenti Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="see-also"></a>Vedere anche  
 [Proprietà delle dimensioni di database](database-dimension-properties.md)   
