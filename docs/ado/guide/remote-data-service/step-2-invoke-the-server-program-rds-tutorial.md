 ...
 **La parte** se non è stato utilizzato [RDSServer](../../../ado/reference/rds-api/datafactory-object-rdsserver.md) in questa esercitazione, il modo più semplice per eseguire questo passaggio potrebbe consistere nell'utilizzare il [RDS. Elemento DataControl](../../../ado/reference/rds-api/datacontrol-object-rds.md) oggetto. Il **RDS. DataControl** combina il passaggio precedente della creazione di un proxy, con questo passaggio, invia la query.  
