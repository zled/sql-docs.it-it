---
title: Aggiornato - ADO per i documenti del Server SQL | Documenti Microsoft
description: Visualizzare i frammenti di contenuto aggiornato per la documentazione modificato di recente in, per gli oggetti ADO (ActiveX Data) per Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32435482"
---
# <a name="new-and-recently-updated-activex-data-objects-ado-for-sql-server"></a>Nuovi e aggiornati: ActiveX Data Objects (ADO) per SQL Server
...
- *Area di interesse:* &nbsp; **oggetti ADO (ActiveX Data) per SQL Server**.
