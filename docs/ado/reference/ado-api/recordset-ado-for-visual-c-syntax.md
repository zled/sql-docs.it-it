---
title: Recordset (ADO per la sintassi di Visual C++) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35281270"
---
# <a name="recordset-ado-for-visual-c-syntax"></a>Recordset (ADO per la sintassi di Visual C++)
