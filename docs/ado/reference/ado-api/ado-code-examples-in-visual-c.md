...
-   [Esempio del metodo Clone](../../../ado/reference/ado-api/clone-method-example-vc.md)  
  
-   [Metodo CompareBookmarks](../../../ado/reference/ado-api/comparebookmarks-method-example-vc.md)  
...
-   [Esempio GetString (metodo)](../../../ado/reference/ado-api/getstring-method-example-vc.md)  
  
-   [MoveFirst, MoveLast, MoveNext e MovePrevious metodi esempio](../../../ado/reference/ado-api/movefirst-movelast-movenext-and-moveprevious-methods-example-vc.md)  
  
-   [Esempio di firme](../../../ado/reference/ado-api/nextrecordset-method-example-vc.md)  
  
-   [Esempio di metodi di apertura e chiusura](../../../ado/reference/ado-api/open-and-close-methods-example-vc.md)  
  
-   [Metodo OpenSchema](../../../ado/reference/ado-api/openschema-method-example-vc.md)  
...
-   [Proprietà ActiveCommand](../../../ado/reference/ado-api/activecommand-property-example-vc.md)  
...
-   [Proprietà MarshalOptions](../../../ado/reference/ado-api/marshaloptions-property-example-vc.md)  
  
-   [Esempio di proprietà MaxRecords](../../../ado/reference/ado-api/maxrecords-property-example-vc.md)  
  
-   [Esempio di proprietà Precision e NumericScale](../../../ado/reference/ado-api/numericscale-and-precision-properties-example-vc.md)  
