---
title: Supporta l'esempio di metodo (VC + +) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35282650"
---
# <a name="supports-method-example-vc"></a>Esempio di metodo di supporto (VC + +)
Questo esempio viene utilizzato il [supporta](../../../ado/reference/ado-api/supports-method.md) metodo per visualizzare le opzioni supportate da un oggetto recordset è aperto con diversi tipi di cursore. La funzione DisplaySupport è necessaria per eseguire questo esempio.  
