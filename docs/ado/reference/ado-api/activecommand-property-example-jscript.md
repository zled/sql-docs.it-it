---
title: Esempio di proprietà ActiveCommand (JScript) | Documenti Microsoft
ms.prod: sql
...
---
# <a name="activecommand-property-example-jscript"></a>Esempio di proprietà ActiveCommand (JScript)
Questo esempio viene illustrato il [ActiveCommand](../../../ado/reference/ado-api/activecommand-property-ado.md) proprietà. Tagliare e incollare il codice seguente in blocco note o un altro editor di testo e salvarlo come **ActiveCommandJS**.  
