---
title: Esempio UpdateBatch e CancelBatch metodi (VB) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35282675"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vb"></a>Esempio UpdateBatch e CancelBatch metodi (VB)
