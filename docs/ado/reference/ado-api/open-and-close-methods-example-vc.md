---
title: Apertura e chiusura di esempio di metodi (VC + +) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35279920"
---
# <a name="open-and-close-methods-example-vc"></a>Esempio di metodi di apertura e chiusura (VC + +)
