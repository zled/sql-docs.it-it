---
title: Comando (ADO per la sintassi di Visual C++) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35276600"
---
# <a name="command-ado-for-visual-c-syntax"></a>Comando (ADO per la sintassi di Visual C++)
