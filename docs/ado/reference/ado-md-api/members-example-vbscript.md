---
title: Esempio di membri (VBScript) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35284790"
---
# <a name="members-example-vbscript"></a>Esempio di membri (VBScript)
In questo esempio utilizza una stringa di query MDX per recuperare i dati OLAP e scrive il set di celle risultante in una struttura di tabella HTML utilizzando le caratteristiche di estensione di colonna per la dimensione di più set di celle.  
