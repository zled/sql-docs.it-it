---
title: Esempio di asse (VBScript) | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35283400"
---
# <a name="axis-example-vbscript"></a>Esempio di asse (VBScript)
Questa pagina ASP consente di visualizzare i dati OLAP da una stringa di Query MDX e scrive il set di celle risultante in una struttura di tabella HTML.  
