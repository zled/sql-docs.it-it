---
title: Metodi ADO MD | Documenti Microsoft
ms.prod: sql
...
|||  
|-|-|  
|[Chiudi](../../../ado/reference/ado-md-api/close-method-ado-md.md)|Chiude un set di celle aperto.|  
|[GetSchemaObject](../../../ado/reference/ado-md-api/getschemaobject-method-ado-md.md)|Recupera un oggetto dello schema ADO MD (dimensione, gerarchia, livello o membro) dal proprio nome univoco.|  
|[Apertura](../../../ado/reference/ado-md-api/open-method-ado-md.md)|Recupera i risultati di una query multidimensionale e restituisce i risultati per un set di celle.|  
