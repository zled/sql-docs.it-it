...
|[Aprire](../../../ado/reference/ado-md-api/open-method-ado-md.md)|Recupera i risultati di una query multidimensionale e restituisce i risultati per un set di celle.|  
