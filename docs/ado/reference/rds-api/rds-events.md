---
title: Gli eventi di servizi desktop remoto | Documenti Microsoft
...
|[onReadyStateChange (RDS)](../../../ado/reference/rds-api/onreadystatechange-event-rds.md)|Chiamato ogni volta che il valore di **ReadyState** le modifiche alle proprietà.|
