---
title: Esempio di proprietà (VC + +) in cluster | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35285420"
---
# <a name="clustered-property-example-vc"></a>Esempio di proprietà Clustered (VC + +)
