...
-   [Le colonne e tabelle aggiungere metodi, esempio di proprietà Name (VC + +)](../../../ado/reference/adox-api/columns-and-tables-append-methods-name-property-example-vc.md)  
  
-   [Connessione Close (metodo), esempio di proprietà di tipo tabella (VC + +)](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
  
-   [Creare l'esempio di metodo (VC + +)](../../../ado/reference/adox-api/create-method-example-vc.md)  
  
-   [GetObjectOwner e metodi SetObjectOwner (VC + +)](../../../ado/reference/adox-api/getobjectowner-and-setobjectowner-methods-example-vc.md)  
  
-   [GetPermissions e metodi SetPermissions (VC + +)](../../../ado/reference/adox-api/getpermissions-and-setpermissions-methods-example-vc.md)  
  
-   [Aggiungere utenti e gruppi, esempio di metodi ChangePassword (VC + +)](../../../ado/reference/adox-api/groups-and-users-append-changepassword-methods-example-vc.md)  
  
-   [Indici di esempio del metodo Append (VC + +)](../../../ado/reference/adox-api/indexes-append-method-example-vc.md)  
...
-   [Esempio di proprietà ActiveConnection catalogo (VC + +)](../../../ado/reference/adox-api/catalog-activeconnection-property-example-vc.md)  
  
-   [Esempio di proprietà Clustered (VC + +)](../../../ado/reference/adox-api/clustered-property-example-vc.md)  
  
-   [Esempio di proprietà CommandText (VC + +) e di comando](../../../ado/reference/adox-api/command-and-commandtext-properties-example-vc.md)  
...
-   [Esempio DateCreated e DateModified proprietà (VC + +)](../../../ado/reference/adox-api/datecreated-and-datemodified-properties-example-vc.md)  
...
-   [NumericScale e Precision (VC + +)](../../../ado/reference/adox-api/numericscale-and-precision-properties-of-the-column-object-example-vc.md)  
  
-   [Esempio di proprietà ParentCatalog (VC + +)](../../../ado/reference/adox-api/parentcatalog-property-example-vc.md)  
  
-   [Esempio PrimaryKey e proprietà univoche (VC + +)](../../../ado/reference/adox-api/primarykey-and-unique-properties-example-vc.md)  
