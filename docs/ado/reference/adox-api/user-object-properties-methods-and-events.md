---
title: Le proprietà dell'oggetto utente, metodi ed eventi | Documenti Microsoft
ms.prod: sql
...
ms.locfileid: "35287260"
---
# <a name="user-object-properties-methods-and-events"></a>Le proprietà dell'oggetto utente, metodi ed eventi
