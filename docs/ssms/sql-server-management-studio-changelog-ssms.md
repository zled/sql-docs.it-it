...
- Si tratta di una shell moderna (è stato scelto Visual Studio 2107 15.6.4). La nuova shell sblocca tutte le correzioni di accessibilità integrate in SSMS e in Visual Studio.
