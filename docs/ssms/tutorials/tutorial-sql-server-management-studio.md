...
[Lezione 1: Navigazione di base in SQL Server Management Studio](../../tools/sql-server-management-studio/lesson-1-basic-navigation-in-sql-server-management-studio.md)  
...
[Lezione 3: Utilizzo di modelli, soluzioni e progetti script](../../tools/sql-server-management-studio/lesson-3-working-with-templates-solutions-and-script-projects.md)  
...
-   Installare la versione più recente di [SQL Server Management Studio](https://msdn.microsoft.com/library/mt238290.aspx) dall'area download.  
