...
### <a name="find-your-error-log-if-you-cannot-connect-to-sql"></a>Trovare il log degli errori se non è possibile connettersi a SQL
...
### <a name="find-your-error-log-if-youre-connected-to-sql"></a>Trovare il log degli errori se si è connessi a SQL
1. Connettersi a SQL Server.
