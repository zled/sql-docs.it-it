...
---
# Lezione 1-1 - Avviare SQL Server Management Studio
<a id="lesson-1-1---start-sql-server-management-studio" class="xliff"></a>
...
<a id="opening-sql-server-management-studio" class="xliff"></a>  
  
#### Per aprire SQL Server Management Studio
<a id="to-open-sql-server-management-studio" class="xliff"></a>  
...
## Componenti di Management Studio
<a id="management-studio-components" class="xliff"></a>  
...
## Visualizzazione di finestre aggiuntive
<a id="showing-additional-windows" class="xliff"></a>  
  
#### Per visualizzare la finestra Server registrati
<a id="to-show-the-registered-servers-window" class="xliff"></a>  
...
<a id="next-task-in-lesson" class="xliff"></a>  
