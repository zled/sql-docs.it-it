...
> [!NOTE]  
> Per rimuovere completamente una colonna dalla query, vedere [Remove Columns from Queries &#40;Visual Database Tools&#41;](../../ssms/visual-db-tools/remove-columns-from-queries-visual-database-tools.md).  
