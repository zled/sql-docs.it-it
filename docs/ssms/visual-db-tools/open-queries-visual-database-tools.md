...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] In Progettazione query e Progettazione viste è possibile aprire una query esistente usando il comando **Apri**.  
