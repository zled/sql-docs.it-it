...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Mediante la colonna **Ordinamento** nel [riquadro Criteri](../../ssms/visual-db-tools/criteria-pane-visual-database-tools.md) è possibile specificare in quale sequenza devono essere usate le colonne per l'ordinamento dei dati.  
