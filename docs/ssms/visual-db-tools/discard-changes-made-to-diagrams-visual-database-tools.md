...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] È possibile eliminare le modifiche al diagramma di database che non si vuole salvare nel database.  
