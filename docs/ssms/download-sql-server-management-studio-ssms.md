...
### <a name="available-languages-ssms-179"></a>Lingue disponibili (SSMS 17.9)
...
## <a name="ssms-installation-tips-and-issues-ssms-179"></a>Suggerimenti e problemi di installazione di SSMS (SSMS 17.9)
...
* Per ridurre le probabilità che al termine del programma di installazione di SSMS sia necessario il riavvio del computer, eseguire le azioni seguenti:
  ...
  * Chiudere tutte le istanze di Visual Studio aperte nel computer.
