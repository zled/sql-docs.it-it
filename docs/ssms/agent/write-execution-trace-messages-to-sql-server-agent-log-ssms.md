...
3.  Nella finestra di dialogo **Proprietà SQL Server Agent -**_nome\_server_ in **Log degli errori** nella pagina **Generale** selezionare la casella di controllo **Includi messaggi di traccia esecuzione**.  
