...
Usare questa pagina per visualizzare o modificare le entità che possono usare un account proxy di [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] Agent nei passaggi di processo.  
