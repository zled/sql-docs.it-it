# [Panoramica](statements.md)

# ADD

## [CLASSIFICAZIONE DI SENSIBILITÀ](add-sensitivity-classification-transact-sql.md)
...
## [DATABASE (database SQL di Azure)](alter-database-azure-sql-database.md)  
## [DATABASE (Azure SQL Data Warehouse)](alter-database-azure-sql-data-warehouse.md)  
## [DATABASE (data warehouse parallelo)](alter-database-parallel-data-warehouse.md)  
## [DATABASE AUDIT SPECIFICATION](alter-database-audit-specification-transact-sql.md)
## [DATABASE - Livello di compatibilità](alter-database-transact-sql-compatibility-level.md)  
## [DATABASE - Mirroring del database](alter-database-transact-sql-database-mirroring.md)  
## [DATABASE ENCRYPTION KEY](alter-database-encryption-key-transact-sql.md)
## [DATABASE - Opzioni file e filegroup](alter-database-transact-sql-file-and-filegroup-options.md)  
...
## [Opzioni DATABASE SET](alter-database-transact-sql-set-options.md)  
...
## [INDEX (indici XML selettivi)](alter-index-selective-xml-indexes.md)  
...
## [BACKUP DATABASE (data warehouse parallelo)](backup-database-parallel-data-warehouse.md)  
...
## [Istruzioni RESTORE](restore-statements-for-restoring-recovering-and-managing-backups-transact-sql.md)  
## [RESTORE DATABASE (data warehouse parallelo)](restore-database-parallel-data-warehouse.md)

## [Argomenti RESTORE](restore-statements-arguments-transact-sql.md)  
...
## [DATABASE (database SQL di Azure)](create-database-azure-sql-database.md)  
## [DATABASE (Azure SQL Data Warehouse)](create-database-azure-sql-data-warehouse.md)  
## [DATABASE (data warehouse parallelo)](create-database-parallel-data-warehouse.md)  
...
## [REMOTE TABLE AS SELECT (data warehouse parallelo)](create-remote-table-as-select-parallel-data-warehouse.md)  
...
## [TABLE (grafo SQL)](create-table-sql-graph.md)  
## [TABLE AS SELECT (Azure SQL Data Warehouse)](create-table-as-select-azure-sql-data-warehouse.md)
## [TABLE IDENTITY (proprietà)](create-table-transact-sql-identity-property.md)
...
## [XML INDEX (indici XML selettivi)](create-xml-index-selective-xml-indexes.md)  
## [XML SCHEMA COLLECTION](create-xml-schema-collection-transact-sql.md)  

# Regole di confronto
## [Clausola COLLATE](collations.md)  
## [Nome delle regole di confronto di SQL Server](sql-server-collation-name-transact-sql.md)  
## [Nome delle regole di confronto di Windows](windows-collation-name-transact-sql.md)  
## [Precedenza delle regole di confronto](collation-precedence-transact-sql.md)  
...
## [INDEX (indici XML selettivi)](drop-index-selective-xml-indexes.md)  
...
## [CLASSIFICAZIONE DI SENSIBILITÀ](drop-sensitivity-classification-transact-sql.md)
...
# [INSERT (grafo SQL)](insert-sql-graph.md)
...
## [DENY - Autorizzazioni per assembly](deny-assembly-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per chiavi asimmetriche](deny-asymmetric-key-permissions-transact-sql.md)  
## [DENY - Autorizzazioni del gruppo di disponibilità](deny-availability-group-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per certificati](deny-certificate-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per database](deny-database-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per entità di database](deny-database-principal-permissions-transact-sql.md)  
## [DENY - Credenziali con ambito database](deny-database-scoped-credential-transact-sql.md)  
## [DENY - Autorizzazioni per endpoint](deny-endpoint-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per il catalogo full-text](deny-full-text-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per oggetti](deny-object-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per schemi](deny-schema-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per l'elenco delle proprietà di ricerca](deny-search-property-list-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per server](deny-server-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per entità server](deny-server-principal-permissions-transact-sql.md)  
## [DENY - Autorizzazioni di Service Broker](deny-service-broker-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per chiavi simmetriche](deny-symmetric-key-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per oggetti di sistema](deny-system-object-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per tipi](deny-type-permissions-transact-sql.md)  
## [DENY - Autorizzazioni per raccolte di XML Schema](deny-xml-schema-collection-permissions-transact-sql.md)  
## [EXECUTE AS](execute-as-transact-sql.md)  
## [Clausola EXECUTE AS](execute-as-clause-transact-sql.md)  
## [GRANT](grant-transact-sql.md)  
## [GRANT - Autorizzazioni per assembly](grant-assembly-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per chiavi asimmetriche](grant-asymmetric-key-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni del gruppo di disponibilità](grant-availability-group-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per certificati](grant-certificate-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per database](grant-database-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per entità di database](grant-database-principal-permissions-transact-sql.md)  
## [GRANT - Credenziali con ambito database](grant-database-scoped-credential-transact-sql.md)  
## [GRANT - Autorizzazioni per endpoint](grant-endpoint-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per il catalogo full-text](grant-full-text-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per oggetti](grant-object-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per schemi](grant-schema-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per l'elenco delle proprietà di ricerca](grant-search-property-list-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per server](grant-server-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per entità server](grant-server-principal-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni di Service Broker](grant-service-broker-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per chiavi simmetriche](grant-symmetric-key-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per oggetti di sistema](grant-system-object-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per tipi](grant-type-permissions-transact-sql.md)  
## [GRANT - Autorizzazioni per raccolte di XML Schema](grant-xml-schema-collection-permissions-transact-sql.md)  
## [OPEN MASTER KEY](open-master-key-transact-sql.md)  
## [OPEN SYMMETRIC KEY](open-symmetric-key-transact-sql.md)  
## [Autorizzazioni: GRANT, DENY, REVOKE (Azure SQL Data Warehouse, data warehouse parallelo)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
## [REVERT](revert-transact-sql.md)  
## [REVOKE](revoke-transact-sql.md)  
## [REVOKE - Autorizzazioni per assembly](revoke-assembly-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per chiavi asimmetriche](revoke-asymmetric-key-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni del gruppo di disponibilità](revoke-availability-group-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per certificati](revoke-certificate-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per database](revoke-database-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per entità di database](revoke-database-principal-permissions-transact-sql.md)  
## [REVOKE - Credenziali con ambito database](revoke-database-scoped-credential-transact-sql.md)  
## [REVOKE - Autorizzazioni per endpoint](revoke-endpoint-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per il catalogo full-text](revoke-full-text-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per oggetti](revoke-object-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per schemi](revoke-schema-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per l'elenco delle proprietà di ricerca](revoke-search-property-list-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per server](revoke-server-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per entità server](revoke-server-principal-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni di Service Broker](revoke-service-broker-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per chiavi simmetriche](revoke-symmetric-key-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per oggetti di sistema](revoke-system-object-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per tipi](revoke-type-permissions-transact-sql.md)  
## [REVOKE - Autorizzazioni per raccolte di XML Schema](revoke-xml-schema-collection-permissions-transact-sql.md)  
...
# SET
## [Panoramica](set-statements-transact-sql.md)
