...
> [!NOTE]  
>  **Database SQL di Azure** V12 è stato rilasciato nel dicembre 2014. Un aspetto di tale versione è che il livello di compatibilità dei database appena creati è impostato su 120. Nel 2015 Database SQL ha iniziato il supporto per il livello 130, anche se il valore predefinito è rimasto 120. 
> 
> A partire dalla **metà di giugno 2016**, in Database SQL, il livello di compatibilità predefinito è 130 anziché 120 per i database **appena creati**. I database esistenti creati prima di tale periodo non sono interessati e mantengono il livello di compatibilità corrente (100, 110 e 120).  
> 
...
Le correzioni derivanti dal flag di traccia 4199 nelle versioni di SQL Server precedenti a SQL Server 2017 sono ora abilitate per impostazione predefinita. Con la modalità di compatibilità 140 il flag di traccia 4199 continuerà a essere applicabile per le nuove correzioni di query optimizer che vengono rilasciate dopo SQL Server 2017. Per informazioni sul flag di traccia 4199, vedere [Flag di traccia 4199](https://support.microsoft.com/en-us/kb/974006).   
