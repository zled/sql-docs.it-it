 ...
 *table_or_view_name*  
 ...
 Per visualizzare un report degli indici in un oggetto, usare la vista del catalogo [sys.indexes](../../relational-databases/system-catalog-views/sys-indexes-transact-sql.md).  
