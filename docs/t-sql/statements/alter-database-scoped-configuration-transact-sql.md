...
### <a name="k-query-state-of-alter-database-scoped-configuration-based-on-different-statements"></a>K. Eseguire una query sullo stato di ALTER DATABASE SCOPED CONFIGURATION in base a istruzioni diverse
