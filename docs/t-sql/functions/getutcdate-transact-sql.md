...
## <a name="examples-includesssdwfullincludessssdwfull-mdmd-and-includesspdwincludessspdw-mdmd"></a>Esempi: [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] e[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]  
 L'esempio seguente usa le funzioni di sei sistema che restituiscono data e ora correnti per restituire la data, ora o entrambi. I valori sono restituiti in serie. Pertanto, i secondi frazionari potrebbero essere diversi.  
