...
Nell'esempio seguente viene creato un certificato denominato `Shipping04` e viene usata la funzione **CERTENCODED** per restituire la codifica binaria del certificato.
