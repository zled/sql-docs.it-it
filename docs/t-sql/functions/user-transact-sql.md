---
title: UTENTE (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 03/06/2017
...
### <a name="d-using-user-to-return-the-database-user-name"></a>D. Utilizzo della funzione USER per recuperare il nome dell'utente del database  
 Nell'esempio seguente viene dichiarata una variabile di tipo `char`, viene assegnato il valore corrente di USER alla variabile e vengono restituite la variabile e una descrizione.  
