---
title: Funzioni per i metadati (Transact-SQL) | Documenti Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|[APPLOCK_TEST](../../t-sql/functions/applock-test-transact-sql.md)|[VALORE SUCCESSIVO PER](../../t-sql/functions/next-value-for-transact-sql.md)|  
...
|[DB_NAME](../../t-sql/functions/db-name-transact-sql.md)|[FUNZIONE PARSENAME](../../t-sql/functions/parsename-transact-sql.md)|  
...
|[FULLTEXTSERVICEPROPERTY](../../t-sql/functions/fulltextserviceproperty-transact-sql.md)|[VERSIONE](../../t-sql/functions/version-transact-sql-metadata-functions.md)|  
