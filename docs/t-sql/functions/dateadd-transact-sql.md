...
*datepart*  
È la parte dell'elemento *date* a cui viene aggiunto un **numero***intero*. Nella tabella seguente vengono elencati tutti gli argomenti *datepart* validi. Variabili definite dall'utente equivalenti non sono valide.
