...
### <a name="c-using-sessionuser-to-return-the-user-name-of-the-current-session"></a>C: Uso di SESSION_USER per recuperare il nome utente della sessione corrente  
