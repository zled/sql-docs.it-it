...
### <a name="h-using-the---wildcard-characters"></a>H. Utilizzo del carattere jolly [ ]  
 Nell'esempio seguente viene cercato `DimEmployee` le righe con il nome di `Rob` o `Bob`.  
