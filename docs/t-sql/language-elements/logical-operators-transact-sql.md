...
|[QUALSIASI](../../t-sql/language-elements/any-transact-sql.md)|Restituisce TRUE se uno dei confronti specificati è TRUE.|  
|[TRA](../../t-sql/language-elements/between-transact-sql.md)|Restituisce TRUE se l'operando è compreso nell'intervallo specificato.|  
|[ESISTE](../../t-sql/language-elements/exists-transact-sql.md)|Restituisce TRUE se una sottoquery contiene una o più righe.|  
|[IN](../../t-sql/language-elements/in-transact-sql.md)|Restituisce TRUE se l'operando è uguale a una delle espressioni elencate.|  
|[AD ESEMPIO](../../t-sql/language-elements/like-transact-sql.md)|Restituisce TRUE se l'operando corrisponde a un modello.|  
