...
# [Commento con barra e asterisco](slash-star-comment-transact-sql.md)  
...
# [Barra rovesciata](sql-server-utilities-statements-backslash.md)  
...
### [+= (aggiunta EQUALS)](add-equals-transact-sql.md)  
### [- (sottrazione)](subtract-transact-sql.md)  
### [-= (sottrazione EQUALS)](subtract-equals-transact-sql.md)  
### [* (moltiplicazione)](multiply-transact-sql.md)  
### [*= (moltiplicazione EQUALS)](multiply-equals-transact-sql.md)  
### [(Divisione)](divide-transact-sql.md)  
### [/= (divisione EQUALS)](divide-equals-transact-sql.md)  
...
### [&= (AND bit per bit EQUALS)](bitwise-and-equals-transact-sql.md)  
### [| (OR bit per bit)](bitwise-or-transact-sql.md)  
### [|= (OR bit per bit EQUALS)](bitwise-or-equals-transact-sql.md)  
### [^ (OR esclusivo bit per bit)](bitwise-exclusive-or-transact-sql.md)  
### [^= (OR esclusivo bit per bit EQUALS)](bitwise-exclusive-or-equals-transact-sql.md)  
...
### [+= (concatenazione di stringhe)](string-concatenation-equal-transact-sql.md)  
### [Carattere di percentuale (Caratteri jolly per la corrispondenza)](percent-character-wildcard-character-s-to-match-transact-sql.md)  
