...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Scarica la stored procedure estesa specificata DLL dalla memoria.
...
[Lo scaricamento di un'estesa DLL di Stored Procedure](../../relational-databases/extended-stored-procedures-programming/unloading-an-extended-stored-procedure-dll.md)
