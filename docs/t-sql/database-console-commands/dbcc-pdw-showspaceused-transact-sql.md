...
## <a name="arguments"></a>Argomenti  
 ...
 Il nome di tabella composto da una, due o tre parti da visualizzare. Per i nomi di tabella composti da due o tre parti, il nome devono essere racchiuso tra virgolette doppie (""). L'uso delle virgolette nei nomi di tabella composti da una parte è facoltativo. Quando non viene specificato alcun nome di tabella, vengono visualizzate le informazioni per il database corrente.  
